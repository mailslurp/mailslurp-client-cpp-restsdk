...
public:
    ...
    /// <param name="to">The email address that submitted form should be sent to. Either this or _toAlias must be present for a form to be successfully submitted.. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="toAlias">ID of an email alias to that form should be sent to. Aliases must be created before submission and can be used to hide an email address and reduce spam. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    ...
    pplx::task<utility::string_t> submitForm(
        ...
        boost::optional<utility::string_t> toAlias,
