...
pplx::task<utility::string_t> FormControllerApi::submitForm(boost::optional<utility::string_t> emailAddress, boost::optional<utility::string_t> redirectTo, boost::optional<utility::string_t> spamCheck, boost::optional<utility::string_t> subject, boost::optional<utility::string_t> successMessage, boost::optional<utility::string_t> to, boost::optional<utility::string_t> toAlias, boost::optional<utility::string_t> otherParameters) const
{
    ...
    if (emailAddress)
    {
        localVarFormParams[ utility::conversions::to_string_t("_emailAddress") ] = ApiClient::parameterToString(*emailAddress);
    }
    if (redirectTo)
    {
        localVarFormParams[ utility::conversions::to_string_t("_redirectTo") ] = ApiClient::parameterToString(*redirectTo);
    }
    if (spamCheck)
    {
        localVarFormParams[ utility::conversions::to_string_t("_spamCheck") ] = ApiClient::parameterToString(*spamCheck);
    }
    if (subject)
    {
        localVarFormParams[ utility::conversions::to_string_t("_subject") ] = ApiClient::parameterToString(*subject);
    }
    if (successMessage)
    {
        localVarFormParams[ utility::conversions::to_string_t("_successMessage") ] = ApiClient::parameterToString(*successMessage);
    }
    if (to)
    {
        localVarFormParams[ utility::conversions::to_string_t("_to") ] = ApiClient::parameterToString(*to);
    }
    if (toAlias)
    {
        localVarFormParams[ utility::conversions::to_string_t("_toAlias") ] = ApiClient::parameterToString(*toAlias);
    }
    if (otherParameters)
    {
        localVarFormParams[ utility::conversions::to_string_t("otherParameters") ] = ApiClient::parameterToString(*otherParameters);
    }
