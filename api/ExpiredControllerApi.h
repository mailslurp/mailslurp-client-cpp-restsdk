...
public:
    ...
    /// </remarks>
    /// <param name="iD_of_the_ExpiredInboxRecord_you_want_to_retrievePeriod_This_is_different_from_the_ID_of_the_inbox_you_are_interested_inPeriod_See_other_methods_for_getting_ExpiredInboxRecord_for_an_inbox_inboxIdRight_Parenthesis"></param>
    pplx::task<std::shared_ptr<ExpiredInboxDto>> getExpiredInboxRecord(
        std::shared_ptr<utility::string_t> iD_of_the_ExpiredInboxRecord_you_want_to_retrievePeriod_This_is_different_from_the_ID_of_the_inbox_you_are_interested_inPeriod_See_other_methods_for_getting_ExpiredInboxRecord_for_an_inbox_inboxIdRight_Parenthesis
    ) const;
    /// <summary>
