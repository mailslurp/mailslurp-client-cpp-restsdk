...
public:
    ...
    pplx::task<std::shared_ptr<Page_InboxProjection_>> getAllInboxes(
        boost::optional<bool> favourite,
    ...
    /// <param name="limit">Limit the result set, ordered by received date time sort direction (optional, default to 0)</param>
    ...
    /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<Page_EmailPreview_>> getInboxEmailsPaginated(
        std::shared_ptr<utility::string_t> inboxId,
        boost::optional<int32_t> page,
        boost::optional<int32_t> size,
        boost::optional<utility::string_t> sort
    ...
    /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<Page_SentEmailProjection_>> getInboxSentEmails(
        std::shared_ptr<utility::string_t> inboxId,
        boost::optional<int32_t> page,
        boost::optional<int32_t> size,
        boost::optional<utility::string_t> sort
