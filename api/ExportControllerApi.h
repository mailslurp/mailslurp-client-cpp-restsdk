...
public:
    ...
    /// <param name="createdEarliestTime">createdEarliestTime (optional, default to utility::datetime())</param>
    /// <param name="createdOldestTime">createdOldestTime (optional, default to utility::datetime())</param>
    /// <param name="excludePreviouslyExported">excludePreviouslyExported (optional, default to false)</param>
    /// <param name="filter">filter (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="listSeparatorToken">listSeparatorToken (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<utility::string_t> exportEntities(
    ...
    /// <param name="apiKey">apiKey (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
