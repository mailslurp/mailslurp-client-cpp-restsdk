...
public:
    ...
    /// <param name="emailId">emailId</param>
    /// <param name="apiKey">Can pass apiKey in url for this request if you wish to download the file in a browser (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    ...
    /// <param name="size">Optional page size in email list pagination (optional, default to 0)</param>
    ...
    pplx::task<std::shared_ptr<Page_EmailProjection_>> getEmailsPaginated(
