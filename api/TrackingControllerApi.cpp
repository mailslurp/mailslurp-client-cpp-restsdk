...
pplx::task<std::shared_ptr<PageTrackingPixelProjection>> TrackingControllerApi::getAllTrackingPixels(boost::optional<int32_t> page, boost::optional<utility::string_t> searchFilter, boost::optional<int32_t> size, boost::optional<utility::string_t> sort) const
{
