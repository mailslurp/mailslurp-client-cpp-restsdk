...
public:
    ...
    pplx::task<void> deleteSmsMessage(
        std::shared_ptr<utility::string_t> smsId
    ) const;
    /// <summary>
    ...
    pplx::task<void> deleteSmsMessages(
        boost::optional<std::shared_ptr<utility::string_t>> phoneNumberId
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="smsId"></param>
    pplx::task<std::shared_ptr<SmsMessage>> getSmsMessage(
        std::shared_ptr<utility::string_t> smsId
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<PageSmsProjection>> getSmsMessagesPaginated(
        boost::optional<std::shared_ptr<utility::string_t>> phoneNumber,
