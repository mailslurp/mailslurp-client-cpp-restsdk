...
int64_t PageExpiredInboxRecordProjection::getTotal() const
{
    return m_Total;
}

void PageExpiredInboxRecordProjection::setTotal(int64_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool PageExpiredInboxRecordProjection::totalIsSet() const
{
    return m_TotalIsSet;
}

void PageExpiredInboxRecordProjection::unsetTotal()
{
    m_TotalIsSet = false;
}
