...
web::json::value CreateInboxDto::toJson() const
{
    ...
    {
        val[utility::conversions::to_string_t("virtualInbox")] = ModelBase::toJson(m_VirtualInbox);
    }
...
bool CreateInboxDto::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("virtualInbox")))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("virtualInbox"));
        if(!fieldValue.is_null())
        {
            bool refVal_virtualInbox;
            ok &= ModelBase::fromJson(fieldValue, refVal_virtualInbox);
            setVirtualInbox(refVal_virtualInbox);
        }
    }
    return ok;
}
...
void CreateInboxDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_VirtualInboxIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("virtualInbox"), m_VirtualInbox));
    }
}
...
bool CreateInboxDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("virtualInbox")))
    {
        bool refVal_virtualInbox;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t("virtualInbox")), refVal_virtualInbox );
        setVirtualInbox(refVal_virtualInbox);
    }
    return ok;
}
