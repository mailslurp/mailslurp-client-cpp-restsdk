...
/*
 * Page_ContactProjection_.h
 *
 * 
 */

#ifndef COM_MAILSLURP_CLIENT_MODEL_Page_ContactProjection__H_
#define COM_MAILSLURP_CLIENT_MODEL_Page_ContactProjection__H_
...
/// 
/// </summary>
class  Page_ContactProjection_
    : public ModelBase
{
public:
    Page_ContactProjection_();
    virtual ~Page_ContactProjection_();
    ...
    /////////////////////////////////////////////
    /// Page_ContactProjection_ members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<ContactProjection>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<ContactProjection>>& value);
...
protected:
    std::vector<std::shared_ptr<ContactProjection>> m_Content;
    bool m_ContentIsSet;
    bool m_Empty;
    bool m_EmptyIsSet;
    bool m_First;
...
#endif /* COM_MAILSLURP_CLIENT_MODEL_Page_ContactProjection__H_ */
