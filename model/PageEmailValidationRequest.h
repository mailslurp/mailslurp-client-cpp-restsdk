...
#ifndef COM_MAILSLURP_CLIENT_MODEL_PageEmailValidationRequest_H_
#define COM_MAILSLURP_CLIENT_MODEL_PageEmailValidationRequest_H_
...
#include <vector>
#include "EmailValidationRequestDto.h"
...
public:
    ...
    virtual ~PageEmailValidationRequest();
    ...
    /////////////////////////////////////////////
    /// PageEmailValidationRequest members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<EmailValidationRequestDto>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<EmailValidationRequestDto>>& value);
...
protected:
    std::vector<std::shared_ptr<EmailValidationRequestDto>> m_Content;
    bool m_ContentIsSet;
...
#endif /* COM_MAILSLURP_CLIENT_MODEL_PageEmailValidationRequest_H_ */
