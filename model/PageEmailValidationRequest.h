...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<EmailValidationRequest>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<EmailValidationRequest>>& value);
...
protected:
    std::vector<std::shared_ptr<EmailValidationRequest>> m_Content;
    bool m_ContentIsSet;
