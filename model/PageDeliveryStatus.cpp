...
bool PageDeliveryStatus::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("content")))
    {
        ...
        {
            std::vector<std::shared_ptr<DeliveryStatus>> refVal_content;
...
std::vector<std::shared_ptr<DeliveryStatus>>& PageDeliveryStatus::getContent()
{
    return m_Content;
}

void PageDeliveryStatus::setContent(const std::vector<std::shared_ptr<DeliveryStatus>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
