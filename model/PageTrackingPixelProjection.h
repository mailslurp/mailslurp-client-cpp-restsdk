...
#ifndef COM_MAILSLURP_CLIENT_MODEL_PageTrackingPixelProjection_H_
#define COM_MAILSLURP_CLIENT_MODEL_PageTrackingPixelProjection_H_
...
public:
    ...
    virtual ~PageTrackingPixelProjection();
    ...
    /////////////////////////////////////////////
    /// PageTrackingPixelProjection members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<TrackingPixelProjection>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<TrackingPixelProjection>>& value);
...
protected:
    std::vector<std::shared_ptr<TrackingPixelProjection>> m_Content;
    bool m_ContentIsSet;
...
#endif /* COM_MAILSLURP_CLIENT_MODEL_PageTrackingPixelProjection_H_ */
