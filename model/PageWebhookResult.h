...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<WebhookResultDto>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<WebhookResultDto>>& value);
...
protected:
    std::vector<std::shared_ptr<WebhookResultDto>> m_Content;
    bool m_ContentIsSet;
