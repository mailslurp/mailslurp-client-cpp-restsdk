...
/*
 * Page_EmailPreview_.h
 *
 * 
 */

#ifndef COM_MAILSLURP_CLIENT_MODEL_Page_EmailPreview__H_
#define COM_MAILSLURP_CLIENT_MODEL_Page_EmailPreview__H_
...
/// 
/// </summary>
class  Page_EmailPreview_
    : public ModelBase
{
public:
    Page_EmailPreview_();
    virtual ~Page_EmailPreview_();
    ...
    /////////////////////////////////////////////
    /// Page_EmailPreview_ members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<EmailPreview>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<EmailPreview>>& value);
...
protected:
    std::vector<std::shared_ptr<EmailPreview>> m_Content;
    bool m_ContentIsSet;
    bool m_Empty;
    bool m_EmptyIsSet;
    bool m_First;
...
#endif /* COM_MAILSLURP_CLIENT_MODEL_Page_EmailPreview__H_ */
