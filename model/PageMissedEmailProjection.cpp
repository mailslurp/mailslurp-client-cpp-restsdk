...
bool PageMissedEmailProjection::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("content")))
    {
        ...
        {
            std::vector<std::shared_ptr<MissedEmailProjection>> refVal_content;
...
std::shared_ptr<Pageable> PageMissedEmailProjection::getPageable() const
{
    return m_Pageable;
}

void PageMissedEmailProjection::setPageable(const std::shared_ptr<Pageable>& value)
{
    m_Pageable = value;
...
std::shared_ptr<Sort> PageMissedEmailProjection::getSort() const
{
    return m_Sort;
}

void PageMissedEmailProjection::setSort(const std::shared_ptr<Sort>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
