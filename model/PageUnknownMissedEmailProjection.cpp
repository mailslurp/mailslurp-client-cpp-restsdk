...
std::shared_ptr<Pageable> PageUnknownMissedEmailProjection::getPageable() const
{
    return m_Pageable;
}

void PageUnknownMissedEmailProjection::setPageable(const std::shared_ptr<Pageable>& value)
{
    m_Pageable = value;
