...
bool DomainPreview::isVerified() const
{
    return m_Verified;
}

void DomainPreview::setVerified(bool value)
{
    m_Verified = value;
    m_VerifiedIsSet = true;
}

bool DomainPreview::verifiedIsSet() const
{
    return m_VerifiedIsSet;
}

void DomainPreview::unsetVerified()
{
    m_VerifiedIsSet = false;
}
}
