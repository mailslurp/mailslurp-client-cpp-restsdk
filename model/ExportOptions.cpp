...
bool ExportOptions::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("listSeparatorToken")))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Object> refVal_listSeparatorToken;
...
std::shared_ptr<Object> ExportOptions::getListSeparatorToken() const
{
    return m_ListSeparatorToken;
}

void ExportOptions::setListSeparatorToken(const std::shared_ptr<Object>& value)
{
