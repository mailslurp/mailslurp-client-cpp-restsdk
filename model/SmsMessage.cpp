...
void SmsMessage::validate()
{
    // TODO: implement validation
}

web::json::value SmsMessage::toJson() const
{
...
bool SmsMessage::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SmsMessage::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SmsMessage::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
utility::string_t SmsMessage::getId() const
{
    return m_Id;
}

void SmsMessage::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool SmsMessage::idIsSet() const
{
    return m_IdIsSet;
}

void SmsMessage::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t SmsMessage::getUserId() const
{
    return m_UserId;
}

void SmsMessage::setUserId(const utility::string_t& value)
{
    m_UserId = value;
    m_UserIdIsSet = true;
}

bool SmsMessage::userIdIsSet() const
{
    return m_UserIdIsSet;
}

void SmsMessage::unsetUserId()
{
    m_UserIdIsSet = false;
}
utility::string_t SmsMessage::getPhoneNumber() const
{
    return m_PhoneNumber;
}

void SmsMessage::setPhoneNumber(const utility::string_t& value)
{
    m_PhoneNumber = value;
    m_PhoneNumberIsSet = true;
}

bool SmsMessage::phoneNumberIsSet() const
{
    return m_PhoneNumberIsSet;
}

void SmsMessage::unsetPhoneNumber()
{
    m_PhoneNumberIsSet = false;
}
utility::string_t SmsMessage::getFromNumber() const
{
    return m_FromNumber;
}

void SmsMessage::setFromNumber(const utility::string_t& value)
{
    m_FromNumber = value;
    m_FromNumberIsSet = true;
}

bool SmsMessage::fromNumberIsSet() const
{
    return m_FromNumberIsSet;
}

void SmsMessage::unsetFromNumber()
{
    m_FromNumberIsSet = false;
}
utility::string_t SmsMessage::getBody() const
{
    return m_Body;
}

void SmsMessage::setBody(const utility::string_t& value)
{
    m_Body = value;
    m_BodyIsSet = true;
}

bool SmsMessage::bodyIsSet() const
{
    return m_BodyIsSet;
}

void SmsMessage::unsetBody()
{
    m_BodyIsSet = false;
}
bool SmsMessage::isRead() const
{
    return m_Read;
}

void SmsMessage::setRead(bool value)
{
    m_Read = value;
    m_ReadIsSet = true;
}

bool SmsMessage::readIsSet() const
{
    return m_ReadIsSet;
}

void SmsMessage::unsetRead()
{
    m_ReadIsSet = false;
}
utility::string_t SmsMessage::getSid() const
{
    return m_Sid;
}

void SmsMessage::setSid(const utility::string_t& value)
{
    m_Sid = value;
    m_SidIsSet = true;
}

bool SmsMessage::sidIsSet() const
{
    return m_SidIsSet;
}

void SmsMessage::unsetSid()
{
    m_SidIsSet = false;
}
utility::datetime SmsMessage::getCreatedAt() const
{
    return m_CreatedAt;
}

void SmsMessage::setCreatedAt(const utility::datetime& value)
{
    m_CreatedAt = value;
    m_CreatedAtIsSet = true;
}

bool SmsMessage::createdAtIsSet() const
{
    return m_CreatedAtIsSet;
}

void SmsMessage::unsetCreatedAt()
{
    m_CreatedAtIsSet = false;
}
utility::datetime SmsMessage::getUpdatedAt() const
{
    return m_UpdatedAt;
}

void SmsMessage::setUpdatedAt(const utility::datetime& value)
{
    m_UpdatedAt = value;
    m_UpdatedAtIsSet = true;
}

bool SmsMessage::updatedAtIsSet() const
{
    return m_UpdatedAtIsSet;
}

void SmsMessage::unsetUpdatedAt()
{
    m_UpdatedAtIsSet = false;
}
}
