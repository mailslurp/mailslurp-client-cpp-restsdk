...
void PageInboxRulesetProjection::validate()
{
    // TODO: implement validation
}

web::json::value PageInboxRulesetProjection::toJson() const
{
...
bool PageInboxRulesetProjection::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t("content")))
    {
        ...
        {
            std::vector<std::shared_ptr<InboxRulesetProjection>> refVal_content;
...
void PageInboxRulesetProjection::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageInboxRulesetProjection::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::vector<std::shared_ptr<InboxRulesetProjection>>& PageInboxRulesetProjection::getContent()
{
    return m_Content;
}

void PageInboxRulesetProjection::setContent(const std::vector<std::shared_ptr<InboxRulesetProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageInboxRulesetProjection::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageInboxRulesetProjection::unsetContent()
{
    m_ContentIsSet = false;
}
bool PageInboxRulesetProjection::isEmpty() const
{
    return m_Empty;
}

void PageInboxRulesetProjection::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageInboxRulesetProjection::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageInboxRulesetProjection::unsetEmpty()
{
    m_EmptyIsSet = false;
}
bool PageInboxRulesetProjection::isFirst() const
{
    return m_First;
}

void PageInboxRulesetProjection::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageInboxRulesetProjection::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageInboxRulesetProjection::unsetFirst()
{
    m_FirstIsSet = false;
}
bool PageInboxRulesetProjection::isLast() const
{
    return m_Last;
}

void PageInboxRulesetProjection::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageInboxRulesetProjection::lastIsSet() const
{
    return m_LastIsSet;
}

void PageInboxRulesetProjection::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageInboxRulesetProjection::getNumber() const
{
    return m_number;
}

void PageInboxRulesetProjection::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageInboxRulesetProjection::numberIsSet() const
{
    return m_numberIsSet;
}

void PageInboxRulesetProjection::unsetnumber()
{
    m_numberIsSet = false;
}
int32_t PageInboxRulesetProjection::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageInboxRulesetProjection::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageInboxRulesetProjection::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageInboxRulesetProjection::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
std::shared_ptr<Pageable> PageInboxRulesetProjection::getPageable() const
{
    return m_Pageable;
}

void PageInboxRulesetProjection::setPageable(const std::shared_ptr<Pageable>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageInboxRulesetProjection::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageInboxRulesetProjection::unsetPageable()
{
    m_PageableIsSet = false;
}
int32_t PageInboxRulesetProjection::getSize() const
{
    return m_Size;
}

void PageInboxRulesetProjection::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageInboxRulesetProjection::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageInboxRulesetProjection::unsetSize()
{
    m_SizeIsSet = false;
}
std::shared_ptr<Sort> PageInboxRulesetProjection::getSort() const
{
    return m_Sort;
}

void PageInboxRulesetProjection::setSort(const std::shared_ptr<Sort>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageInboxRulesetProjection::sortIsSet() const
{
    return m_SortIsSet;
}

void PageInboxRulesetProjection::unsetSort()
{
    m_SortIsSet = false;
}
int64_t PageInboxRulesetProjection::getTotalElements() const
{
    return m_TotalElements;
}

void PageInboxRulesetProjection::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageInboxRulesetProjection::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageInboxRulesetProjection::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PageInboxRulesetProjection::getTotalPages() const
{
    return m_TotalPages;
}

void PageInboxRulesetProjection::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageInboxRulesetProjection::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageInboxRulesetProjection::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
}
