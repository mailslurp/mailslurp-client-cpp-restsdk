...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<BounceRecipient>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<BounceRecipient>>& value);
...
protected:
    std::vector<std::shared_ptr<BounceRecipient>> m_Content;
    bool m_ContentIsSet;
