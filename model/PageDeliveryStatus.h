...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<DeliveryStatus>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<DeliveryStatus>>& value);
...
protected:
    std::vector<std::shared_ptr<DeliveryStatus>> m_Content;
    bool m_ContentIsSet;
