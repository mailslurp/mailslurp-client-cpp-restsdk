...
/*
 * Page_SentEmailProjection_.h
 *
 * 
 */

#ifndef COM_MAILSLURP_CLIENT_MODEL_Page_SentEmailProjection__H_
#define COM_MAILSLURP_CLIENT_MODEL_Page_SentEmailProjection__H_
...
/// 
/// </summary>
class  Page_SentEmailProjection_
    : public ModelBase
{
public:
    Page_SentEmailProjection_();
    virtual ~Page_SentEmailProjection_();
    ...
    /////////////////////////////////////////////
    /// Page_SentEmailProjection_ members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<SentEmailProjection>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<SentEmailProjection>>& value);
...
protected:
    std::vector<std::shared_ptr<SentEmailProjection>> m_Content;
    bool m_ContentIsSet;
    bool m_Empty;
    bool m_EmptyIsSet;
    bool m_First;
...
#endif /* COM_MAILSLURP_CLIENT_MODEL_Page_SentEmailProjection__H_ */
