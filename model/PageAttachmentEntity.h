...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<AttachmentEntity>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<AttachmentEntity>>& value);
...
protected:
    std::vector<std::shared_ptr<AttachmentEntity>> m_Content;
    bool m_ContentIsSet;
    bool m_Empty;
    bool m_EmptyIsSet;
    bool m_First;
