...
Page_EmailPreview_::Page_EmailPreview_()
{
...
void Page_EmailPreview_::validate()
{
    // TODO: implement validation
}

web::json::value Page_EmailPreview_::toJson() const
{
...
bool Page_EmailPreview_::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Page_EmailPreview_::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Page_EmailPreview_::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::vector<std::shared_ptr<EmailPreview>>& Page_EmailPreview_::getContent()
{
    return m_Content;
}

void Page_EmailPreview_::setContent(const std::vector<std::shared_ptr<EmailPreview>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool Page_EmailPreview_::contentIsSet() const
{
    return m_ContentIsSet;
}

void Page_EmailPreview_::unsetContent()
{
    m_ContentIsSet = false;
}
bool Page_EmailPreview_::isEmpty() const
{
    return m_Empty;
}

void Page_EmailPreview_::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool Page_EmailPreview_::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void Page_EmailPreview_::unsetEmpty()
{
    m_EmptyIsSet = false;
}
bool Page_EmailPreview_::isFirst() const
{
    return m_First;
}

void Page_EmailPreview_::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool Page_EmailPreview_::firstIsSet() const
{
    return m_FirstIsSet;
}

void Page_EmailPreview_::unsetFirst()
{
    m_FirstIsSet = false;
}
bool Page_EmailPreview_::isLast() const
{
    return m_Last;
}

void Page_EmailPreview_::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool Page_EmailPreview_::lastIsSet() const
{
    return m_LastIsSet;
}

void Page_EmailPreview_::unsetLast()
{
    m_LastIsSet = false;
}
int32_t Page_EmailPreview_::getNumber() const
{
    return m_number;
}

void Page_EmailPreview_::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool Page_EmailPreview_::numberIsSet() const
{
    return m_numberIsSet;
}

void Page_EmailPreview_::unsetnumber()
{
    m_numberIsSet = false;
}
int32_t Page_EmailPreview_::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void Page_EmailPreview_::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool Page_EmailPreview_::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void Page_EmailPreview_::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
std::shared_ptr<Pageable> Page_EmailPreview_::getPageable() const
{
    return m_Pageable;
}

void Page_EmailPreview_::setPageable(const std::shared_ptr<Pageable>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool Page_EmailPreview_::pageableIsSet() const
{
    return m_PageableIsSet;
}

void Page_EmailPreview_::unsetPageable()
{
    m_PageableIsSet = false;
}
int32_t Page_EmailPreview_::getSize() const
{
    return m_Size;
}

void Page_EmailPreview_::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool Page_EmailPreview_::sizeIsSet() const
{
    return m_SizeIsSet;
}

void Page_EmailPreview_::unsetSize()
{
    m_SizeIsSet = false;
}
std::shared_ptr<Sort> Page_EmailPreview_::getSort() const
{
    return m_Sort;
}

void Page_EmailPreview_::setSort(const std::shared_ptr<Sort>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool Page_EmailPreview_::sortIsSet() const
{
    return m_SortIsSet;
}

void Page_EmailPreview_::unsetSort()
{
    m_SortIsSet = false;
}
int64_t Page_EmailPreview_::getTotalElements() const
{
    return m_TotalElements;
}

void Page_EmailPreview_::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool Page_EmailPreview_::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void Page_EmailPreview_::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t Page_EmailPreview_::getTotalPages() const
{
    return m_TotalPages;
}

void Page_EmailPreview_::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool Page_EmailPreview_::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void Page_EmailPreview_::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
}
