...
std::shared_ptr<Pageable> PageGroupProjection::getPageable() const
{
    return m_Pageable;
}

void PageGroupProjection::setPageable(const std::shared_ptr<Pageable>& value)
{
    m_Pageable = value;
...
std::shared_ptr<Sort> PageGroupProjection::getSort() const
{
    return m_Sort;
}

void PageGroupProjection::setSort(const std::shared_ptr<Sort>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
