...
void WebhookResultEntity::validate()
{
    // TODO: implement validation
}

web::json::value WebhookResultEntity::toJson() const
{
...
bool WebhookResultEntity::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void WebhookResultEntity::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool WebhookResultEntity::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
utility::datetime WebhookResultEntity::getCreatedAt() const
{
    return m_CreatedAt;
}

void WebhookResultEntity::setCreatedAt(const utility::datetime& value)
{
    m_CreatedAt = value;
    m_CreatedAtIsSet = true;
}

bool WebhookResultEntity::createdAtIsSet() const
{
    return m_CreatedAtIsSet;
}

void WebhookResultEntity::unsetCreatedAt()
{
    m_CreatedAtIsSet = false;
}
utility::string_t WebhookResultEntity::getHttpMethod() const
{
    return m_HttpMethod;
}

void WebhookResultEntity::setHttpMethod(const utility::string_t& value)
{
    m_HttpMethod = value;
    m_HttpMethodIsSet = true;
}

bool WebhookResultEntity::httpMethodIsSet() const
{
    return m_HttpMethodIsSet;
}

void WebhookResultEntity::unsetHttpMethod()
{
    m_HttpMethodIsSet = false;
}
utility::string_t WebhookResultEntity::getId() const
{
    return m_Id;
}

void WebhookResultEntity::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool WebhookResultEntity::idIsSet() const
{
    return m_IdIsSet;
}

void WebhookResultEntity::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t WebhookResultEntity::getInboxId() const
{
    return m_InboxId;
}

void WebhookResultEntity::setInboxId(const utility::string_t& value)
{
    m_InboxId = value;
    m_InboxIdIsSet = true;
}

bool WebhookResultEntity::inboxIdIsSet() const
{
    return m_InboxIdIsSet;
}

void WebhookResultEntity::unsetInboxId()
{
    m_InboxIdIsSet = false;
}
utility::string_t WebhookResultEntity::getMessageId() const
{
    return m_MessageId;
}

void WebhookResultEntity::setMessageId(const utility::string_t& value)
{
    m_MessageId = value;
    m_MessageIdIsSet = true;
}

bool WebhookResultEntity::messageIdIsSet() const
{
    return m_MessageIdIsSet;
}

void WebhookResultEntity::unsetMessageId()
{
    m_MessageIdIsSet = false;
}
utility::string_t WebhookResultEntity::getResponseBodyExtract() const
{
    return m_ResponseBodyExtract;
}

void WebhookResultEntity::setResponseBodyExtract(const utility::string_t& value)
{
    m_ResponseBodyExtract = value;
    m_ResponseBodyExtractIsSet = true;
}

bool WebhookResultEntity::responseBodyExtractIsSet() const
{
    return m_ResponseBodyExtractIsSet;
}

void WebhookResultEntity::unsetResponseBodyExtract()
{
    m_ResponseBodyExtractIsSet = false;
}
int32_t WebhookResultEntity::getResponseStatus() const
{
    return m_ResponseStatus;
}

void WebhookResultEntity::setResponseStatus(int32_t value)
{
    m_ResponseStatus = value;
    m_ResponseStatusIsSet = true;
}

bool WebhookResultEntity::responseStatusIsSet() const
{
    return m_ResponseStatusIsSet;
}

void WebhookResultEntity::unsetResponseStatus()
{
    m_ResponseStatusIsSet = false;
}
int64_t WebhookResultEntity::getResponseTimeMillis() const
{
    return m_ResponseTimeMillis;
}

void WebhookResultEntity::setResponseTimeMillis(int64_t value)
{
    m_ResponseTimeMillis = value;
    m_ResponseTimeMillisIsSet = true;
}

bool WebhookResultEntity::responseTimeMillisIsSet() const
{
    return m_ResponseTimeMillisIsSet;
}

void WebhookResultEntity::unsetResponseTimeMillis()
{
    m_ResponseTimeMillisIsSet = false;
}
utility::string_t WebhookResultEntity::getResultType() const
{
    return m_ResultType;
}

void WebhookResultEntity::setResultType(const utility::string_t& value)
{
    m_ResultType = value;
    m_ResultTypeIsSet = true;
}

bool WebhookResultEntity::resultTypeIsSet() const
{
    return m_ResultTypeIsSet;
}

void WebhookResultEntity::unsetResultType()
{
    m_ResultTypeIsSet = false;
}
utility::datetime WebhookResultEntity::getUpdatedAt() const
{
    return m_UpdatedAt;
}

void WebhookResultEntity::setUpdatedAt(const utility::datetime& value)
{
    m_UpdatedAt = value;
    m_UpdatedAtIsSet = true;
}

bool WebhookResultEntity::updatedAtIsSet() const
{
    return m_UpdatedAtIsSet;
}

void WebhookResultEntity::unsetUpdatedAt()
{
    m_UpdatedAtIsSet = false;
}
utility::string_t WebhookResultEntity::getUserId() const
{
    return m_UserId;
}

void WebhookResultEntity::setUserId(const utility::string_t& value)
{
    m_UserId = value;
    m_UserIdIsSet = true;
}

bool WebhookResultEntity::userIdIsSet() const
{
    return m_UserIdIsSet;
}

void WebhookResultEntity::unsetUserId()
{
    m_UserIdIsSet = false;
}
utility::string_t WebhookResultEntity::getWebhookEvent() const
{
    return m_WebhookEvent;
}

void WebhookResultEntity::setWebhookEvent(const utility::string_t& value)
{
    m_WebhookEvent = value;
    m_WebhookEventIsSet = true;
}

bool WebhookResultEntity::webhookEventIsSet() const
{
    return m_WebhookEventIsSet;
}

void WebhookResultEntity::unsetWebhookEvent()
{
    m_WebhookEventIsSet = false;
}
utility::string_t WebhookResultEntity::getWebhookId() const
{
    return m_WebhookId;
}

void WebhookResultEntity::setWebhookId(const utility::string_t& value)
{
    m_WebhookId = value;
    m_WebhookIdIsSet = true;
}

bool WebhookResultEntity::webhookIdIsSet() const
{
    return m_WebhookIdIsSet;
}

void WebhookResultEntity::unsetWebhookId()
{
    m_WebhookIdIsSet = false;
}
utility::string_t WebhookResultEntity::getWebhookUrl() const
{
    return m_WebhookUrl;
}

void WebhookResultEntity::setWebhookUrl(const utility::string_t& value)
{
    m_WebhookUrl = value;
    m_WebhookUrlIsSet = true;
}

bool WebhookResultEntity::webhookUrlIsSet() const
{
    return m_WebhookUrlIsSet;
}

void WebhookResultEntity::unsetWebhookUrl()
{
    m_WebhookUrlIsSet = false;
}
}
