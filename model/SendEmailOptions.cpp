...
web::json::value SendEmailOptions::toJson() const
{
    ...
    {
        val[utility::conversions::to_string_t("addTrackingPixel")] = ModelBase::toJson(m_AddTrackingPixel);
    }
    if(m_FilterBouncedRecipientsIsSet)
    {
        val[utility::conversions::to_string_t("filterBouncedRecipients")] = ModelBase::toJson(m_FilterBouncedRecipients);
    }
    if(m_ValidateEmailAddressesIsSet)
    {
        val[utility::conversions::to_string_t("validateEmailAddresses")] = ModelBase::toJson(m_ValidateEmailAddresses);
    }
...
bool SendEmailOptions::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("addTrackingPixel")))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("addTrackingPixel"));
        if(!fieldValue.is_null())
        {
            bool refVal_addTrackingPixel;
            ok &= ModelBase::fromJson(fieldValue, refVal_addTrackingPixel);
            setAddTrackingPixel(refVal_addTrackingPixel);
        }
    }
    if(val.has_field(utility::conversions::to_string_t("filterBouncedRecipients")))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("filterBouncedRecipients"));
        if(!fieldValue.is_null())
        {
            bool refVal_filterBouncedRecipients;
            ok &= ModelBase::fromJson(fieldValue, refVal_filterBouncedRecipients);
            setFilterBouncedRecipients(refVal_filterBouncedRecipients);
        }
    }
    if(val.has_field(utility::conversions::to_string_t("validateEmailAddresses")))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("validateEmailAddresses"));
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_validateEmailAddresses;
            ok &= ModelBase::fromJson(fieldValue, refVal_validateEmailAddresses);
            setValidateEmailAddresses(refVal_validateEmailAddresses);
        }
    }
    return ok;
}
...
void SendEmailOptions::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_AddTrackingPixelIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("addTrackingPixel"), m_AddTrackingPixel));
    }
    if(m_FilterBouncedRecipientsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("filterBouncedRecipients"), m_FilterBouncedRecipients));
    }
    if(m_ValidateEmailAddressesIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("validateEmailAddresses"), m_ValidateEmailAddresses));
    }
}
...
bool SendEmailOptions::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("addTrackingPixel")))
    {
        bool refVal_addTrackingPixel;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t("addTrackingPixel")), refVal_addTrackingPixel );
        setAddTrackingPixel(refVal_addTrackingPixel);
    }
    if(multipart->hasContent(utility::conversions::to_string_t("filterBouncedRecipients")))
    {
        bool refVal_filterBouncedRecipients;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t("filterBouncedRecipients")), refVal_filterBouncedRecipients );
        setFilterBouncedRecipients(refVal_filterBouncedRecipients);
    }
    if(multipart->hasContent(utility::conversions::to_string_t("validateEmailAddresses")))
    {
        utility::string_t refVal_validateEmailAddresses;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t("validateEmailAddresses")), refVal_validateEmailAddresses );
        setValidateEmailAddresses(refVal_validateEmailAddresses);
    }
    return ok;
}
