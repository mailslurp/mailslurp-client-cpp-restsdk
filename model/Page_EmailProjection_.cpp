...
#include "Page_EmailProjection_.h"
...
Page_EmailProjection_::Page_EmailProjection_()
{
...
void Page_EmailProjection_::validate()
{
    // TODO: implement validation
}

web::json::value Page_EmailProjection_::toJson() const
{
...
bool Page_EmailProjection_::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Page_EmailProjection_::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Page_EmailProjection_::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::vector<std::shared_ptr<EmailProjection>>& Page_EmailProjection_::getContent()
{
    return m_Content;
}

void Page_EmailProjection_::setContent(const std::vector<std::shared_ptr<EmailProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool Page_EmailProjection_::contentIsSet() const
{
    return m_ContentIsSet;
}

void Page_EmailProjection_::unsetContent()
{
    m_ContentIsSet = false;
}
bool Page_EmailProjection_::isEmpty() const
{
    return m_Empty;
}

void Page_EmailProjection_::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool Page_EmailProjection_::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void Page_EmailProjection_::unsetEmpty()
{
    m_EmptyIsSet = false;
}
bool Page_EmailProjection_::isFirst() const
{
    return m_First;
}

void Page_EmailProjection_::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool Page_EmailProjection_::firstIsSet() const
{
    return m_FirstIsSet;
}

void Page_EmailProjection_::unsetFirst()
{
    m_FirstIsSet = false;
}
bool Page_EmailProjection_::isLast() const
{
    return m_Last;
}

void Page_EmailProjection_::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool Page_EmailProjection_::lastIsSet() const
{
    return m_LastIsSet;
}

void Page_EmailProjection_::unsetLast()
{
    m_LastIsSet = false;
}
int32_t Page_EmailProjection_::getNumber() const
{
    return m_number;
}

void Page_EmailProjection_::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool Page_EmailProjection_::numberIsSet() const
{
    return m_numberIsSet;
}

void Page_EmailProjection_::unsetnumber()
{
    m_numberIsSet = false;
}
int32_t Page_EmailProjection_::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void Page_EmailProjection_::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool Page_EmailProjection_::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void Page_EmailProjection_::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
std::shared_ptr<Pageable> Page_EmailProjection_::getPageable() const
{
    return m_Pageable;
}

void Page_EmailProjection_::setPageable(const std::shared_ptr<Pageable>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool Page_EmailProjection_::pageableIsSet() const
{
    return m_PageableIsSet;
}

void Page_EmailProjection_::unsetPageable()
{
    m_PageableIsSet = false;
}
int32_t Page_EmailProjection_::getSize() const
{
    return m_Size;
}

void Page_EmailProjection_::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool Page_EmailProjection_::sizeIsSet() const
{
    return m_SizeIsSet;
}

void Page_EmailProjection_::unsetSize()
{
    m_SizeIsSet = false;
}
std::shared_ptr<Sort> Page_EmailProjection_::getSort() const
{
    return m_Sort;
}

void Page_EmailProjection_::setSort(const std::shared_ptr<Sort>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool Page_EmailProjection_::sortIsSet() const
{
    return m_SortIsSet;
}

void Page_EmailProjection_::unsetSort()
{
    m_SortIsSet = false;
}
int64_t Page_EmailProjection_::getTotalElements() const
{
    return m_TotalElements;
}

void Page_EmailProjection_::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool Page_EmailProjection_::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void Page_EmailProjection_::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t Page_EmailProjection_::getTotalPages() const
{
    return m_TotalPages;
}

void Page_EmailProjection_::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool Page_EmailProjection_::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void Page_EmailProjection_::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
}
