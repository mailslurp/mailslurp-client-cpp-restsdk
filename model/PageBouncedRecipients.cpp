...
bool PageBouncedRecipients::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("content")))
    {
        ...
        {
            std::vector<std::shared_ptr<BounceRecipient>> refVal_content;
...
std::vector<std::shared_ptr<BounceRecipient>>& PageBouncedRecipients::getContent()
{
    return m_Content;
}

void PageBouncedRecipients::setContent(const std::vector<std::shared_ptr<BounceRecipient>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
