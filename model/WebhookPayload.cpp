...
utility::string_t WebhookPayload::getId() const
{
    return m_Id;
}

void WebhookPayload::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool WebhookPayload::idIsSet() const
{
    return m_IdIsSet;
}

void WebhookPayload::unsetId()
{
    m_IdIsSet = false;
}
