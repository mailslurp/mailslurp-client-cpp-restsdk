...
std::vector<std::shared_ptr<InboxProjection>>& PageInboxProjection::getContent()
{
    return m_Content;
}

void PageInboxProjection::setContent(const std::vector<std::shared_ptr<InboxProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
...
std::shared_ptr<Pageable> PageInboxProjection::getPageable() const
{
    return m_Pageable;
}

void PageInboxProjection::setPageable(const std::shared_ptr<Pageable>& value)
{
    m_Pageable = value;
