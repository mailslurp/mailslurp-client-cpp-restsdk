...
bool PageWebhookResult::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("content")))
    {
        ...
        {
            std::vector<std::shared_ptr<WebhookResultEntity>> refVal_content;
...
std::vector<std::shared_ptr<WebhookResultEntity>>& PageWebhookResult::getContent()
{
    return m_Content;
}

void PageWebhookResult::setContent(const std::vector<std::shared_ptr<WebhookResultEntity>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
...
std::shared_ptr<Pageable> PageWebhookResult::getPageable() const
{
    return m_Pageable;
}

void PageWebhookResult::setPageable(const std::shared_ptr<Pageable>& value)
{
    m_Pageable = value;
