...
bool EmailVerificationResult::isValid() const
{
    return m_Valid;
}

void EmailVerificationResult::setValid(bool value)
{
    m_Valid = value;
    m_ValidIsSet = true;
}

bool EmailVerificationResult::validIsSet() const
{
    return m_ValidIsSet;
}

void EmailVerificationResult::unsetValid()
{
    m_ValidIsSet = false;
}
}
