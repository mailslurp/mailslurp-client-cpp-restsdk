...
web::json::value InboxRulesetTestOptions::toJson() const
{
    ...
    {
        val[utility::conversions::to_string_t("testTarget")] = ModelBase::toJson(m_TestTarget);
    }
...
bool InboxRulesetTestOptions::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("testTarget")))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("testTarget"));
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_testTarget;
            ok &= ModelBase::fromJson(fieldValue, refVal_testTarget);
            setTestTarget(refVal_testTarget);
        }
    }
    return ok;
}
...
void InboxRulesetTestOptions::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_TestTargetIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("testTarget"), m_TestTarget));
    }
}
...
bool InboxRulesetTestOptions::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("testTarget")))
    {
        utility::string_t refVal_testTarget;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t("testTarget")), refVal_testTarget );
        setTestTarget(refVal_testTarget);
    }
    return ok;
}
