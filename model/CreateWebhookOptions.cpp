...
web::json::value CreateWebhookOptions::toJson() const
{
    ...
    {
        val[utility::conversions::to_string_t("includeHeaders")] = ModelBase::toJson(m_IncludeHeaders);
    }
...
bool CreateWebhookOptions::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("includeHeaders")))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("includeHeaders"));
        if(!fieldValue.is_null())
        {
            std::shared_ptr<WebhookHeaders> refVal_includeHeaders;
            ok &= ModelBase::fromJson(fieldValue, refVal_includeHeaders);
            setIncludeHeaders(refVal_includeHeaders);
        }
    }
...
void CreateWebhookOptions::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_IncludeHeadersIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("includeHeaders"), m_IncludeHeaders));
    }
    if(m_RequestBodyTemplateIsSet)
    {
...
bool CreateWebhookOptions::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("includeHeaders")))
    {
        std::shared_ptr<WebhookHeaders> refVal_includeHeaders;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t("includeHeaders")), refVal_includeHeaders );
        setIncludeHeaders(refVal_includeHeaders);
    }
