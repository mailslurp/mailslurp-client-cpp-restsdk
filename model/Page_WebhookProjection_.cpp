...
#include "Page_WebhookProjection_.h"
...
Page_WebhookProjection_::Page_WebhookProjection_()
{
...
void Page_WebhookProjection_::validate()
{
    // TODO: implement validation
}

web::json::value Page_WebhookProjection_::toJson() const
{
...
bool Page_WebhookProjection_::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Page_WebhookProjection_::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Page_WebhookProjection_::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::vector<std::shared_ptr<WebhookProjection>>& Page_WebhookProjection_::getContent()
{
    return m_Content;
}

void Page_WebhookProjection_::setContent(const std::vector<std::shared_ptr<WebhookProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool Page_WebhookProjection_::contentIsSet() const
{
    return m_ContentIsSet;
}

void Page_WebhookProjection_::unsetContent()
{
    m_ContentIsSet = false;
}
bool Page_WebhookProjection_::isEmpty() const
{
    return m_Empty;
}

void Page_WebhookProjection_::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool Page_WebhookProjection_::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void Page_WebhookProjection_::unsetEmpty()
{
    m_EmptyIsSet = false;
}
bool Page_WebhookProjection_::isFirst() const
{
    return m_First;
}

void Page_WebhookProjection_::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool Page_WebhookProjection_::firstIsSet() const
{
    return m_FirstIsSet;
}

void Page_WebhookProjection_::unsetFirst()
{
    m_FirstIsSet = false;
}
bool Page_WebhookProjection_::isLast() const
{
    return m_Last;
}

void Page_WebhookProjection_::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool Page_WebhookProjection_::lastIsSet() const
{
    return m_LastIsSet;
}

void Page_WebhookProjection_::unsetLast()
{
    m_LastIsSet = false;
}
int32_t Page_WebhookProjection_::getNumber() const
{
    return m_number;
}

void Page_WebhookProjection_::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool Page_WebhookProjection_::numberIsSet() const
{
    return m_numberIsSet;
}

void Page_WebhookProjection_::unsetnumber()
{
    m_numberIsSet = false;
}
int32_t Page_WebhookProjection_::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void Page_WebhookProjection_::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool Page_WebhookProjection_::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void Page_WebhookProjection_::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
std::shared_ptr<Pageable> Page_WebhookProjection_::getPageable() const
{
    return m_Pageable;
}

void Page_WebhookProjection_::setPageable(const std::shared_ptr<Pageable>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool Page_WebhookProjection_::pageableIsSet() const
{
    return m_PageableIsSet;
}

void Page_WebhookProjection_::unsetPageable()
{
    m_PageableIsSet = false;
}
int32_t Page_WebhookProjection_::getSize() const
{
    return m_Size;
}

void Page_WebhookProjection_::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool Page_WebhookProjection_::sizeIsSet() const
{
    return m_SizeIsSet;
}

void Page_WebhookProjection_::unsetSize()
{
    m_SizeIsSet = false;
}
std::shared_ptr<Sort> Page_WebhookProjection_::getSort() const
{
    return m_Sort;
}

void Page_WebhookProjection_::setSort(const std::shared_ptr<Sort>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool Page_WebhookProjection_::sortIsSet() const
{
    return m_SortIsSet;
}

void Page_WebhookProjection_::unsetSort()
{
    m_SortIsSet = false;
}
int64_t Page_WebhookProjection_::getTotalElements() const
{
    return m_TotalElements;
}

void Page_WebhookProjection_::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool Page_WebhookProjection_::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void Page_WebhookProjection_::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t Page_WebhookProjection_::getTotalPages() const
{
    return m_TotalPages;
}

void Page_WebhookProjection_::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool Page_WebhookProjection_::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void Page_WebhookProjection_::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
}
