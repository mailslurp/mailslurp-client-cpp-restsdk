...
#ifndef COM_MAILSLURP_CLIENT_MODEL_PageAlias_H_
#define COM_MAILSLURP_CLIENT_MODEL_PageAlias_H_
...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<AliasProjection>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<AliasProjection>>& value);
...
protected:
    std::vector<std::shared_ptr<AliasProjection>> m_Content;
    bool m_ContentIsSet;
    bool m_Empty;
    bool m_EmptyIsSet;
    bool m_First;
...
#endif /* COM_MAILSLURP_CLIENT_MODEL_PageAlias_H_ */
