...
#include "Page_SentEmailProjection_.h"
...
Page_SentEmailProjection_::Page_SentEmailProjection_()
{
...
void Page_SentEmailProjection_::validate()
{
    // TODO: implement validation
}

web::json::value Page_SentEmailProjection_::toJson() const
{
...
bool Page_SentEmailProjection_::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Page_SentEmailProjection_::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Page_SentEmailProjection_::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::vector<std::shared_ptr<SentEmailProjection>>& Page_SentEmailProjection_::getContent()
{
    return m_Content;
}

void Page_SentEmailProjection_::setContent(const std::vector<std::shared_ptr<SentEmailProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool Page_SentEmailProjection_::contentIsSet() const
{
    return m_ContentIsSet;
}

void Page_SentEmailProjection_::unsetContent()
{
    m_ContentIsSet = false;
}
bool Page_SentEmailProjection_::isEmpty() const
{
    return m_Empty;
}

void Page_SentEmailProjection_::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool Page_SentEmailProjection_::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void Page_SentEmailProjection_::unsetEmpty()
{
    m_EmptyIsSet = false;
}
bool Page_SentEmailProjection_::isFirst() const
{
    return m_First;
}

void Page_SentEmailProjection_::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool Page_SentEmailProjection_::firstIsSet() const
{
    return m_FirstIsSet;
}

void Page_SentEmailProjection_::unsetFirst()
{
    m_FirstIsSet = false;
}
bool Page_SentEmailProjection_::isLast() const
{
    return m_Last;
}

void Page_SentEmailProjection_::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool Page_SentEmailProjection_::lastIsSet() const
{
    return m_LastIsSet;
}

void Page_SentEmailProjection_::unsetLast()
{
    m_LastIsSet = false;
}
int32_t Page_SentEmailProjection_::getNumber() const
{
    return m_number;
}

void Page_SentEmailProjection_::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool Page_SentEmailProjection_::numberIsSet() const
{
    return m_numberIsSet;
}

void Page_SentEmailProjection_::unsetnumber()
{
    m_numberIsSet = false;
}
int32_t Page_SentEmailProjection_::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void Page_SentEmailProjection_::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool Page_SentEmailProjection_::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void Page_SentEmailProjection_::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
std::shared_ptr<Pageable> Page_SentEmailProjection_::getPageable() const
{
    return m_Pageable;
}

void Page_SentEmailProjection_::setPageable(const std::shared_ptr<Pageable>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool Page_SentEmailProjection_::pageableIsSet() const
{
    return m_PageableIsSet;
}

void Page_SentEmailProjection_::unsetPageable()
{
    m_PageableIsSet = false;
}
int32_t Page_SentEmailProjection_::getSize() const
{
    return m_Size;
}

void Page_SentEmailProjection_::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool Page_SentEmailProjection_::sizeIsSet() const
{
    return m_SizeIsSet;
}

void Page_SentEmailProjection_::unsetSize()
{
    m_SizeIsSet = false;
}
std::shared_ptr<Sort> Page_SentEmailProjection_::getSort() const
{
    return m_Sort;
}

void Page_SentEmailProjection_::setSort(const std::shared_ptr<Sort>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool Page_SentEmailProjection_::sortIsSet() const
{
    return m_SortIsSet;
}

void Page_SentEmailProjection_::unsetSort()
{
    m_SortIsSet = false;
}
int64_t Page_SentEmailProjection_::getTotalElements() const
{
    return m_TotalElements;
}

void Page_SentEmailProjection_::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool Page_SentEmailProjection_::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void Page_SentEmailProjection_::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t Page_SentEmailProjection_::getTotalPages() const
{
    return m_TotalPages;
}

void Page_SentEmailProjection_::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool Page_SentEmailProjection_::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void Page_SentEmailProjection_::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
}
