...
/*
 * Page_EmailProjection_.h
 *
 * 
 */

#ifndef COM_MAILSLURP_CLIENT_MODEL_Page_EmailProjection__H_
#define COM_MAILSLURP_CLIENT_MODEL_Page_EmailProjection__H_
...
/// 
/// </summary>
class  Page_EmailProjection_
    : public ModelBase
{
public:
    Page_EmailProjection_();
    virtual ~Page_EmailProjection_();
    ...
    /////////////////////////////////////////////
    /// Page_EmailProjection_ members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<EmailProjection>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<EmailProjection>>& value);
...
protected:
    std::vector<std::shared_ptr<EmailProjection>> m_Content;
    bool m_ContentIsSet;
    bool m_Empty;
    bool m_EmptyIsSet;
    bool m_First;
...
#endif /* COM_MAILSLURP_CLIENT_MODEL_Page_EmailProjection__H_ */
