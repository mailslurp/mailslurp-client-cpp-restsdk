...
utility::string_t MissedEmail::getRawUrl() const
{
    return m_RawUrl;
}

void MissedEmail::setRawUrl(const utility::string_t& value)
{
    m_RawUrl = value;
    m_RawUrlIsSet = true;
}

bool MissedEmail::rawUrlIsSet() const
{
    return m_RawUrlIsSet;
}

void MissedEmail::unsetRawUrl()
{
    m_RawUrlIsSet = false;
}
utility::string_t MissedEmail::getRawKey() const
{
    return m_RawKey;
}

void MissedEmail::setRawKey(const utility::string_t& value)
{
    m_RawKey = value;
    m_RawKeyIsSet = true;
}

bool MissedEmail::rawKeyIsSet() const
{
    return m_RawKeyIsSet;
}

void MissedEmail::unsetRawKey()
{
    m_RawKeyIsSet = false;
}
utility::string_t MissedEmail::getRawBucket() const
{
    return m_RawBucket;
}

void MissedEmail::setRawBucket(const utility::string_t& value)
{
    m_RawBucket = value;
    m_RawBucketIsSet = true;
}

bool MissedEmail::rawBucketIsSet() const
{
    return m_RawBucketIsSet;
}

void MissedEmail::unsetRawBucket()
{
    m_RawBucketIsSet = false;
}
bool MissedEmail::isCanRestore() const
{
    return m_CanRestore;
}

void MissedEmail::setCanRestore(bool value)
{
    m_CanRestore = value;
    m_CanRestoreIsSet = true;
}

bool MissedEmail::canRestoreIsSet() const
{
    return m_CanRestoreIsSet;
}

void MissedEmail::unsetCanRestore()
{
    m_CanRestoreIsSet = false;
}
