...
web::json::value WebhookDto::toJson() const
{
    ...
    if(m_PhoneIdIsSet)
    {
        val[utility::conversions::to_string_t("phoneId")] = ModelBase::toJson(m_PhoneId);
    }
    if(m_InboxIdIsSet)
    {
    ...
    {
        val[utility::conversions::to_string_t("requestBodyTemplate")] = ModelBase::toJson(m_RequestBodyTemplate);
    }
    if(m_UrlIsSet)
    {
    ...
    {
        val[utility::conversions::to_string_t("requestHeaders")] = ModelBase::toJson(m_RequestHeaders);
    }
...
bool WebhookDto::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("phoneId")))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("phoneId"));
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_phoneId;
            ok &= ModelBase::fromJson(fieldValue, refVal_phoneId);
            setPhoneId(refVal_phoneId);
        }
    }
    ...
    if(val.has_field(utility::conversions::to_string_t("requestBodyTemplate")))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("requestBodyTemplate"));
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_requestBodyTemplate;
            ok &= ModelBase::fromJson(fieldValue, refVal_requestBodyTemplate);
            setRequestBodyTemplate(refVal_requestBodyTemplate);
        }
    }
    ...
    if(val.has_field(utility::conversions::to_string_t("requestHeaders")))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("requestHeaders"));
        if(!fieldValue.is_null())
        {
            std::shared_ptr<WebhookHeaders> refVal_requestHeaders;
            ok &= ModelBase::fromJson(fieldValue, refVal_requestHeaders);
            setRequestHeaders(refVal_requestHeaders);
        }
    }
    return ok;
}
...
void WebhookDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_PhoneIdIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("phoneId"), m_PhoneId));
    }
    if(m_InboxIdIsSet)
    {
    ...
    if(m_RequestBodyTemplateIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("requestBodyTemplate"), m_RequestBodyTemplate));
    }
    if(m_UrlIsSet)
    {
    ...
    if(m_RequestHeadersIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("requestHeaders"), m_RequestHeaders));
    }
}
...
bool WebhookDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("phoneId")))
    {
        utility::string_t refVal_phoneId;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t("phoneId")), refVal_phoneId );
        setPhoneId(refVal_phoneId);
    }
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("requestBodyTemplate")))
    {
        utility::string_t refVal_requestBodyTemplate;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t("requestBodyTemplate")), refVal_requestBodyTemplate );
        setRequestBodyTemplate(refVal_requestBodyTemplate);
    }
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("requestHeaders")))
    {
        std::shared_ptr<WebhookHeaders> refVal_requestHeaders;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t("requestHeaders")), refVal_requestHeaders );
        setRequestHeaders(refVal_requestHeaders);
    }
    return ok;
}
