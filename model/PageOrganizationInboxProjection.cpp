...
std::shared_ptr<Pageable> PageOrganizationInboxProjection::getPageable() const
{
    return m_Pageable;
}

void PageOrganizationInboxProjection::setPageable(const std::shared_ptr<Pageable>& value)
{
    m_Pageable = value;
