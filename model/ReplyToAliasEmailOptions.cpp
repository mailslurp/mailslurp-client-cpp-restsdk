...
std::shared_ptr<Object> ReplyToAliasEmailOptions::getTemplateVariables() const
{
    return m_TemplateVariables;
}

void ReplyToAliasEmailOptions::setTemplateVariables(const std::shared_ptr<Object>& value)
{
