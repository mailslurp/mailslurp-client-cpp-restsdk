...
/*
 * Page_WebhookProjection_.h
 *
 * 
 */

#ifndef COM_MAILSLURP_CLIENT_MODEL_Page_WebhookProjection__H_
#define COM_MAILSLURP_CLIENT_MODEL_Page_WebhookProjection__H_
...
/// 
/// </summary>
class  Page_WebhookProjection_
    : public ModelBase
{
public:
    Page_WebhookProjection_();
    virtual ~Page_WebhookProjection_();
    ...
    /////////////////////////////////////////////
    /// Page_WebhookProjection_ members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<WebhookProjection>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<WebhookProjection>>& value);
...
protected:
    std::vector<std::shared_ptr<WebhookProjection>> m_Content;
    bool m_ContentIsSet;
    bool m_Empty;
    bool m_EmptyIsSet;
    bool m_First;
...
#endif /* COM_MAILSLURP_CLIENT_MODEL_Page_WebhookProjection__H_ */
