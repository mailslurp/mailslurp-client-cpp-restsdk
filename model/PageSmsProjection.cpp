...
bool PageSmsProjection::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("content")))
    {
        ...
        {
            std::vector<std::shared_ptr<SmsProjection>> refVal_content;
...
int64_t PageSmsProjection::getTotal() const
{
    return m_Total;
}

void PageSmsProjection::setTotal(int64_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool PageSmsProjection::totalIsSet() const
{
    return m_TotalIsSet;
}

void PageSmsProjection::unsetTotal()
{
    m_TotalIsSet = false;
}
...
std::shared_ptr<Sort> PageSmsProjection::getSort() const
{
    return m_Sort;
}

void PageSmsProjection::setSort(const std::shared_ptr<Sort>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
