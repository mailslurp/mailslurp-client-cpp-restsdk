...
bool PageAttachmentEntity::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("content")))
    {
        ...
        {
            std::vector<std::shared_ptr<AttachmentEntity>> refVal_content;
...
std::vector<std::shared_ptr<AttachmentEntity>>& PageAttachmentEntity::getContent()
{
    return m_Content;
}

void PageAttachmentEntity::setContent(const std::vector<std::shared_ptr<AttachmentEntity>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
