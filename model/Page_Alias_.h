...
#ifndef COM_MAILSLURP_CLIENT_MODEL_Page_Alias__H_
#define COM_MAILSLURP_CLIENT_MODEL_Page_Alias__H_
...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<Alias>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<Alias>>& value);
...
protected:
    std::vector<std::shared_ptr<Alias>> m_Content;
    bool m_ContentIsSet;
    bool m_Empty;
    bool m_EmptyIsSet;
    bool m_First;
...
#endif /* COM_MAILSLURP_CLIENT_MODEL_Page_Alias__H_ */
