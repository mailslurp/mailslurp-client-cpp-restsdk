...
#include "InboxRulesetProjection.h"
...
void InboxRulesetProjection::validate()
{
    // TODO: implement validation
}

web::json::value InboxRulesetProjection::toJson() const
{
...
bool InboxRulesetProjection::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void InboxRulesetProjection::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool InboxRulesetProjection::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
utility::string_t InboxRulesetProjection::getAction() const
{
    return m_Action;
}

void InboxRulesetProjection::setAction(const utility::string_t& value)
{
    m_Action = value;
    m_ActionIsSet = true;
}

bool InboxRulesetProjection::actionIsSet() const
{
    return m_ActionIsSet;
}

void InboxRulesetProjection::unsetAction()
{
    m_ActionIsSet = false;
}
utility::string_t InboxRulesetProjection::getHandler() const
{
    return m_Handler;
}

void InboxRulesetProjection::setHandler(const utility::string_t& value)
{
    m_Handler = value;
    m_HandlerIsSet = true;
}

bool InboxRulesetProjection::handlerIsSet() const
{
    return m_HandlerIsSet;
}

void InboxRulesetProjection::unsetHandler()
{
    m_HandlerIsSet = false;
}
utility::string_t InboxRulesetProjection::getId() const
{
    return m_Id;
}

void InboxRulesetProjection::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool InboxRulesetProjection::idIsSet() const
{
    return m_IdIsSet;
}

void InboxRulesetProjection::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t InboxRulesetProjection::getInboxId() const
{
    return m_InboxId;
}

void InboxRulesetProjection::setInboxId(const utility::string_t& value)
{
    m_InboxId = value;
    m_InboxIdIsSet = true;
}

bool InboxRulesetProjection::inboxIdIsSet() const
{
    return m_InboxIdIsSet;
}

void InboxRulesetProjection::unsetInboxId()
{
    m_InboxIdIsSet = false;
}
utility::string_t InboxRulesetProjection::getScope() const
{
    return m_Scope;
}

void InboxRulesetProjection::setScope(const utility::string_t& value)
{
    m_Scope = value;
    m_ScopeIsSet = true;
}

bool InboxRulesetProjection::scopeIsSet() const
{
    return m_ScopeIsSet;
}

void InboxRulesetProjection::unsetScope()
{
    m_ScopeIsSet = false;
}
utility::string_t InboxRulesetProjection::getTarget() const
{
    return m_Target;
}

void InboxRulesetProjection::setTarget(const utility::string_t& value)
{
    m_Target = value;
    m_TargetIsSet = true;
}

bool InboxRulesetProjection::targetIsSet() const
{
    return m_TargetIsSet;
}

void InboxRulesetProjection::unsetTarget()
{
    m_TargetIsSet = false;
}
}
