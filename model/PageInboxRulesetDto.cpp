...
int64_t PageInboxRulesetDto::getTotal() const
{
    return m_Total;
}

void PageInboxRulesetDto::setTotal(int64_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool PageInboxRulesetDto::totalIsSet() const
{
    return m_TotalIsSet;
}

void PageInboxRulesetDto::unsetTotal()
{
    m_TotalIsSet = false;
}
