...
int64_t PageContactProjection::getTotal() const
{
    return m_Total;
}

void PageContactProjection::setTotal(int64_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool PageContactProjection::totalIsSet() const
{
    return m_TotalIsSet;
}

void PageContactProjection::unsetTotal()
{
    m_TotalIsSet = false;
}
...
std::shared_ptr<Sort> PageContactProjection::getSort() const
{
    return m_Sort;
}

void PageContactProjection::setSort(const std::shared_ptr<Sort>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
