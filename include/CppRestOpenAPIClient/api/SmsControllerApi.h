...
public:
    ...
    pplx::task<std::shared_ptr<ExtractCodesResult>> getSmsCodes(
        utility::string_t smsId,
    ...
    /// </remarks>
    /// <param name="read"> (optional, default to false)</param>
    /// <param name="phoneNumberId"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<void> markAllSmsAsRead(
    ...
    /// <param name="smsId"></param>
    /// <param name="read"> (optional, default to false)</param>
    pplx::task<std::shared_ptr<SmsDto>> markSmsAsRead(
        utility::string_t smsId,
        boost::optional<bool> read
    ) const;
    /// <summary>
