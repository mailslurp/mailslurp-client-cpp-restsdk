...
public:
    ...
    /// <param name="createWebhookOptions"></param>
    pplx::task<std::shared_ptr<WebhookDto>> createWebhookForAITransformer(
        utility::string_t transformerId,
        std::shared_ptr<CreateWebhookOptions> createWebhookOptions
    ) const;
    /// <summary>
    ...
    /// <param name="aiTransformerId">AI Transformer ID (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<PageWebhookResult>> getAllWebhookResults(
        ...
        boost::optional<utility::string_t> phoneId,
        boost::optional<utility::string_t> aiTransformerId
    ) const;
    /// <summary>
    ...
    /// <param name="since">Filter by created at after the given timestamp (optional, default to utility::datetime())</param>
    /// <param name="inboxId">Filter by inboxId (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="aiTransformerId">Filter by aiTransformerId (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="phoneId">Filter by phoneId (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="before">Filter by created at before the given timestamp (optional, default to utility::datetime())</param>
    /// <param name="health">Filter by webhook health (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="eventType">Optional event type (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="url">Optional url endpoint filter (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="eventTypeSource">Webhook source type category such as phone, inbox, aiTranformer (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="includeAccountWide">Include account scope webhooks when passing phoneId, inboxId, or aiTransformerId filters (optional, default to false)</param>
    pplx::task<std::shared_ptr<PageWebhookProjection>> getAllWebhooks(
        ...
        boost::optional<utility::string_t> eventTypeSource,
        boost::optional<bool> includeAccountWide
    ) const;
    /// <summary>
    ...
    /// <param name="health">Filter by webhook health (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="eventType">Optional event type (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="includeAccountWide">Include account scope inbox webhooks (optional, default to false)</param>
    ...
    /// <param name="searchFilter">Optional search filter (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="health">Filter by webhook health (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="includeAccountWide">Include account scope phone webhooks (optional, default to false)</param>
    ...
    /// 
    /// </remarks>
    pplx::task<std::shared_ptr<WebhookNewAITransformResultPayload>> getTestWebhookPayloadNewAITransformResult(
    ) const;
    /// <summary>
    ...
    /// <param name="aiTransformerId"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
