...
public:
    ...
    pplx::task<std::shared_ptr<TotpDeviceDto>> createTotpDeviceForBase32SecretKey(
        std::shared_ptr<CreateTotpDeviceBase32SecretKeyOptions> createTotpDeviceBase32SecretKeyOptions
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<TotpDeviceDto>> createTotpDeviceForCustom(
        std::shared_ptr<CreateTotpDeviceCustomOptions> createTotpDeviceCustomOptions
    ) const;
    /// <summary>
