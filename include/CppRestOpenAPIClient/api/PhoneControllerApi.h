...
public:
    ...
    pplx::task<std::shared_ptr<PhoneNumberDto>> addPhoneNumberTags(
        utility::string_t phoneNumberId,
        std::shared_ptr<PhoneNumberTagsOptions> phoneNumberTagsOptions
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="phoneNumberId"></param>
    pplx::task<std::vector<utility::string_t>> getPhoneNumberTags(
        utility::string_t phoneNumberId
    ) const;
    /// <summary>
    /// Get phone numbers
    ...
    /// <param name="tag">Optional tags to filter by. A phone must include all provided tags (optional, default to std::vector&lt;std::shared_ptr&lt;utility::string_t&gt;&gt;())</param>
    ...
    pplx::task<std::shared_ptr<PagePhoneNumberProjection>> getPhoneNumbers(
        ...
        boost::optional<std::vector<utility::string_t>> tag,
    ...
    /// </remarks>
    /// <param name="search">Optional search filter (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::vector<utility::string_t>> getPhoneTags(
        boost::optional<utility::string_t> search
    ) const;
    /// <summary>
    ...
    /// <param name="phoneNumberId"></param>
    /// <param name="phoneNumberTagsOptions"></param>
    pplx::task<std::shared_ptr<PhoneNumberDto>> removePhoneNumberTags(
        utility::string_t phoneNumberId,
        std::shared_ptr<PhoneNumberTagsOptions> phoneNumberTagsOptions
    ) const;
    /// <summary>
    ...
    /// <param name="phoneNumberId"></param>
    /// <param name="phoneNumberTagsOptions"></param>
    pplx::task<std::shared_ptr<PhoneNumberDto>> setPhoneNumberTags(
        utility::string_t phoneNumberId,
        std::shared_ptr<PhoneNumberTagsOptions> phoneNumberTagsOptions
    ) const;
    /// <summary>
