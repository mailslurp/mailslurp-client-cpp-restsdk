...
public:
    ...
    /// </remarks>
    /// <param name="accountRegion">Optional account region filter (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<TenantReputationFindingsDto>> getTenantReputationFindings(
        boost::optional<utility::string_t> accountRegion
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="accountRegion">Optional account region filter (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<TenantReputationStatusSummaryDto>> getTenantReputationStatusSummary(
        boost::optional<utility::string_t> accountRegion
    ) const;
