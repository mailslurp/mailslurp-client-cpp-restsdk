...
public:
    ...
    /// <param name="inboxId">Optional inbox ID to filter for (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="emailId">Optional email ID to filter for (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="sentId">Optional sent ID to filter for (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
