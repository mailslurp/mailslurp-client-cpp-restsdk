...
public:
    ...
    pplx::task<std::shared_ptr<ExportTransformerResponse>> exportTransformerResults(
        std::shared_ptr<ExportTransformerOptions> exportTransformerOptions
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<std::shared_ptr<ExportTransformerResultJobDto>> getExportTransformerResultsJob(
        utility::string_t id
    ) const;
    /// <summary>
    /// Get a transformer
    ...
    /// <param name="smsId"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="attachmentId"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="aiTransformId"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    ...
    /// <param name="size">Optional page size. Maximum size is 100. Use page index and sort to page through larger results (optional, default to 0)</param>
    /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<PageTableData>> getTransformerResultsTable(
    ...
    /// <param name="smsId"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="attachmentId"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<AITransformMappingMatchResult>> testTransformerMappingMatch(
        utility::string_t id,
        boost::optional<utility::string_t> emailId,
        boost::optional<utility::string_t> smsId,
        boost::optional<utility::string_t> attachmentId
