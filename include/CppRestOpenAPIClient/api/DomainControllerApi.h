...
public:
    ...
    pplx::task<std::shared_ptr<DomainRegionGroupsDto>> getAvailableDomainRegions(
    ...
    /// </remarks>
    /// <param name="inboxType"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<DomainGroupsDto>> getAvailableDomains(
        boost::optional<utility::string_t> inboxType
    ) const;
    /// <summary>
    /// Get a domain
    ...
    /// </remarks>
    /// <param name="inboxType"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<DomainGroupsDto>> getMailSlurpDomains(
        boost::optional<utility::string_t> inboxType
    ) const;
    /// <summary>
    /// Update a domain
