...
public:
    ...
    pplx::task<std::shared_ptr<ExtractAttachmentTextResult>> extractAttachmentText(
        utility::string_t attachmentId,
        boost::optional<std::shared_ptr<ExtractAttachmentTextOptions>> extractAttachmentTextOptions
    ) const;
    /// <summary>
    ...
    pplx::task<std::vector<utility::string_t>> uploadMultipartForm(
        ...
        boost::optional<std::shared_ptr<ImportEmailIntoInboxMultipart_request>> importEmailIntoInboxMultipartRequest
    ) const;
