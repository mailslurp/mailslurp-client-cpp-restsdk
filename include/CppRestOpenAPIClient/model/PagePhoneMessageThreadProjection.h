...
/*
 * PagePhoneMessageThreadProjection.h
 *
...
#ifndef COM_MAILSLURP_CLIENT_MODEL_PagePhoneMessageThreadProjection_H_
#define COM_MAILSLURP_CLIENT_MODEL_PagePhoneMessageThreadProjection_H_
...
public:
    ...
    virtual ~PagePhoneMessageThreadProjection();
    ...
    /////////////////////////////////////////////
    /// PagePhoneMessageThreadProjection members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<PhoneMessageThreadProjection>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<PhoneMessageThreadProjection>>& value);
...
protected:
    std::vector<std::shared_ptr<PhoneMessageThreadProjection>> m_Content;
    bool m_ContentIsSet;
...
#endif /* COM_MAILSLURP_CLIENT_MODEL_PagePhoneMessageThreadProjection_H_ */
