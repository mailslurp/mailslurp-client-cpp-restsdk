...
/*
 * PageAITransformMappingProjection.h
 *
...
#ifndef COM_MAILSLURP_CLIENT_MODEL_PageAITransformMappingProjection_H_
#define COM_MAILSLURP_CLIENT_MODEL_PageAITransformMappingProjection_H_
...
public:
    ...
    virtual ~PageAITransformMappingProjection();
    ...
    /////////////////////////////////////////////
    /// PageAITransformMappingProjection members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<AITransformMappingProjection>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<AITransformMappingProjection>>& value);
...
protected:
    std::vector<std::shared_ptr<AITransformMappingProjection>> m_Content;
    bool m_ContentIsSet;
...
#endif /* COM_MAILSLURP_CLIENT_MODEL_PageAITransformMappingProjection_H_ */
