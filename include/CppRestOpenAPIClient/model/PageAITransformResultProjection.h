...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<AITransformResultProjection>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<AITransformResultProjection>>& value);
...
protected:
    std::vector<std::shared_ptr<AITransformResultProjection>> m_Content;
    bool m_ContentIsSet;
