...
#ifndef COM_MAILSLURP_CLIENT_MODEL_PageComplaint_H_
#define COM_MAILSLURP_CLIENT_MODEL_PageComplaint_H_
...
public:
    ...
    /////////////////////////////////////////////
    /// PageComplaint members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<Complaint>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<Complaint>>& value);
...
protected:
    std::vector<std::shared_ptr<Complaint>> m_Content;
    bool m_ContentIsSet;
...
#endif /* COM_MAILSLURP_CLIENT_MODEL_PageComplaint_H_ */
