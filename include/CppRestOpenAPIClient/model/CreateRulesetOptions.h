...
/*
 * CreateRulesetOptions.h
 *
 * Options for creating inbox rulesets. Inbox rulesets can be used to block, allow, filter, or forward emails when sending or receiving using the inbox.
 */

#ifndef COM_MAILSLURP_CLIENT_MODEL_CreateRulesetOptions_H_
#define COM_MAILSLURP_CLIENT_MODEL_CreateRulesetOptions_H_
...
#endif /* COM_MAILSLURP_CLIENT_MODEL_CreateRulesetOptions_H_ */
