...
#ifndef COM_MAILSLURP_CLIENT_MODEL_PageSmsProjection_H_
#define COM_MAILSLURP_CLIENT_MODEL_PageSmsProjection_H_
...
public:
    ...
    /////////////////////////////////////////////
    /// PageSmsProjection members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<SmsProjection>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<SmsProjection>>& value);
...
protected:
    std::vector<std::shared_ptr<SmsProjection>> m_Content;
    bool m_ContentIsSet;
...
#endif /* COM_MAILSLURP_CLIENT_MODEL_PageSmsProjection_H_ */
