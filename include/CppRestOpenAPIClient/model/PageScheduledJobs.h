...
#ifndef COM_MAILSLURP_CLIENT_MODEL_PageScheduledJobs_H_
#define COM_MAILSLURP_CLIENT_MODEL_PageScheduledJobs_H_
...
public:
    ...
    /////////////////////////////////////////////
    /// PageScheduledJobs members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<ScheduledJob>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<ScheduledJob>>& value);
...
protected:
    std::vector<std::shared_ptr<ScheduledJob>> m_Content;
    bool m_ContentIsSet;
...
#endif /* COM_MAILSLURP_CLIENT_MODEL_PageScheduledJobs_H_ */
