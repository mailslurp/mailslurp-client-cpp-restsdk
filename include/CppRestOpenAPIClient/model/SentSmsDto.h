...
#ifndef COM_MAILSLURP_CLIENT_MODEL_SentSmsDto_H_
#define COM_MAILSLURP_CLIENT_MODEL_SentSmsDto_H_
...
public:
    ...
    /// 
    /// </summary>
    utility::string_t getReplyToSid() const;
    bool replyToSidIsSet() const;
    void unsetReplyToSid();

    void setReplyToSid(const utility::string_t& value);
...
protected:
    ...
    bool m_SidIsSet;
    utility::string_t m_ReplyToSid;
    bool m_ReplyToSidIsSet;
...
#endif /* COM_MAILSLURP_CLIENT_MODEL_SentSmsDto_H_ */
