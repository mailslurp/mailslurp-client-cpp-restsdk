...
#ifndef COM_MAILSLURP_CLIENT_MODEL_PageBouncedEmail_H_
#define COM_MAILSLURP_CLIENT_MODEL_PageBouncedEmail_H_
...
public:
    ...
    /////////////////////////////////////////////
    /// PageBouncedEmail members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<BounceProjection>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<BounceProjection>>& value);
...
protected:
    std::vector<std::shared_ptr<BounceProjection>> m_Content;
    bool m_ContentIsSet;
...
#endif /* COM_MAILSLURP_CLIENT_MODEL_PageBouncedEmail_H_ */
