...
public:
    ...
    /// 
    /// </summary>
    std::vector<utility::string_t>& getAttachmentNames();
    bool attachmentNamesIsSet() const;
    void unsetAttachmentNames();

    void setAttachmentNames(const std::vector<utility::string_t>& value);
    ...
    /// 
    /// </summary>
    utility::string_t getBodyUrl() const;
    bool bodyUrlIsSet() const;
    void unsetBodyUrl();

    void setBodyUrl(const utility::string_t& value);
...
protected:
    ...
    std::vector<utility::string_t> m_AttachmentNames;
    bool m_AttachmentNamesIsSet;
