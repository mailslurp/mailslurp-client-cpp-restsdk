...
/*
 * PageWebhookEndpointProjection.h
 *
...
#ifndef COM_MAILSLURP_CLIENT_MODEL_PageWebhookEndpointProjection_H_
#define COM_MAILSLURP_CLIENT_MODEL_PageWebhookEndpointProjection_H_
...
public:
    ...
    virtual ~PageWebhookEndpointProjection();
    ...
    /////////////////////////////////////////////
    /// PageWebhookEndpointProjection members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<WebhookEndpointProjection>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<WebhookEndpointProjection>>& value);
...
protected:
    std::vector<std::shared_ptr<WebhookEndpointProjection>> m_Content;
    bool m_ContentIsSet;
...
#endif /* COM_MAILSLURP_CLIENT_MODEL_PageWebhookEndpointProjection_H_ */
