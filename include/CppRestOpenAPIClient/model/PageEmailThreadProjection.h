...
/*
 * PageEmailThreadProjection.h
 *
 * Paginated email thread projection results.
 */

#ifndef COM_MAILSLURP_CLIENT_MODEL_PageEmailThreadProjection_H_
#define COM_MAILSLURP_CLIENT_MODEL_PageEmailThreadProjection_H_
...
public:
    ...
    virtual ~PageEmailThreadProjection();
    ...
    /////////////////////////////////////////////
    /// PageEmailThreadProjection members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<EmailThreadProjection>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<EmailThreadProjection>>& value);
...
protected:
    std::vector<std::shared_ptr<EmailThreadProjection>> m_Content;
    bool m_ContentIsSet;
...
#endif /* COM_MAILSLURP_CLIENT_MODEL_PageEmailThreadProjection_H_ */
