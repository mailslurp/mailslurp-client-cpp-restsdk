...
#ifndef COM_MAILSLURP_CLIENT_MODEL_PageConnectorSyncEvents_H_
#define COM_MAILSLURP_CLIENT_MODEL_PageConnectorSyncEvents_H_
...
public:
    ...
    virtual ~PageConnectorSyncEvents();
    ...
    /////////////////////////////////////////////
    /// PageConnectorSyncEvents members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<ConnectorSyncEventProjection>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<ConnectorSyncEventProjection>>& value);
...
protected:
    std::vector<std::shared_ptr<ConnectorSyncEventProjection>> m_Content;
    bool m_ContentIsSet;
...
#endif /* COM_MAILSLURP_CLIENT_MODEL_PageConnectorSyncEvents_H_ */
