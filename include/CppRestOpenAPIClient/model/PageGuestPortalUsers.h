...
/*
 * PageGuestPortalUsers.h
 *
 * Paginated guest portal users
 */

#ifndef COM_MAILSLURP_CLIENT_MODEL_PageGuestPortalUsers_H_
#define COM_MAILSLURP_CLIENT_MODEL_PageGuestPortalUsers_H_
...
public:
    ...
    /////////////////////////////////////////////
    /// PageGuestPortalUsers members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<GuestPortalUserProjection>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<GuestPortalUserProjection>>& value);
...
protected:
    std::vector<std::shared_ptr<GuestPortalUserProjection>> m_Content;
    bool m_ContentIsSet;
...
#endif /* COM_MAILSLURP_CLIENT_MODEL_PageGuestPortalUsers_H_ */
