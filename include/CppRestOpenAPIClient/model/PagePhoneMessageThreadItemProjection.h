...
/*
 * PagePhoneMessageThreadItemProjection.h
 *
...
#ifndef COM_MAILSLURP_CLIENT_MODEL_PagePhoneMessageThreadItemProjection_H_
#define COM_MAILSLURP_CLIENT_MODEL_PagePhoneMessageThreadItemProjection_H_
...
public:
    ...
    virtual ~PagePhoneMessageThreadItemProjection();
    ...
    /////////////////////////////////////////////
    /// PagePhoneMessageThreadItemProjection members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<PhoneMessageThreadItemProjection>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<PhoneMessageThreadItemProjection>>& value);
...
protected:
    std::vector<std::shared_ptr<PhoneMessageThreadItemProjection>> m_Content;
    bool m_ContentIsSet;
...
#endif /* COM_MAILSLURP_CLIENT_MODEL_PagePhoneMessageThreadItemProjection_H_ */
