...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<InboxPreview>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<InboxPreview>>& value);
...
protected:
    std::vector<std::shared_ptr<InboxPreview>> m_Content;
    bool m_ContentIsSet;
