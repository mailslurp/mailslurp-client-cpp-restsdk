...
public:
    ...
    /// </summary>
    bool isUseShortAddress() const;
    bool useShortAddressIsSet() const;
    void unsetUseShortAddress();

    void setUseShortAddress(bool value);
...
protected:
    ...
    bool m_UseShortAddress;
    bool m_UseShortAddressIsSet;
};
