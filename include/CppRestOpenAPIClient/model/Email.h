...
public:
    ...
    /// </summary>
    std::map<utility::string_t, std::vector<utility::string_t>>& getHeadersMap();
    bool headersMapIsSet() const;
    void unsetHeadersMap();

    void setHeadersMap(const std::map<utility::string_t, std::vector<utility::string_t>>& value);
    ...
    /// 
    /// </summary>
    bool isXampHtml() const;
    bool xampHtmlIsSet() const;
    void unsetXampHtml();

    void setXampHtml(bool value);
...
protected:
    ...
    bool m_HeadersIsSet;
    std::map<utility::string_t, std::vector<utility::string_t>> m_HeadersMap;
    bool m_HeadersMapIsSet;
