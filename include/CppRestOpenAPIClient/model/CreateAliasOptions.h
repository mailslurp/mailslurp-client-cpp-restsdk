...
public:
    ...
    /// </summary>
    bool isVerifyEmailAddress() const;
    bool verifyEmailAddressIsSet() const;
    void unsetVerifyEmailAddress();

    void setVerifyEmailAddress(bool value);
...
protected:
    ...
    bool m_VerifyEmailAddress;
    bool m_VerifyEmailAddressIsSet;
};
