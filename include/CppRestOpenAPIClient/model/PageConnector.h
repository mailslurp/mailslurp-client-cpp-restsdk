...
#ifndef COM_MAILSLURP_CLIENT_MODEL_PageConnector_H_
#define COM_MAILSLURP_CLIENT_MODEL_PageConnector_H_
...
public:
    ...
    /////////////////////////////////////////////
    /// PageConnector members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<ConnectorProjection>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<ConnectorProjection>>& value);
...
protected:
    std::vector<std::shared_ptr<ConnectorProjection>> m_Content;
    bool m_ContentIsSet;
...
#endif /* COM_MAILSLURP_CLIENT_MODEL_PageConnector_H_ */
