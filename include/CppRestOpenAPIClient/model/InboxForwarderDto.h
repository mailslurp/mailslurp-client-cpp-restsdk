...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<InboxAutomationMatchOptions> getMatchOptions() const;
    bool matchOptionsIsSet() const;
    void unsetMatchOptions();

    void setMatchOptions(const std::shared_ptr<InboxAutomationMatchOptions>& value);

    /// <summary>
    /// Method for extracting text from attachments.
    /// </summary>
    utility::string_t getAttachmentTextExtractionMethod() const;
    bool attachmentTextExtractionMethodIsSet() const;
    void unsetAttachmentTextExtractionMethod();

    void setAttachmentTextExtractionMethod(const utility::string_t& value);
...
protected:
    ...
    bool m_ShouldIsSet;
    std::shared_ptr<InboxAutomationMatchOptions> m_MatchOptions;
    bool m_MatchOptionsIsSet;
    utility::string_t m_AttachmentTextExtractionMethod;
    bool m_AttachmentTextExtractionMethodIsSet;
};
