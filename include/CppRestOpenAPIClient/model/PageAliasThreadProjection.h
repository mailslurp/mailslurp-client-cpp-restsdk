...
/*
 * PageAliasThreadProjection.h
 *
 * Paginated alias thread projection results.
 */

#ifndef COM_MAILSLURP_CLIENT_MODEL_PageAliasThreadProjection_H_
#define COM_MAILSLURP_CLIENT_MODEL_PageAliasThreadProjection_H_
...
public:
    ...
    virtual ~PageAliasThreadProjection();
    ...
    /////////////////////////////////////////////
    /// PageAliasThreadProjection members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<AliasThreadProjection>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<AliasThreadProjection>>& value);
...
protected:
    std::vector<std::shared_ptr<AliasThreadProjection>> m_Content;
    bool m_ContentIsSet;
...
#endif /* COM_MAILSLURP_CLIENT_MODEL_PageAliasThreadProjection_H_ */
