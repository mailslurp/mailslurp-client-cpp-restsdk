...
/*
 * PageDevicePreviewRunProjection.h
 *
...
#ifndef COM_MAILSLURP_CLIENT_MODEL_PageDevicePreviewRunProjection_H_
#define COM_MAILSLURP_CLIENT_MODEL_PageDevicePreviewRunProjection_H_
...
public:
    ...
    virtual ~PageDevicePreviewRunProjection();
    ...
    /////////////////////////////////////////////
    /// PageDevicePreviewRunProjection members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<DevicePreviewRunDto>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<DevicePreviewRunDto>>& value);
...
protected:
    std::vector<std::shared_ptr<DevicePreviewRunDto>> m_Content;
    bool m_ContentIsSet;
...
#endif /* COM_MAILSLURP_CLIENT_MODEL_PageDevicePreviewRunProjection_H_ */
