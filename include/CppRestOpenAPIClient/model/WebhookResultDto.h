...
public:
    ...
    /// 
    /// </summary>
    utility::string_t getAiTransformerId() const;
    bool aiTransformerIdIsSet() const;
    void unsetAiTransformerId();

    void setAiTransformerId(const utility::string_t& value);
...
protected:
    ...
    bool m_SmsIdIsSet;
    utility::string_t m_AiTransformerId;
    bool m_AiTransformerIdIsSet;
};
