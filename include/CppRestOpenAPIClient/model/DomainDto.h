...
public:
    ...
    /// </summary>
    utility::string_t getDuplicateRecordsMessage() const;
    bool duplicateRecordsMessageIsSet() const;
    void unsetDuplicateRecordsMessage();

    void setDuplicateRecordsMessage(const utility::string_t& value);

    /// <summary>
    /// Whether the domain has duplicated required records. If true then see the domain in the dashboard app.
    /// </summary>
    bool isHasDuplicateRecords() const;
    bool hasDuplicateRecordsIsSet() const;
    void unsetHasDuplicateRecords();

    void setHasDuplicateRecords(bool value);

    /// <summary>
    /// If the domain is missing records then show which pairs are missing.
    /// </summary>
    utility::string_t getMissingRecordsMessage() const;
    bool missingRecordsMessageIsSet() const;
    void unsetMissingRecordsMessage();

    void setMissingRecordsMessage(const utility::string_t& value);

    /// <summary>
    /// Whether the domain has missing required records. If true then see the domain in the dashboard app.
    /// </summary>
    bool isHasMissingRecords() const;
    bool hasMissingRecordsIsSet() const;
    void unsetHasMissingRecords();

    void setHasMissingRecords(bool value);
...
protected:
    ...
    utility::string_t m_DuplicateRecordsMessage;
    bool m_DuplicateRecordsMessageIsSet;
    bool m_HasDuplicateRecords;
    bool m_HasDuplicateRecordsIsSet;
    utility::string_t m_MissingRecordsMessage;
    bool m_MissingRecordsMessageIsSet;
    bool m_HasMissingRecords;
    bool m_HasMissingRecordsIsSet;
    bool m_IsVerified;
