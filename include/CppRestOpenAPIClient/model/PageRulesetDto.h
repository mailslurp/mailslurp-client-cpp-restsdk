...
#ifndef COM_MAILSLURP_CLIENT_MODEL_PageRulesetDto_H_
#define COM_MAILSLURP_CLIENT_MODEL_PageRulesetDto_H_
...
public:
    ...
    /////////////////////////////////////////////
    /// PageRulesetDto members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<RulesetDto>>& getContent();
    bool contentIsSet() const;
    void unsetContent();

    void setContent(const std::vector<std::shared_ptr<RulesetDto>>& value);
...
protected:
    std::vector<std::shared_ptr<RulesetDto>> m_Content;
    bool m_ContentIsSet;
...
#endif /* COM_MAILSLURP_CLIENT_MODEL_PageRulesetDto_H_ */
