...
pplx::task<utility::string_t> FormControllerApi::submitForm(boost::optional<utility::string_t> to, boost::optional<utility::string_t> subject, boost::optional<utility::string_t> emailAddress, boost::optional<utility::string_t> successMessage, boost::optional<utility::string_t> spamCheck, boost::optional<utility::string_t> otherParameters) const
{
