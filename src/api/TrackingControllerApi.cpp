...
#include "CppRestOpenAPIClient/api/TrackingControllerApi.h"
...
pplx::task<std::shared_ptr<TrackingPixelDto>> TrackingControllerApi::getTrackingPixel(utility::string_t id) const
{
