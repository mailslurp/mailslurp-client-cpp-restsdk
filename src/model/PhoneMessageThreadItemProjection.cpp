...
utility::string_t PhoneMessageThreadItemProjection::getId() const
{
    return m_Id;
}

void PhoneMessageThreadItemProjection::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool PhoneMessageThreadItemProjection::idIsSet() const
{
    return m_IdIsSet;
}

void PhoneMessageThreadItemProjection::unsetId()
{
    m_IdIsSet = false;
}
}
