...
void PageInboxTags::validate()
{
    // TODO: implement validation
}

web::json::value PageInboxTags::toJson() const
{
...
bool PageInboxTags::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PageInboxTags::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageInboxTags::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<utility::string_t>& PageInboxTags::getContent()
{
    return m_Content;
}

void PageInboxTags::setContent(const std::vector<utility::string_t>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageInboxTags::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageInboxTags::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageInboxTags::getPageable() const
{
    return m_Pageable;
}

void PageInboxTags::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageInboxTags::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageInboxTags::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PageInboxTags::getTotalElements() const
{
    return m_TotalElements;
}

void PageInboxTags::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageInboxTags::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageInboxTags::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PageInboxTags::getTotalPages() const
{
    return m_TotalPages;
}

void PageInboxTags::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageInboxTags::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageInboxTags::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PageInboxTags::isLast() const
{
    return m_Last;
}

void PageInboxTags::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageInboxTags::lastIsSet() const
{
    return m_LastIsSet;
}

void PageInboxTags::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageInboxTags::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageInboxTags::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageInboxTags::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageInboxTags::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
std::shared_ptr<SortObject> PageInboxTags::getSort() const
{
    return m_Sort;
}

void PageInboxTags::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageInboxTags::sortIsSet() const
{
    return m_SortIsSet;
}

void PageInboxTags::unsetSort()
{
    m_SortIsSet = false;
}
bool PageInboxTags::isFirst() const
{
    return m_First;
}

void PageInboxTags::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageInboxTags::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageInboxTags::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageInboxTags::getSize() const
{
    return m_Size;
}

void PageInboxTags::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageInboxTags::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageInboxTags::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageInboxTags::getNumber() const
{
    return m_number;
}

void PageInboxTags::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageInboxTags::numberIsSet() const
{
    return m_numberIsSet;
}

void PageInboxTags::unsetnumber()
{
    m_numberIsSet = false;
}
bool PageInboxTags::isEmpty() const
{
    return m_Empty;
}

void PageInboxTags::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageInboxTags::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageInboxTags::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
