...
utility::string_t TestInboxRulesetSendingOptions::getPhoneId() const
{
    return m_PhoneId;
}

void TestInboxRulesetSendingOptions::setPhoneId(const utility::string_t& value)
{
    m_PhoneId = value;
    m_PhoneIdIsSet = true;
}

bool TestInboxRulesetSendingOptions::phoneIdIsSet() const
{
    return m_PhoneIdIsSet;
}

void TestInboxRulesetSendingOptions::unsetPhoneId()
{
    m_PhoneIdIsSet = false;
}
