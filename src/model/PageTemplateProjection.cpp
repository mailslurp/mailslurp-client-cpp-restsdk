...
void PageTemplateProjection::validate()
{
    // TODO: implement validation
}

web::json::value PageTemplateProjection::toJson() const
{
...
bool PageTemplateProjection::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<TemplateProjection>> refVal_setContent;
...
void PageTemplateProjection::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageTemplateProjection::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<TemplateProjection>>& PageTemplateProjection::getContent()
{
    return m_Content;
}

void PageTemplateProjection::setContent(const std::vector<std::shared_ptr<TemplateProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageTemplateProjection::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageTemplateProjection::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageTemplateProjection::getPageable() const
{
    return m_Pageable;
}

void PageTemplateProjection::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageTemplateProjection::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageTemplateProjection::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PageTemplateProjection::getTotal() const
{
    return m_Total;
}

void PageTemplateProjection::setTotal(int64_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool PageTemplateProjection::totalIsSet() const
{
    return m_TotalIsSet;
}

void PageTemplateProjection::unsetTotal()
{
    m_TotalIsSet = false;
}
int64_t PageTemplateProjection::getTotalElements() const
{
    return m_TotalElements;
}

void PageTemplateProjection::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageTemplateProjection::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageTemplateProjection::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PageTemplateProjection::getTotalPages() const
{
    return m_TotalPages;
}

void PageTemplateProjection::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageTemplateProjection::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageTemplateProjection::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PageTemplateProjection::isLast() const
{
    return m_Last;
}

void PageTemplateProjection::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageTemplateProjection::lastIsSet() const
{
    return m_LastIsSet;
}

void PageTemplateProjection::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageTemplateProjection::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageTemplateProjection::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageTemplateProjection::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageTemplateProjection::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
bool PageTemplateProjection::isFirst() const
{
    return m_First;
}

void PageTemplateProjection::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageTemplateProjection::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageTemplateProjection::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageTemplateProjection::getSize() const
{
    return m_Size;
}

void PageTemplateProjection::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageTemplateProjection::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageTemplateProjection::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageTemplateProjection::getNumber() const
{
    return m_number;
}

void PageTemplateProjection::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageTemplateProjection::numberIsSet() const
{
    return m_numberIsSet;
}

void PageTemplateProjection::unsetnumber()
{
    m_numberIsSet = false;
}
std::shared_ptr<SortObject> PageTemplateProjection::getSort() const
{
    return m_Sort;
}

void PageTemplateProjection::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageTemplateProjection::sortIsSet() const
{
    return m_SortIsSet;
}

void PageTemplateProjection::unsetSort()
{
    m_SortIsSet = false;
}
bool PageTemplateProjection::isEmpty() const
{
    return m_Empty;
}

void PageTemplateProjection::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageTemplateProjection::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageTemplateProjection::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
