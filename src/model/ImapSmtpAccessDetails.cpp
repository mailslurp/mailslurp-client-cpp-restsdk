...
utility::string_t ImapSmtpAccessDetails::getEmailAddress() const
{
    return m_EmailAddress;
}

void ImapSmtpAccessDetails::setEmailAddress(const utility::string_t& value)
{
    m_EmailAddress = value;
    m_EmailAddressIsSet = true;
}

bool ImapSmtpAccessDetails::emailAddressIsSet() const
{
    return m_EmailAddressIsSet;
}

void ImapSmtpAccessDetails::unsetEmailAddress()
{
    m_EmailAddressIsSet = false;
}
