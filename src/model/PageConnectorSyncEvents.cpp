...
void PageConnectorSyncEvents::validate()
{
    // TODO: implement validation
}

web::json::value PageConnectorSyncEvents::toJson() const
{
...
bool PageConnectorSyncEvents::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<ConnectorSyncEventProjection>> refVal_setContent;
...
void PageConnectorSyncEvents::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageConnectorSyncEvents::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<ConnectorSyncEventProjection>>& PageConnectorSyncEvents::getContent()
{
    return m_Content;
}

void PageConnectorSyncEvents::setContent(const std::vector<std::shared_ptr<ConnectorSyncEventProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageConnectorSyncEvents::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageConnectorSyncEvents::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageConnectorSyncEvents::getPageable() const
{
    return m_Pageable;
}

void PageConnectorSyncEvents::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageConnectorSyncEvents::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageConnectorSyncEvents::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PageConnectorSyncEvents::getTotal() const
{
    return m_Total;
}

void PageConnectorSyncEvents::setTotal(int64_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool PageConnectorSyncEvents::totalIsSet() const
{
    return m_TotalIsSet;
}

void PageConnectorSyncEvents::unsetTotal()
{
    m_TotalIsSet = false;
}
int64_t PageConnectorSyncEvents::getTotalElements() const
{
    return m_TotalElements;
}

void PageConnectorSyncEvents::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageConnectorSyncEvents::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageConnectorSyncEvents::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PageConnectorSyncEvents::getTotalPages() const
{
    return m_TotalPages;
}

void PageConnectorSyncEvents::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageConnectorSyncEvents::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageConnectorSyncEvents::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PageConnectorSyncEvents::isLast() const
{
    return m_Last;
}

void PageConnectorSyncEvents::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageConnectorSyncEvents::lastIsSet() const
{
    return m_LastIsSet;
}

void PageConnectorSyncEvents::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageConnectorSyncEvents::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageConnectorSyncEvents::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageConnectorSyncEvents::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageConnectorSyncEvents::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
bool PageConnectorSyncEvents::isFirst() const
{
    return m_First;
}

void PageConnectorSyncEvents::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageConnectorSyncEvents::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageConnectorSyncEvents::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageConnectorSyncEvents::getSize() const
{
    return m_Size;
}

void PageConnectorSyncEvents::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageConnectorSyncEvents::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageConnectorSyncEvents::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageConnectorSyncEvents::getNumber() const
{
    return m_number;
}

void PageConnectorSyncEvents::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageConnectorSyncEvents::numberIsSet() const
{
    return m_numberIsSet;
}

void PageConnectorSyncEvents::unsetnumber()
{
    m_numberIsSet = false;
}
std::shared_ptr<SortObject> PageConnectorSyncEvents::getSort() const
{
    return m_Sort;
}

void PageConnectorSyncEvents::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageConnectorSyncEvents::sortIsSet() const
{
    return m_SortIsSet;
}

void PageConnectorSyncEvents::unsetSort()
{
    m_SortIsSet = false;
}
bool PageConnectorSyncEvents::isEmpty() const
{
    return m_Empty;
}

void PageConnectorSyncEvents::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageConnectorSyncEvents::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageConnectorSyncEvents::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
