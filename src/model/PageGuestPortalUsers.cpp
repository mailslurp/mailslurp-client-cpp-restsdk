...
void PageGuestPortalUsers::validate()
{
    // TODO: implement validation
}

web::json::value PageGuestPortalUsers::toJson() const
{
...
bool PageGuestPortalUsers::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<GuestPortalUserProjection>> refVal_setContent;
...
void PageGuestPortalUsers::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageGuestPortalUsers::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<GuestPortalUserProjection>>& PageGuestPortalUsers::getContent()
{
    return m_Content;
}

void PageGuestPortalUsers::setContent(const std::vector<std::shared_ptr<GuestPortalUserProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageGuestPortalUsers::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageGuestPortalUsers::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageGuestPortalUsers::getPageable() const
{
    return m_Pageable;
}

void PageGuestPortalUsers::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageGuestPortalUsers::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageGuestPortalUsers::unsetPageable()
{
    m_PageableIsSet = false;
}
int32_t PageGuestPortalUsers::getTotalPages() const
{
    return m_TotalPages;
}

void PageGuestPortalUsers::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageGuestPortalUsers::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageGuestPortalUsers::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
int64_t PageGuestPortalUsers::getTotalElements() const
{
    return m_TotalElements;
}

void PageGuestPortalUsers::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageGuestPortalUsers::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageGuestPortalUsers::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
bool PageGuestPortalUsers::isLast() const
{
    return m_Last;
}

void PageGuestPortalUsers::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageGuestPortalUsers::lastIsSet() const
{
    return m_LastIsSet;
}

void PageGuestPortalUsers::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageGuestPortalUsers::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageGuestPortalUsers::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageGuestPortalUsers::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageGuestPortalUsers::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
bool PageGuestPortalUsers::isFirst() const
{
    return m_First;
}

void PageGuestPortalUsers::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageGuestPortalUsers::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageGuestPortalUsers::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageGuestPortalUsers::getSize() const
{
    return m_Size;
}

void PageGuestPortalUsers::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageGuestPortalUsers::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageGuestPortalUsers::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageGuestPortalUsers::getNumber() const
{
    return m_number;
}

void PageGuestPortalUsers::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageGuestPortalUsers::numberIsSet() const
{
    return m_numberIsSet;
}

void PageGuestPortalUsers::unsetnumber()
{
    m_numberIsSet = false;
}
std::shared_ptr<SortObject> PageGuestPortalUsers::getSort() const
{
    return m_Sort;
}

void PageGuestPortalUsers::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageGuestPortalUsers::sortIsSet() const
{
    return m_SortIsSet;
}

void PageGuestPortalUsers::unsetSort()
{
    m_SortIsSet = false;
}
bool PageGuestPortalUsers::isEmpty() const
{
    return m_Empty;
}

void PageGuestPortalUsers::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageGuestPortalUsers::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageGuestPortalUsers::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
