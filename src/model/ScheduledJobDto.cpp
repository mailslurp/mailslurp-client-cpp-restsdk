...
void ScheduledJobDto::validate()
{
    // TODO: implement validation
}

web::json::value ScheduledJobDto::toJson() const
{
...
bool ScheduledJobDto::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ScheduledJobDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ScheduledJobDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t ScheduledJobDto::getId() const
{
    return m_Id;
}

void ScheduledJobDto::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool ScheduledJobDto::idIsSet() const
{
    return m_IdIsSet;
}

void ScheduledJobDto::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t ScheduledJobDto::getUserId() const
{
    return m_UserId;
}

void ScheduledJobDto::setUserId(const utility::string_t& value)
{
    m_UserId = value;
    m_UserIdIsSet = true;
}

bool ScheduledJobDto::userIdIsSet() const
{
    return m_UserIdIsSet;
}

void ScheduledJobDto::unsetUserId()
{
    m_UserIdIsSet = false;
}
utility::string_t ScheduledJobDto::getInboxId() const
{
    return m_InboxId;
}

void ScheduledJobDto::setInboxId(const utility::string_t& value)
{
    m_InboxId = value;
    m_InboxIdIsSet = true;
}

bool ScheduledJobDto::inboxIdIsSet() const
{
    return m_InboxIdIsSet;
}

void ScheduledJobDto::unsetInboxId()
{
    m_InboxIdIsSet = false;
}
utility::string_t ScheduledJobDto::getJobId() const
{
    return m_JobId;
}

void ScheduledJobDto::setJobId(const utility::string_t& value)
{
    m_JobId = value;
    m_JobIdIsSet = true;
}

bool ScheduledJobDto::jobIdIsSet() const
{
    return m_JobIdIsSet;
}

void ScheduledJobDto::unsetJobId()
{
    m_JobIdIsSet = false;
}
utility::string_t ScheduledJobDto::getGroupId() const
{
    return m_GroupId;
}

void ScheduledJobDto::setGroupId(const utility::string_t& value)
{
    m_GroupId = value;
    m_GroupIdIsSet = true;
}

bool ScheduledJobDto::groupIdIsSet() const
{
    return m_GroupIdIsSet;
}

void ScheduledJobDto::unsetGroupId()
{
    m_GroupIdIsSet = false;
}
utility::string_t ScheduledJobDto::getTriggerId() const
{
    return m_TriggerId;
}

void ScheduledJobDto::setTriggerId(const utility::string_t& value)
{
    m_TriggerId = value;
    m_TriggerIdIsSet = true;
}

bool ScheduledJobDto::triggerIdIsSet() const
{
    return m_TriggerIdIsSet;
}

void ScheduledJobDto::unsetTriggerId()
{
    m_TriggerIdIsSet = false;
}
utility::string_t ScheduledJobDto::getStatus() const
{
    return m_Status;
}

void ScheduledJobDto::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool ScheduledJobDto::statusIsSet() const
{
    return m_StatusIsSet;
}

void ScheduledJobDto::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::datetime ScheduledJobDto::getSendAtTimestamp() const
{
    return m_SendAtTimestamp;
}

void ScheduledJobDto::setSendAtTimestamp(const utility::datetime& value)
{
    m_SendAtTimestamp = value;
    m_SendAtTimestampIsSet = true;
}

bool ScheduledJobDto::sendAtTimestampIsSet() const
{
    return m_SendAtTimestampIsSet;
}

void ScheduledJobDto::unsetSendAtTimestamp()
{
    m_SendAtTimestampIsSet = false;
}
utility::datetime ScheduledJobDto::getCreatedAt() const
{
    return m_CreatedAt;
}

void ScheduledJobDto::setCreatedAt(const utility::datetime& value)
{
    m_CreatedAt = value;
    m_CreatedAtIsSet = true;
}

bool ScheduledJobDto::createdAtIsSet() const
{
    return m_CreatedAtIsSet;
}

void ScheduledJobDto::unsetCreatedAt()
{
    m_CreatedAtIsSet = false;
}
utility::datetime ScheduledJobDto::getUpdatedAt() const
{
    return m_UpdatedAt;
}

void ScheduledJobDto::setUpdatedAt(const utility::datetime& value)
{
    m_UpdatedAt = value;
    m_UpdatedAtIsSet = true;
}

bool ScheduledJobDto::updatedAtIsSet() const
{
    return m_UpdatedAtIsSet;
}

void ScheduledJobDto::unsetUpdatedAt()
{
    m_UpdatedAtIsSet = false;
}
}
