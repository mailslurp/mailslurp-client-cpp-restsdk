...
utility::string_t CreateInboxDto::getPrefix() const
{
    return m_Prefix;
}

void CreateInboxDto::setPrefix(const utility::string_t& value)
{
    m_Prefix = value;
    m_PrefixIsSet = true;
}

bool CreateInboxDto::prefixIsSet() const
{
    return m_PrefixIsSet;
}

void CreateInboxDto::unsetPrefix()
{
    m_PrefixIsSet = false;
}
}
