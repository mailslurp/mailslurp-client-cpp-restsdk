...
web::json::value InboxForwarderTestResult::toJson() const
{
    ...
    if(m_DoesMatchIsSet)
    {
        val[utility::conversions::to_string_t(U("doesMatch"))] = ModelBase::toJson(m_DoesMatch);
    }
...
bool InboxForwarderTestResult::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("matches"))))
    {
        ...
        {
            std::map<utility::string_t, bool> refVal_setMatches;
            ok &= ModelBase::fromJson(fieldValue, refVal_setMatches);
            setMatches(refVal_setMatches);
        }
    }
    if(val.has_field(utility::conversions::to_string_t(U("doesMatch"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("doesMatch")));
        if(!fieldValue.is_null())
        {
            bool refVal_setDoesMatch;
            ok &= ModelBase::fromJson(fieldValue, refVal_setDoesMatch);
            setDoesMatch(refVal_setDoesMatch);
        }
    }
    return ok;
}
...
void InboxForwarderTestResult::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_DoesMatchIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("doesMatch")), m_DoesMatch));
    }
}
...
bool InboxForwarderTestResult::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(U("doesMatch"))))
    {
        bool refVal_setDoesMatch;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("doesMatch"))), refVal_setDoesMatch );
        setDoesMatch(refVal_setDoesMatch);
    }
    return ok;
}
