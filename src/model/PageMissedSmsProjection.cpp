...
void PageMissedSmsProjection::validate()
{
    // TODO: implement validation
}

web::json::value PageMissedSmsProjection::toJson() const
{
...
bool PageMissedSmsProjection::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<MissedSmsProjection>> refVal_setContent;
...
void PageMissedSmsProjection::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageMissedSmsProjection::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<MissedSmsProjection>>& PageMissedSmsProjection::getContent()
{
    return m_Content;
}

void PageMissedSmsProjection::setContent(const std::vector<std::shared_ptr<MissedSmsProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageMissedSmsProjection::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageMissedSmsProjection::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageMissedSmsProjection::getPageable() const
{
    return m_Pageable;
}

void PageMissedSmsProjection::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageMissedSmsProjection::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageMissedSmsProjection::unsetPageable()
{
    m_PageableIsSet = false;
}
int32_t PageMissedSmsProjection::getTotalPages() const
{
    return m_TotalPages;
}

void PageMissedSmsProjection::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageMissedSmsProjection::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageMissedSmsProjection::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
int64_t PageMissedSmsProjection::getTotalElements() const
{
    return m_TotalElements;
}

void PageMissedSmsProjection::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageMissedSmsProjection::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageMissedSmsProjection::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
bool PageMissedSmsProjection::isLast() const
{
    return m_Last;
}

void PageMissedSmsProjection::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageMissedSmsProjection::lastIsSet() const
{
    return m_LastIsSet;
}

void PageMissedSmsProjection::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageMissedSmsProjection::getSize() const
{
    return m_Size;
}

void PageMissedSmsProjection::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageMissedSmsProjection::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageMissedSmsProjection::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageMissedSmsProjection::getNumber() const
{
    return m_number;
}

void PageMissedSmsProjection::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageMissedSmsProjection::numberIsSet() const
{
    return m_numberIsSet;
}

void PageMissedSmsProjection::unsetnumber()
{
    m_numberIsSet = false;
}
int32_t PageMissedSmsProjection::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageMissedSmsProjection::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageMissedSmsProjection::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageMissedSmsProjection::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
std::shared_ptr<SortObject> PageMissedSmsProjection::getSort() const
{
    return m_Sort;
}

void PageMissedSmsProjection::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageMissedSmsProjection::sortIsSet() const
{
    return m_SortIsSet;
}

void PageMissedSmsProjection::unsetSort()
{
    m_SortIsSet = false;
}
bool PageMissedSmsProjection::isFirst() const
{
    return m_First;
}

void PageMissedSmsProjection::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageMissedSmsProjection::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageMissedSmsProjection::unsetFirst()
{
    m_FirstIsSet = false;
}
bool PageMissedSmsProjection::isEmpty() const
{
    return m_Empty;
}

void PageMissedSmsProjection::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageMissedSmsProjection::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageMissedSmsProjection::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
