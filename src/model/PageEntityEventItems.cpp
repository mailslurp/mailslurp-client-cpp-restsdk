...
void PageEntityEventItems::validate()
{
    // TODO: implement validation
}

web::json::value PageEntityEventItems::toJson() const
{
...
bool PageEntityEventItems::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<EntityEventItemProjection>> refVal_setContent;
...
void PageEntityEventItems::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageEntityEventItems::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<EntityEventItemProjection>>& PageEntityEventItems::getContent()
{
    return m_Content;
}

void PageEntityEventItems::setContent(const std::vector<std::shared_ptr<EntityEventItemProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageEntityEventItems::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageEntityEventItems::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageEntityEventItems::getPageable() const
{
    return m_Pageable;
}

void PageEntityEventItems::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageEntityEventItems::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageEntityEventItems::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PageEntityEventItems::getTotalElements() const
{
    return m_TotalElements;
}

void PageEntityEventItems::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageEntityEventItems::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageEntityEventItems::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PageEntityEventItems::getTotalPages() const
{
    return m_TotalPages;
}

void PageEntityEventItems::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageEntityEventItems::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageEntityEventItems::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PageEntityEventItems::isLast() const
{
    return m_Last;
}

void PageEntityEventItems::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageEntityEventItems::lastIsSet() const
{
    return m_LastIsSet;
}

void PageEntityEventItems::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageEntityEventItems::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageEntityEventItems::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageEntityEventItems::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageEntityEventItems::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
bool PageEntityEventItems::isFirst() const
{
    return m_First;
}

void PageEntityEventItems::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageEntityEventItems::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageEntityEventItems::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageEntityEventItems::getSize() const
{
    return m_Size;
}

void PageEntityEventItems::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageEntityEventItems::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageEntityEventItems::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageEntityEventItems::getNumber() const
{
    return m_number;
}

void PageEntityEventItems::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageEntityEventItems::numberIsSet() const
{
    return m_numberIsSet;
}

void PageEntityEventItems::unsetnumber()
{
    m_numberIsSet = false;
}
std::shared_ptr<SortObject> PageEntityEventItems::getSort() const
{
    return m_Sort;
}

void PageEntityEventItems::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageEntityEventItems::sortIsSet() const
{
    return m_SortIsSet;
}

void PageEntityEventItems::unsetSort()
{
    m_SortIsSet = false;
}
bool PageEntityEventItems::isEmpty() const
{
    return m_Empty;
}

void PageEntityEventItems::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageEntityEventItems::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageEntityEventItems::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
