...
bool PageEmailValidationRequest::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<EmailValidationRequestDto>> refVal_setContent;
...
std::vector<std::shared_ptr<EmailValidationRequestDto>>& PageEmailValidationRequest::getContent()
{
    return m_Content;
}

void PageEmailValidationRequest::setContent(const std::vector<std::shared_ptr<EmailValidationRequestDto>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
...
std::shared_ptr<SortObject> PageEmailValidationRequest::getSort() const
{
    return m_Sort;
}

void PageEmailValidationRequest::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
