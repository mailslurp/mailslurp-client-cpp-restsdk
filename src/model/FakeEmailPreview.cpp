...
bool FakeEmailPreview::isHasAttachments() const
{
    return m_HasAttachments;
}

void FakeEmailPreview::setHasAttachments(bool value)
{
    m_HasAttachments = value;
    m_HasAttachmentsIsSet = true;
}

bool FakeEmailPreview::hasAttachmentsIsSet() const
{
    return m_HasAttachmentsIsSet;
}

void FakeEmailPreview::unsetHasAttachments()
{
    m_HasAttachmentsIsSet = false;
}
