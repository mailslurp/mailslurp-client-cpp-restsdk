...
void PageBouncedEmail::validate()
{
    // TODO: implement validation
}

web::json::value PageBouncedEmail::toJson() const
{
...
bool PageBouncedEmail::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<BounceProjection>> refVal_setContent;
...
void PageBouncedEmail::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageBouncedEmail::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<BounceProjection>>& PageBouncedEmail::getContent()
{
    return m_Content;
}

void PageBouncedEmail::setContent(const std::vector<std::shared_ptr<BounceProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageBouncedEmail::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageBouncedEmail::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageBouncedEmail::getPageable() const
{
    return m_Pageable;
}

void PageBouncedEmail::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageBouncedEmail::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageBouncedEmail::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PageBouncedEmail::getTotal() const
{
    return m_Total;
}

void PageBouncedEmail::setTotal(int64_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool PageBouncedEmail::totalIsSet() const
{
    return m_TotalIsSet;
}

void PageBouncedEmail::unsetTotal()
{
    m_TotalIsSet = false;
}
int64_t PageBouncedEmail::getTotalElements() const
{
    return m_TotalElements;
}

void PageBouncedEmail::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageBouncedEmail::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageBouncedEmail::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PageBouncedEmail::getTotalPages() const
{
    return m_TotalPages;
}

void PageBouncedEmail::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageBouncedEmail::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageBouncedEmail::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PageBouncedEmail::isLast() const
{
    return m_Last;
}

void PageBouncedEmail::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageBouncedEmail::lastIsSet() const
{
    return m_LastIsSet;
}

void PageBouncedEmail::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageBouncedEmail::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageBouncedEmail::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageBouncedEmail::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageBouncedEmail::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
bool PageBouncedEmail::isFirst() const
{
    return m_First;
}

void PageBouncedEmail::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageBouncedEmail::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageBouncedEmail::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageBouncedEmail::getSize() const
{
    return m_Size;
}

void PageBouncedEmail::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageBouncedEmail::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageBouncedEmail::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageBouncedEmail::getNumber() const
{
    return m_number;
}

void PageBouncedEmail::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageBouncedEmail::numberIsSet() const
{
    return m_numberIsSet;
}

void PageBouncedEmail::unsetnumber()
{
    m_numberIsSet = false;
}
std::shared_ptr<SortObject> PageBouncedEmail::getSort() const
{
    return m_Sort;
}

void PageBouncedEmail::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageBouncedEmail::sortIsSet() const
{
    return m_SortIsSet;
}

void PageBouncedEmail::unsetSort()
{
    m_SortIsSet = false;
}
bool PageBouncedEmail::isEmpty() const
{
    return m_Empty;
}

void PageBouncedEmail::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageBouncedEmail::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageBouncedEmail::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
