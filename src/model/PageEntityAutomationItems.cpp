...
void PageEntityAutomationItems::validate()
{
    // TODO: implement validation
}

web::json::value PageEntityAutomationItems::toJson() const
{
...
bool PageEntityAutomationItems::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<EntityAutomationItemProjection>> refVal_setContent;
...
void PageEntityAutomationItems::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageEntityAutomationItems::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<EntityAutomationItemProjection>>& PageEntityAutomationItems::getContent()
{
    return m_Content;
}

void PageEntityAutomationItems::setContent(const std::vector<std::shared_ptr<EntityAutomationItemProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageEntityAutomationItems::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageEntityAutomationItems::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageEntityAutomationItems::getPageable() const
{
    return m_Pageable;
}

void PageEntityAutomationItems::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageEntityAutomationItems::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageEntityAutomationItems::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PageEntityAutomationItems::getTotalElements() const
{
    return m_TotalElements;
}

void PageEntityAutomationItems::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageEntityAutomationItems::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageEntityAutomationItems::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PageEntityAutomationItems::getTotalPages() const
{
    return m_TotalPages;
}

void PageEntityAutomationItems::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageEntityAutomationItems::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageEntityAutomationItems::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PageEntityAutomationItems::isLast() const
{
    return m_Last;
}

void PageEntityAutomationItems::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageEntityAutomationItems::lastIsSet() const
{
    return m_LastIsSet;
}

void PageEntityAutomationItems::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageEntityAutomationItems::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageEntityAutomationItems::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageEntityAutomationItems::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageEntityAutomationItems::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
std::shared_ptr<SortObject> PageEntityAutomationItems::getSort() const
{
    return m_Sort;
}

void PageEntityAutomationItems::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageEntityAutomationItems::sortIsSet() const
{
    return m_SortIsSet;
}

void PageEntityAutomationItems::unsetSort()
{
    m_SortIsSet = false;
}
bool PageEntityAutomationItems::isFirst() const
{
    return m_First;
}

void PageEntityAutomationItems::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageEntityAutomationItems::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageEntityAutomationItems::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageEntityAutomationItems::getSize() const
{
    return m_Size;
}

void PageEntityAutomationItems::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageEntityAutomationItems::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageEntityAutomationItems::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageEntityAutomationItems::getNumber() const
{
    return m_number;
}

void PageEntityAutomationItems::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageEntityAutomationItems::numberIsSet() const
{
    return m_numberIsSet;
}

void PageEntityAutomationItems::unsetnumber()
{
    m_numberIsSet = false;
}
bool PageEntityAutomationItems::isEmpty() const
{
    return m_Empty;
}

void PageEntityAutomationItems::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageEntityAutomationItems::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageEntityAutomationItems::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
