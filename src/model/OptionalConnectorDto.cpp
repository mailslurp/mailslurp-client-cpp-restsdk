...
void OptionalConnectorDto::validate()
{
    // TODO: implement validation
}

web::json::value OptionalConnectorDto::toJson() const
{
...
bool OptionalConnectorDto::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ConnectorDto> refVal_setResult;
...
void OptionalConnectorDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool OptionalConnectorDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool OptionalConnectorDto::isPresent() const
{
    return m_Present;
}

void OptionalConnectorDto::setPresent(bool value)
{
    m_Present = value;
    m_PresentIsSet = true;
}

bool OptionalConnectorDto::presentIsSet() const
{
    return m_PresentIsSet;
}

void OptionalConnectorDto::unsetPresent()
{
    m_PresentIsSet = false;
}
std::shared_ptr<ConnectorDto> OptionalConnectorDto::getResult() const
{
    return m_Result;
}

void OptionalConnectorDto::setResult(const std::shared_ptr<ConnectorDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool OptionalConnectorDto::resultIsSet() const
{
    return m_ResultIsSet;
}

void OptionalConnectorDto::unsetResult()
{
    m_ResultIsSet = false;
}
}
