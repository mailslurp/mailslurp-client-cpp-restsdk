...
void LookupSpfDomainOptions::validate()
{
    // TODO: implement validation
}

web::json::value LookupSpfDomainOptions::toJson() const
{
...
bool LookupSpfDomainOptions::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void LookupSpfDomainOptions::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool LookupSpfDomainOptions::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t LookupSpfDomainOptions::getHost() const
{
    return m_Host;
}

void LookupSpfDomainOptions::setHost(const utility::string_t& value)
{
    m_Host = value;
    m_HostIsSet = true;
}

bool LookupSpfDomainOptions::hostIsSet() const
{
    return m_HostIsSet;
}

void LookupSpfDomainOptions::unsetHost()
{
    m_HostIsSet = false;
}
}
