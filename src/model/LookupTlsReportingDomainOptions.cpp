...
void LookupTlsReportingDomainOptions::validate()
{
    // TODO: implement validation
}

web::json::value LookupTlsReportingDomainOptions::toJson() const
{
...
bool LookupTlsReportingDomainOptions::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void LookupTlsReportingDomainOptions::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool LookupTlsReportingDomainOptions::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t LookupTlsReportingDomainOptions::getHost() const
{
    return m_Host;
}

void LookupTlsReportingDomainOptions::setHost(const utility::string_t& value)
{
    m_Host = value;
    m_HostIsSet = true;
}

bool LookupTlsReportingDomainOptions::hostIsSet() const
{
    return m_HostIsSet;
}

void LookupTlsReportingDomainOptions::unsetHost()
{
    m_HostIsSet = false;
}
}
