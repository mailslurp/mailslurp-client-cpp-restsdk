...
void PageAttachmentEntity::validate()
{
    // TODO: implement validation
}

web::json::value PageAttachmentEntity::toJson() const
{
...
bool PageAttachmentEntity::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<AttachmentProjection>> refVal_setContent;
...
void PageAttachmentEntity::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageAttachmentEntity::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<AttachmentProjection>>& PageAttachmentEntity::getContent()
{
    return m_Content;
}

void PageAttachmentEntity::setContent(const std::vector<std::shared_ptr<AttachmentProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageAttachmentEntity::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageAttachmentEntity::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageAttachmentEntity::getPageable() const
{
    return m_Pageable;
}

void PageAttachmentEntity::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageAttachmentEntity::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageAttachmentEntity::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PageAttachmentEntity::getTotal() const
{
    return m_Total;
}

void PageAttachmentEntity::setTotal(int64_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool PageAttachmentEntity::totalIsSet() const
{
    return m_TotalIsSet;
}

void PageAttachmentEntity::unsetTotal()
{
    m_TotalIsSet = false;
}
int64_t PageAttachmentEntity::getTotalElements() const
{
    return m_TotalElements;
}

void PageAttachmentEntity::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageAttachmentEntity::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageAttachmentEntity::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PageAttachmentEntity::getTotalPages() const
{
    return m_TotalPages;
}

void PageAttachmentEntity::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageAttachmentEntity::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageAttachmentEntity::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PageAttachmentEntity::isLast() const
{
    return m_Last;
}

void PageAttachmentEntity::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageAttachmentEntity::lastIsSet() const
{
    return m_LastIsSet;
}

void PageAttachmentEntity::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageAttachmentEntity::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageAttachmentEntity::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageAttachmentEntity::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageAttachmentEntity::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
bool PageAttachmentEntity::isFirst() const
{
    return m_First;
}

void PageAttachmentEntity::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageAttachmentEntity::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageAttachmentEntity::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageAttachmentEntity::getSize() const
{
    return m_Size;
}

void PageAttachmentEntity::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageAttachmentEntity::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageAttachmentEntity::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageAttachmentEntity::getNumber() const
{
    return m_number;
}

void PageAttachmentEntity::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageAttachmentEntity::numberIsSet() const
{
    return m_numberIsSet;
}

void PageAttachmentEntity::unsetnumber()
{
    m_numberIsSet = false;
}
std::shared_ptr<SortObject> PageAttachmentEntity::getSort() const
{
    return m_Sort;
}

void PageAttachmentEntity::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageAttachmentEntity::sortIsSet() const
{
    return m_SortIsSet;
}

void PageAttachmentEntity::unsetSort()
{
    m_SortIsSet = false;
}
bool PageAttachmentEntity::isEmpty() const
{
    return m_Empty;
}

void PageAttachmentEntity::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageAttachmentEntity::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageAttachmentEntity::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
