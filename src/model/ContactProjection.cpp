...
utility::string_t ContactProjection::getEmailAddress() const
{
    return m_EmailAddress;
}

void ContactProjection::setEmailAddress(const utility::string_t& value)
{
    m_EmailAddress = value;
    m_EmailAddressIsSet = true;
}

bool ContactProjection::emailAddressIsSet() const
{
    return m_EmailAddressIsSet;
}

void ContactProjection::unsetEmailAddress()
{
    m_EmailAddressIsSet = false;
}
