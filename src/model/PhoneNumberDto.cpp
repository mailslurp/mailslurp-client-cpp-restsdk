...
std::vector<utility::string_t>& PhoneNumberDto::getTags()
{
    return m_Tags;
}

void PhoneNumberDto::setTags(const std::vector<utility::string_t>& value)
{
    m_Tags = value;
    m_TagsIsSet = true;
}

bool PhoneNumberDto::tagsIsSet() const
{
    return m_TagsIsSet;
}

void PhoneNumberDto::unsetTags()
{
    m_TagsIsSet = false;
}
...
utility::string_t PhoneNumberDto::getPhoneVariant() const
{
    return m_PhoneVariant;
}

void PhoneNumberDto::setPhoneVariant(const utility::string_t& value)
{
    m_PhoneVariant = value;
    m_PhoneVariantIsSet = true;
}

bool PhoneNumberDto::phoneVariantIsSet() const
{
    return m_PhoneVariantIsSet;
}

void PhoneNumberDto::unsetPhoneVariant()
{
    m_PhoneVariantIsSet = false;
}
utility::string_t PhoneNumberDto::getLineType() const
{
    return m_LineType;
}

void PhoneNumberDto::setLineType(const utility::string_t& value)
{
    m_LineType = value;
    m_LineTypeIsSet = true;
}

bool PhoneNumberDto::lineTypeIsSet() const
{
    return m_LineTypeIsSet;
}

void PhoneNumberDto::unsetLineType()
{
    m_LineTypeIsSet = false;
}
utility::string_t PhoneNumberDto::getCarrierName() const
{
    return m_CarrierName;
}

void PhoneNumberDto::setCarrierName(const utility::string_t& value)
{
    m_CarrierName = value;
    m_CarrierNameIsSet = true;
}

bool PhoneNumberDto::carrierNameIsSet() const
{
    return m_CarrierNameIsSet;
}

void PhoneNumberDto::unsetCarrierName()
{
    m_CarrierNameIsSet = false;
}
utility::string_t PhoneNumberDto::getMobileCountryCode() const
{
    return m_MobileCountryCode;
}

void PhoneNumberDto::setMobileCountryCode(const utility::string_t& value)
{
    m_MobileCountryCode = value;
    m_MobileCountryCodeIsSet = true;
}

bool PhoneNumberDto::mobileCountryCodeIsSet() const
{
    return m_MobileCountryCodeIsSet;
}

void PhoneNumberDto::unsetMobileCountryCode()
{
    m_MobileCountryCodeIsSet = false;
}
utility::string_t PhoneNumberDto::getMobileNetworkCode() const
{
    return m_MobileNetworkCode;
}

void PhoneNumberDto::setMobileNetworkCode(const utility::string_t& value)
{
    m_MobileNetworkCode = value;
    m_MobileNetworkCodeIsSet = true;
}

bool PhoneNumberDto::mobileNetworkCodeIsSet() const
{
    return m_MobileNetworkCodeIsSet;
}

void PhoneNumberDto::unsetMobileNetworkCode()
{
    m_MobileNetworkCodeIsSet = false;
}
utility::string_t PhoneNumberDto::getProviderLabel() const
{
    return m_ProviderLabel;
}

void PhoneNumberDto::setProviderLabel(const utility::string_t& value)
{
    m_ProviderLabel = value;
    m_ProviderLabelIsSet = true;
}

bool PhoneNumberDto::providerLabelIsSet() const
{
    return m_ProviderLabelIsSet;
}

void PhoneNumberDto::unsetProviderLabel()
{
    m_ProviderLabelIsSet = false;
}
}
