...
web::json::value ConditionalStructuredContentResult::toJson() const
{
    ...
    {
        val[utility::conversions::to_string_t(U("tokenCount"))] = ModelBase::toJson(m_TokenCount);
    }
...
bool ConditionalStructuredContentResult::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("tokenCount"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("tokenCount")));
        if(!fieldValue.is_null())
        {
...
void ConditionalStructuredContentResult::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_TokenCountIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("tokenCount")), m_TokenCount));
    }
}
...
bool ConditionalStructuredContentResult::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(U("tokenCount"))))
    {
        int32_t refVal_setTokenCount;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("tokenCount"))), refVal_setTokenCount );
        setTokenCount(refVal_setTokenCount);
    }
    return ok;
}
...
int32_t ConditionalStructuredContentResult::getTokenCount() const
{
    return m_TokenCount;
}

void ConditionalStructuredContentResult::setTokenCount(int32_t value)
{
    m_TokenCount = value;
    m_TokenCountIsSet = true;
}

bool ConditionalStructuredContentResult::tokenCountIsSet() const
{
    return m_TokenCountIsSet;
}

void ConditionalStructuredContentResult::unsetTokenCount()
{
    m_TokenCountIsSet = false;
}
}
