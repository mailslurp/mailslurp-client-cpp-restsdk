...
void PageListUnsubscribeRecipients::validate()
{
    // TODO: implement validation
}

web::json::value PageListUnsubscribeRecipients::toJson() const
{
...
bool PageListUnsubscribeRecipients::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<ListUnsubscribeRecipientProjection>> refVal_setContent;
...
void PageListUnsubscribeRecipients::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageListUnsubscribeRecipients::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<ListUnsubscribeRecipientProjection>>& PageListUnsubscribeRecipients::getContent()
{
    return m_Content;
}

void PageListUnsubscribeRecipients::setContent(const std::vector<std::shared_ptr<ListUnsubscribeRecipientProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageListUnsubscribeRecipients::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageListUnsubscribeRecipients::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageListUnsubscribeRecipients::getPageable() const
{
    return m_Pageable;
}

void PageListUnsubscribeRecipients::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageListUnsubscribeRecipients::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageListUnsubscribeRecipients::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PageListUnsubscribeRecipients::getTotal() const
{
    return m_Total;
}

void PageListUnsubscribeRecipients::setTotal(int64_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool PageListUnsubscribeRecipients::totalIsSet() const
{
    return m_TotalIsSet;
}

void PageListUnsubscribeRecipients::unsetTotal()
{
    m_TotalIsSet = false;
}
int64_t PageListUnsubscribeRecipients::getTotalElements() const
{
    return m_TotalElements;
}

void PageListUnsubscribeRecipients::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageListUnsubscribeRecipients::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageListUnsubscribeRecipients::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PageListUnsubscribeRecipients::getTotalPages() const
{
    return m_TotalPages;
}

void PageListUnsubscribeRecipients::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageListUnsubscribeRecipients::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageListUnsubscribeRecipients::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PageListUnsubscribeRecipients::isLast() const
{
    return m_Last;
}

void PageListUnsubscribeRecipients::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageListUnsubscribeRecipients::lastIsSet() const
{
    return m_LastIsSet;
}

void PageListUnsubscribeRecipients::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageListUnsubscribeRecipients::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageListUnsubscribeRecipients::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageListUnsubscribeRecipients::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageListUnsubscribeRecipients::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
bool PageListUnsubscribeRecipients::isFirst() const
{
    return m_First;
}

void PageListUnsubscribeRecipients::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageListUnsubscribeRecipients::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageListUnsubscribeRecipients::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageListUnsubscribeRecipients::getSize() const
{
    return m_Size;
}

void PageListUnsubscribeRecipients::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageListUnsubscribeRecipients::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageListUnsubscribeRecipients::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageListUnsubscribeRecipients::getNumber() const
{
    return m_number;
}

void PageListUnsubscribeRecipients::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageListUnsubscribeRecipients::numberIsSet() const
{
    return m_numberIsSet;
}

void PageListUnsubscribeRecipients::unsetnumber()
{
    m_numberIsSet = false;
}
std::shared_ptr<SortObject> PageListUnsubscribeRecipients::getSort() const
{
    return m_Sort;
}

void PageListUnsubscribeRecipients::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageListUnsubscribeRecipients::sortIsSet() const
{
    return m_SortIsSet;
}

void PageListUnsubscribeRecipients::unsetSort()
{
    m_SortIsSet = false;
}
bool PageListUnsubscribeRecipients::isEmpty() const
{
    return m_Empty;
}

void PageListUnsubscribeRecipients::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageListUnsubscribeRecipients::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageListUnsubscribeRecipients::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
