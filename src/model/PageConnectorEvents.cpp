...
void PageConnectorEvents::validate()
{
    // TODO: implement validation
}

web::json::value PageConnectorEvents::toJson() const
{
...
bool PageConnectorEvents::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<ConnectorEventProjection>> refVal_setContent;
...
void PageConnectorEvents::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageConnectorEvents::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<ConnectorEventProjection>>& PageConnectorEvents::getContent()
{
    return m_Content;
}

void PageConnectorEvents::setContent(const std::vector<std::shared_ptr<ConnectorEventProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageConnectorEvents::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageConnectorEvents::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageConnectorEvents::getPageable() const
{
    return m_Pageable;
}

void PageConnectorEvents::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageConnectorEvents::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageConnectorEvents::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PageConnectorEvents::getTotalElements() const
{
    return m_TotalElements;
}

void PageConnectorEvents::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageConnectorEvents::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageConnectorEvents::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PageConnectorEvents::getTotalPages() const
{
    return m_TotalPages;
}

void PageConnectorEvents::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageConnectorEvents::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageConnectorEvents::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PageConnectorEvents::isLast() const
{
    return m_Last;
}

void PageConnectorEvents::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageConnectorEvents::lastIsSet() const
{
    return m_LastIsSet;
}

void PageConnectorEvents::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageConnectorEvents::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageConnectorEvents::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageConnectorEvents::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageConnectorEvents::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
bool PageConnectorEvents::isFirst() const
{
    return m_First;
}

void PageConnectorEvents::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageConnectorEvents::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageConnectorEvents::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageConnectorEvents::getSize() const
{
    return m_Size;
}

void PageConnectorEvents::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageConnectorEvents::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageConnectorEvents::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageConnectorEvents::getNumber() const
{
    return m_number;
}

void PageConnectorEvents::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageConnectorEvents::numberIsSet() const
{
    return m_numberIsSet;
}

void PageConnectorEvents::unsetnumber()
{
    m_numberIsSet = false;
}
std::shared_ptr<SortObject> PageConnectorEvents::getSort() const
{
    return m_Sort;
}

void PageConnectorEvents::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageConnectorEvents::sortIsSet() const
{
    return m_SortIsSet;
}

void PageConnectorEvents::unsetSort()
{
    m_SortIsSet = false;
}
bool PageConnectorEvents::isEmpty() const
{
    return m_Empty;
}

void PageConnectorEvents::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageConnectorEvents::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageConnectorEvents::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
