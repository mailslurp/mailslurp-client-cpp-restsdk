...
void PageOptInIdentityProjection::validate()
{
    // TODO: implement validation
}

web::json::value PageOptInIdentityProjection::toJson() const
{
...
bool PageOptInIdentityProjection::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<OptInIdentityProjection>> refVal_setContent;
...
void PageOptInIdentityProjection::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageOptInIdentityProjection::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<OptInIdentityProjection>>& PageOptInIdentityProjection::getContent()
{
    return m_Content;
}

void PageOptInIdentityProjection::setContent(const std::vector<std::shared_ptr<OptInIdentityProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageOptInIdentityProjection::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageOptInIdentityProjection::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageOptInIdentityProjection::getPageable() const
{
    return m_Pageable;
}

void PageOptInIdentityProjection::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageOptInIdentityProjection::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageOptInIdentityProjection::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PageOptInIdentityProjection::getTotalElements() const
{
    return m_TotalElements;
}

void PageOptInIdentityProjection::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageOptInIdentityProjection::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageOptInIdentityProjection::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PageOptInIdentityProjection::getTotalPages() const
{
    return m_TotalPages;
}

void PageOptInIdentityProjection::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageOptInIdentityProjection::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageOptInIdentityProjection::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PageOptInIdentityProjection::isLast() const
{
    return m_Last;
}

void PageOptInIdentityProjection::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageOptInIdentityProjection::lastIsSet() const
{
    return m_LastIsSet;
}

void PageOptInIdentityProjection::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageOptInIdentityProjection::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageOptInIdentityProjection::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageOptInIdentityProjection::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageOptInIdentityProjection::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
std::shared_ptr<SortObject> PageOptInIdentityProjection::getSort() const
{
    return m_Sort;
}

void PageOptInIdentityProjection::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageOptInIdentityProjection::sortIsSet() const
{
    return m_SortIsSet;
}

void PageOptInIdentityProjection::unsetSort()
{
    m_SortIsSet = false;
}
bool PageOptInIdentityProjection::isFirst() const
{
    return m_First;
}

void PageOptInIdentityProjection::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageOptInIdentityProjection::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageOptInIdentityProjection::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageOptInIdentityProjection::getSize() const
{
    return m_Size;
}

void PageOptInIdentityProjection::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageOptInIdentityProjection::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageOptInIdentityProjection::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageOptInIdentityProjection::getNumber() const
{
    return m_number;
}

void PageOptInIdentityProjection::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageOptInIdentityProjection::numberIsSet() const
{
    return m_numberIsSet;
}

void PageOptInIdentityProjection::unsetnumber()
{
    m_numberIsSet = false;
}
bool PageOptInIdentityProjection::isEmpty() const
{
    return m_Empty;
}

void PageOptInIdentityProjection::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageOptInIdentityProjection::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageOptInIdentityProjection::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
