...
#include "CppRestOpenAPIClient/model/PageAliasThreadProjection.h"
...
void PageAliasThreadProjection::validate()
{
    // TODO: implement validation
}

web::json::value PageAliasThreadProjection::toJson() const
{
...
bool PageAliasThreadProjection::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<AliasThreadProjection>> refVal_setContent;
...
void PageAliasThreadProjection::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageAliasThreadProjection::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<AliasThreadProjection>>& PageAliasThreadProjection::getContent()
{
    return m_Content;
}

void PageAliasThreadProjection::setContent(const std::vector<std::shared_ptr<AliasThreadProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageAliasThreadProjection::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageAliasThreadProjection::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageAliasThreadProjection::getPageable() const
{
    return m_Pageable;
}

void PageAliasThreadProjection::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageAliasThreadProjection::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageAliasThreadProjection::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PageAliasThreadProjection::getTotalElements() const
{
    return m_TotalElements;
}

void PageAliasThreadProjection::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageAliasThreadProjection::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageAliasThreadProjection::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PageAliasThreadProjection::getTotalPages() const
{
    return m_TotalPages;
}

void PageAliasThreadProjection::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageAliasThreadProjection::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageAliasThreadProjection::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PageAliasThreadProjection::isLast() const
{
    return m_Last;
}

void PageAliasThreadProjection::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageAliasThreadProjection::lastIsSet() const
{
    return m_LastIsSet;
}

void PageAliasThreadProjection::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageAliasThreadProjection::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageAliasThreadProjection::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageAliasThreadProjection::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageAliasThreadProjection::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
std::shared_ptr<SortObject> PageAliasThreadProjection::getSort() const
{
    return m_Sort;
}

void PageAliasThreadProjection::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageAliasThreadProjection::sortIsSet() const
{
    return m_SortIsSet;
}

void PageAliasThreadProjection::unsetSort()
{
    m_SortIsSet = false;
}
bool PageAliasThreadProjection::isFirst() const
{
    return m_First;
}

void PageAliasThreadProjection::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageAliasThreadProjection::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageAliasThreadProjection::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageAliasThreadProjection::getSize() const
{
    return m_Size;
}

void PageAliasThreadProjection::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageAliasThreadProjection::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageAliasThreadProjection::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageAliasThreadProjection::getNumber() const
{
    return m_number;
}

void PageAliasThreadProjection::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageAliasThreadProjection::numberIsSet() const
{
    return m_numberIsSet;
}

void PageAliasThreadProjection::unsetnumber()
{
    m_numberIsSet = false;
}
bool PageAliasThreadProjection::isEmpty() const
{
    return m_Empty;
}

void PageAliasThreadProjection::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageAliasThreadProjection::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageAliasThreadProjection::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
