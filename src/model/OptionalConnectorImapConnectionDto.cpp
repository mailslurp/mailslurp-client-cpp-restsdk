...
void OptionalConnectorImapConnectionDto::validate()
{
    // TODO: implement validation
}

web::json::value OptionalConnectorImapConnectionDto::toJson() const
{
...
bool OptionalConnectorImapConnectionDto::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ConnectorImapConnectionDto> refVal_setResult;
...
void OptionalConnectorImapConnectionDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool OptionalConnectorImapConnectionDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool OptionalConnectorImapConnectionDto::isPresent() const
{
    return m_Present;
}

void OptionalConnectorImapConnectionDto::setPresent(bool value)
{
    m_Present = value;
    m_PresentIsSet = true;
}

bool OptionalConnectorImapConnectionDto::presentIsSet() const
{
    return m_PresentIsSet;
}

void OptionalConnectorImapConnectionDto::unsetPresent()
{
    m_PresentIsSet = false;
}
std::shared_ptr<ConnectorImapConnectionDto> OptionalConnectorImapConnectionDto::getResult() const
{
    return m_Result;
}

void OptionalConnectorImapConnectionDto::setResult(const std::shared_ptr<ConnectorImapConnectionDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool OptionalConnectorImapConnectionDto::resultIsSet() const
{
    return m_ResultIsSet;
}

void OptionalConnectorImapConnectionDto::unsetResult()
{
    m_ResultIsSet = false;
}
}
