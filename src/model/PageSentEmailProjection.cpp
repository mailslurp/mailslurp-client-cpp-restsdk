...
int64_t PageSentEmailProjection::getTotal() const
{
    return m_Total;
}

void PageSentEmailProjection::setTotal(int64_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool PageSentEmailProjection::totalIsSet() const
{
    return m_TotalIsSet;
}

void PageSentEmailProjection::unsetTotal()
{
    m_TotalIsSet = false;
}
