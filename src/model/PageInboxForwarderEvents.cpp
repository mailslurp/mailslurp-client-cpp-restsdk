...
void PageInboxForwarderEvents::validate()
{
    // TODO: implement validation
}

web::json::value PageInboxForwarderEvents::toJson() const
{
...
bool PageInboxForwarderEvents::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<InboxForwarderEventProjection>> refVal_setContent;
...
void PageInboxForwarderEvents::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageInboxForwarderEvents::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<InboxForwarderEventProjection>>& PageInboxForwarderEvents::getContent()
{
    return m_Content;
}

void PageInboxForwarderEvents::setContent(const std::vector<std::shared_ptr<InboxForwarderEventProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageInboxForwarderEvents::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageInboxForwarderEvents::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageInboxForwarderEvents::getPageable() const
{
    return m_Pageable;
}

void PageInboxForwarderEvents::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageInboxForwarderEvents::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageInboxForwarderEvents::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PageInboxForwarderEvents::getTotal() const
{
    return m_Total;
}

void PageInboxForwarderEvents::setTotal(int64_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool PageInboxForwarderEvents::totalIsSet() const
{
    return m_TotalIsSet;
}

void PageInboxForwarderEvents::unsetTotal()
{
    m_TotalIsSet = false;
}
int64_t PageInboxForwarderEvents::getTotalElements() const
{
    return m_TotalElements;
}

void PageInboxForwarderEvents::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageInboxForwarderEvents::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageInboxForwarderEvents::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PageInboxForwarderEvents::getTotalPages() const
{
    return m_TotalPages;
}

void PageInboxForwarderEvents::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageInboxForwarderEvents::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageInboxForwarderEvents::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PageInboxForwarderEvents::isLast() const
{
    return m_Last;
}

void PageInboxForwarderEvents::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageInboxForwarderEvents::lastIsSet() const
{
    return m_LastIsSet;
}

void PageInboxForwarderEvents::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageInboxForwarderEvents::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageInboxForwarderEvents::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageInboxForwarderEvents::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageInboxForwarderEvents::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
bool PageInboxForwarderEvents::isFirst() const
{
    return m_First;
}

void PageInboxForwarderEvents::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageInboxForwarderEvents::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageInboxForwarderEvents::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageInboxForwarderEvents::getSize() const
{
    return m_Size;
}

void PageInboxForwarderEvents::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageInboxForwarderEvents::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageInboxForwarderEvents::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageInboxForwarderEvents::getNumber() const
{
    return m_number;
}

void PageInboxForwarderEvents::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageInboxForwarderEvents::numberIsSet() const
{
    return m_numberIsSet;
}

void PageInboxForwarderEvents::unsetnumber()
{
    m_numberIsSet = false;
}
std::shared_ptr<SortObject> PageInboxForwarderEvents::getSort() const
{
    return m_Sort;
}

void PageInboxForwarderEvents::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageInboxForwarderEvents::sortIsSet() const
{
    return m_SortIsSet;
}

void PageInboxForwarderEvents::unsetSort()
{
    m_SortIsSet = false;
}
bool PageInboxForwarderEvents::isEmpty() const
{
    return m_Empty;
}

void PageInboxForwarderEvents::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageInboxForwarderEvents::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageInboxForwarderEvents::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
