...
std::vector<std::shared_ptr<ConnectorSyncRequestResult_exception_cause_suppressed_inner>>& ConnectorSyncRequestResult_exception::getSuppressed()
{
    return m_Suppressed;
}

void ConnectorSyncRequestResult_exception::setSuppressed(const std::vector<std::shared_ptr<ConnectorSyncRequestResult_exception_cause_suppressed_inner>>& value)
{
    m_Suppressed = value;
