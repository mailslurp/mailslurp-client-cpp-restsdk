...
utility::string_t WebhookDto::getAiTransformId() const
{
    return m_AiTransformId;
}

void WebhookDto::setAiTransformId(const utility::string_t& value)
{
    m_AiTransformId = value;
    m_AiTransformIdIsSet = true;
}

bool WebhookDto::aiTransformIdIsSet() const
{
    return m_AiTransformIdIsSet;
}

void WebhookDto::unsetAiTransformId()
{
    m_AiTransformIdIsSet = false;
}
...
bool WebhookDto::isUseStaticIpRange() const
{
    return m_UseStaticIpRange;
}

void WebhookDto::setUseStaticIpRange(bool value)
{
    m_UseStaticIpRange = value;
    m_UseStaticIpRangeIsSet = true;
}

bool WebhookDto::useStaticIpRangeIsSet() const
{
    return m_UseStaticIpRangeIsSet;
}

void WebhookDto::unsetUseStaticIpRange()
{
    m_UseStaticIpRangeIsSet = false;
}
utility::string_t WebhookDto::getHealthStatus() const
{
    return m_HealthStatus;
}

void WebhookDto::setHealthStatus(const utility::string_t& value)
{
    m_HealthStatus = value;
    m_HealthStatusIsSet = true;
}

bool WebhookDto::healthStatusIsSet() const
{
    return m_HealthStatusIsSet;
}

void WebhookDto::unsetHealthStatus()
{
    m_HealthStatusIsSet = false;
}
}
