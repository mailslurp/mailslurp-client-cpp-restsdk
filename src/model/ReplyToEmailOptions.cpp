...
std::map<utility::string_t, utility::string_t>& ReplyToEmailOptions::getCustomHeaders()
{
    return m_CustomHeaders;
}

void ReplyToEmailOptions::setCustomHeaders(const std::map<utility::string_t, utility::string_t>& value)
{
    m_CustomHeaders = value;
    m_CustomHeadersIsSet = true;
}

bool ReplyToEmailOptions::customHeadersIsSet() const
{
    return m_CustomHeadersIsSet;
}

void ReplyToEmailOptions::unsetCustomHeaders()
{
    m_CustomHeadersIsSet = false;
}
