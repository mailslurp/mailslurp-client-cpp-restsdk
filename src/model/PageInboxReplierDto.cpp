...
void PageInboxReplierDto::validate()
{
    // TODO: implement validation
}

web::json::value PageInboxReplierDto::toJson() const
{
...
bool PageInboxReplierDto::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<InboxReplierDto>> refVal_setContent;
...
void PageInboxReplierDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageInboxReplierDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<InboxReplierDto>>& PageInboxReplierDto::getContent()
{
    return m_Content;
}

void PageInboxReplierDto::setContent(const std::vector<std::shared_ptr<InboxReplierDto>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageInboxReplierDto::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageInboxReplierDto::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageInboxReplierDto::getPageable() const
{
    return m_Pageable;
}

void PageInboxReplierDto::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageInboxReplierDto::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageInboxReplierDto::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PageInboxReplierDto::getTotal() const
{
    return m_Total;
}

void PageInboxReplierDto::setTotal(int64_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool PageInboxReplierDto::totalIsSet() const
{
    return m_TotalIsSet;
}

void PageInboxReplierDto::unsetTotal()
{
    m_TotalIsSet = false;
}
int64_t PageInboxReplierDto::getTotalElements() const
{
    return m_TotalElements;
}

void PageInboxReplierDto::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageInboxReplierDto::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageInboxReplierDto::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PageInboxReplierDto::getTotalPages() const
{
    return m_TotalPages;
}

void PageInboxReplierDto::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageInboxReplierDto::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageInboxReplierDto::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PageInboxReplierDto::isLast() const
{
    return m_Last;
}

void PageInboxReplierDto::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageInboxReplierDto::lastIsSet() const
{
    return m_LastIsSet;
}

void PageInboxReplierDto::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageInboxReplierDto::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageInboxReplierDto::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageInboxReplierDto::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageInboxReplierDto::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
bool PageInboxReplierDto::isFirst() const
{
    return m_First;
}

void PageInboxReplierDto::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageInboxReplierDto::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageInboxReplierDto::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageInboxReplierDto::getSize() const
{
    return m_Size;
}

void PageInboxReplierDto::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageInboxReplierDto::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageInboxReplierDto::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageInboxReplierDto::getNumber() const
{
    return m_number;
}

void PageInboxReplierDto::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageInboxReplierDto::numberIsSet() const
{
    return m_numberIsSet;
}

void PageInboxReplierDto::unsetnumber()
{
    m_numberIsSet = false;
}
std::shared_ptr<SortObject> PageInboxReplierDto::getSort() const
{
    return m_Sort;
}

void PageInboxReplierDto::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageInboxReplierDto::sortIsSet() const
{
    return m_SortIsSet;
}

void PageInboxReplierDto::unsetSort()
{
    m_SortIsSet = false;
}
bool PageInboxReplierDto::isEmpty() const
{
    return m_Empty;
}

void PageInboxReplierDto::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageInboxReplierDto::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageInboxReplierDto::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
