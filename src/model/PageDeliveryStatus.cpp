...
bool PageDeliveryStatus::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<DeliveryStatusDto>> refVal_setContent;
...
std::shared_ptr<SortObject> PageDeliveryStatus::getSort() const
{
    return m_Sort;
}

void PageDeliveryStatus::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
