...
utility::string_t CreateWebhookOptions::getAiTransformId() const
{
    return m_AiTransformId;
}

void CreateWebhookOptions::setAiTransformId(const utility::string_t& value)
{
    m_AiTransformId = value;
    m_AiTransformIdIsSet = true;
}

bool CreateWebhookOptions::aiTransformIdIsSet() const
{
    return m_AiTransformIdIsSet;
}

void CreateWebhookOptions::unsetAiTransformId()
{
    m_AiTransformIdIsSet = false;
}
