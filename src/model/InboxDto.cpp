...
utility::datetime InboxDto::getExpiresAt() const
{
    return m_ExpiresAt;
}

void InboxDto::setExpiresAt(const utility::datetime& value)
{
    m_ExpiresAt = value;
...
utility::string_t InboxDto::getLocalPart() const
{
    return m_LocalPart;
}

void InboxDto::setLocalPart(const utility::string_t& value)
{
    m_LocalPart = value;
    m_LocalPartIsSet = true;
}

bool InboxDto::localPartIsSet() const
{
    return m_LocalPartIsSet;
}

void InboxDto::unsetLocalPart()
{
    m_LocalPartIsSet = false;
}
utility::string_t InboxDto::getDomain() const
{
    return m_Domain;
}

void InboxDto::setDomain(const utility::string_t& value)
{
    m_Domain = value;
    m_DomainIsSet = true;
}

bool InboxDto::domainIsSet() const
{
    return m_DomainIsSet;
}

void InboxDto::unsetDomain()
{
    m_DomainIsSet = false;
}
utility::string_t InboxDto::getAccountRegion() const
{
    return m_AccountRegion;
}

void InboxDto::setAccountRegion(const utility::string_t& value)
{
    m_AccountRegion = value;
    m_AccountRegionIsSet = true;
}

bool InboxDto::accountRegionIsSet() const
{
    return m_AccountRegionIsSet;
}

void InboxDto::unsetAccountRegion()
{
    m_AccountRegionIsSet = false;
}
}
