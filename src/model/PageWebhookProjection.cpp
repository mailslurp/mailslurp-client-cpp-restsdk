...
void PageWebhookProjection::validate()
{
    // TODO: implement validation
}

web::json::value PageWebhookProjection::toJson() const
{
...
bool PageWebhookProjection::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<WebhookProjection>> refVal_setContent;
...
void PageWebhookProjection::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageWebhookProjection::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<WebhookProjection>>& PageWebhookProjection::getContent()
{
    return m_Content;
}

void PageWebhookProjection::setContent(const std::vector<std::shared_ptr<WebhookProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageWebhookProjection::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageWebhookProjection::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageWebhookProjection::getPageable() const
{
    return m_Pageable;
}

void PageWebhookProjection::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageWebhookProjection::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageWebhookProjection::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PageWebhookProjection::getTotal() const
{
    return m_Total;
}

void PageWebhookProjection::setTotal(int64_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool PageWebhookProjection::totalIsSet() const
{
    return m_TotalIsSet;
}

void PageWebhookProjection::unsetTotal()
{
    m_TotalIsSet = false;
}
int64_t PageWebhookProjection::getTotalElements() const
{
    return m_TotalElements;
}

void PageWebhookProjection::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageWebhookProjection::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageWebhookProjection::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PageWebhookProjection::getTotalPages() const
{
    return m_TotalPages;
}

void PageWebhookProjection::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageWebhookProjection::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageWebhookProjection::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PageWebhookProjection::isLast() const
{
    return m_Last;
}

void PageWebhookProjection::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageWebhookProjection::lastIsSet() const
{
    return m_LastIsSet;
}

void PageWebhookProjection::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageWebhookProjection::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageWebhookProjection::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageWebhookProjection::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageWebhookProjection::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
bool PageWebhookProjection::isFirst() const
{
    return m_First;
}

void PageWebhookProjection::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageWebhookProjection::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageWebhookProjection::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageWebhookProjection::getSize() const
{
    return m_Size;
}

void PageWebhookProjection::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageWebhookProjection::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageWebhookProjection::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageWebhookProjection::getNumber() const
{
    return m_number;
}

void PageWebhookProjection::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageWebhookProjection::numberIsSet() const
{
    return m_numberIsSet;
}

void PageWebhookProjection::unsetnumber()
{
    m_numberIsSet = false;
}
std::shared_ptr<SortObject> PageWebhookProjection::getSort() const
{
    return m_Sort;
}

void PageWebhookProjection::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageWebhookProjection::sortIsSet() const
{
    return m_SortIsSet;
}

void PageWebhookProjection::unsetSort()
{
    m_SortIsSet = false;
}
bool PageWebhookProjection::isEmpty() const
{
    return m_Empty;
}

void PageWebhookProjection::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageWebhookProjection::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageWebhookProjection::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
