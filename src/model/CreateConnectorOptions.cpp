...
web::json::value CreateConnectorOptions::toJson() const
{
    ...
    if(m_FetchSettingsIsSet)
    {
        val[utility::conversions::to_string_t(U("fetchSettings"))] = ModelBase::toJson(m_FetchSettings);
    }
...
bool CreateConnectorOptions::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("fetchSettings"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("fetchSettings")));
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CreateConnectorImapFetchOptions> refVal_setFetchSettings;
            ok &= ModelBase::fromJson(fieldValue, refVal_setFetchSettings);
            setFetchSettings(refVal_setFetchSettings);
        }
    }
    return ok;
}
...
void CreateConnectorOptions::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_FetchSettingsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("fetchSettings")), m_FetchSettings));
    }
}
...
bool CreateConnectorOptions::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(U("fetchSettings"))))
    {
        std::shared_ptr<CreateConnectorImapFetchOptions> refVal_setFetchSettings;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("fetchSettings"))), refVal_setFetchSettings );
        setFetchSettings(refVal_setFetchSettings);
    }
    return ok;
}
...
std::shared_ptr<CreateConnectorImapFetchOptions> CreateConnectorOptions::getFetchSettings() const
{
    return m_FetchSettings;
}

void CreateConnectorOptions::setFetchSettings(const std::shared_ptr<CreateConnectorImapFetchOptions>& value)
{
    m_FetchSettings = value;
    m_FetchSettingsIsSet = true;
}

bool CreateConnectorOptions::fetchSettingsIsSet() const
{
    return m_FetchSettingsIsSet;
}

void CreateConnectorOptions::unsetFetchSettings()
{
    m_FetchSettingsIsSet = false;
}
}
