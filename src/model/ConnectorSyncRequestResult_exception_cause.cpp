...
bool ConnectorSyncRequestResult_exception_cause::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("suppressed"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<ConnectorSyncRequestResult_exception_cause_suppressed_inner>> refVal_setSuppressed;
...
std::vector<std::shared_ptr<ConnectorSyncRequestResult_exception_cause_suppressed_inner>>& ConnectorSyncRequestResult_exception_cause::getSuppressed()
{
    return m_Suppressed;
}

void ConnectorSyncRequestResult_exception_cause::setSuppressed(const std::vector<std::shared_ptr<ConnectorSyncRequestResult_exception_cause_suppressed_inner>>& value)
{
    m_Suppressed = value;
    m_SuppressedIsSet = true;
}

bool ConnectorSyncRequestResult_exception_cause::suppressedIsSet() const
{
    return m_SuppressedIsSet;
}

void ConnectorSyncRequestResult_exception_cause::unsetSuppressed()
{
    m_SuppressedIsSet = false;
}
