...
void PageRulesetDto::validate()
{
    // TODO: implement validation
}

web::json::value PageRulesetDto::toJson() const
{
...
bool PageRulesetDto::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<RulesetDto>> refVal_setContent;
...
void PageRulesetDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageRulesetDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<RulesetDto>>& PageRulesetDto::getContent()
{
    return m_Content;
}

void PageRulesetDto::setContent(const std::vector<std::shared_ptr<RulesetDto>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageRulesetDto::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageRulesetDto::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageRulesetDto::getPageable() const
{
    return m_Pageable;
}

void PageRulesetDto::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageRulesetDto::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageRulesetDto::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PageRulesetDto::getTotalElements() const
{
    return m_TotalElements;
}

void PageRulesetDto::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageRulesetDto::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageRulesetDto::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PageRulesetDto::getTotalPages() const
{
    return m_TotalPages;
}

void PageRulesetDto::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageRulesetDto::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageRulesetDto::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PageRulesetDto::isLast() const
{
    return m_Last;
}

void PageRulesetDto::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageRulesetDto::lastIsSet() const
{
    return m_LastIsSet;
}

void PageRulesetDto::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageRulesetDto::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageRulesetDto::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageRulesetDto::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageRulesetDto::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
std::shared_ptr<SortObject> PageRulesetDto::getSort() const
{
    return m_Sort;
}

void PageRulesetDto::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageRulesetDto::sortIsSet() const
{
    return m_SortIsSet;
}

void PageRulesetDto::unsetSort()
{
    m_SortIsSet = false;
}
bool PageRulesetDto::isFirst() const
{
    return m_First;
}

void PageRulesetDto::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageRulesetDto::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageRulesetDto::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageRulesetDto::getSize() const
{
    return m_Size;
}

void PageRulesetDto::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageRulesetDto::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageRulesetDto::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageRulesetDto::getNumber() const
{
    return m_number;
}

void PageRulesetDto::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageRulesetDto::numberIsSet() const
{
    return m_numberIsSet;
}

void PageRulesetDto::unsetnumber()
{
    m_numberIsSet = false;
}
bool PageRulesetDto::isEmpty() const
{
    return m_Empty;
}

void PageRulesetDto::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageRulesetDto::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageRulesetDto::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
