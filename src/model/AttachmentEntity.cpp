...
utility::string_t AttachmentEntity::getInboxId() const
{
    return m_InboxId;
}

void AttachmentEntity::setInboxId(const utility::string_t& value)
{
    m_InboxId = value;
    m_InboxIdIsSet = true;
}

bool AttachmentEntity::inboxIdIsSet() const
{
    return m_InboxIdIsSet;
}

void AttachmentEntity::unsetInboxId()
{
    m_InboxIdIsSet = false;
}
