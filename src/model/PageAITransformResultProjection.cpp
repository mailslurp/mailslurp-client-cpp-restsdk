...
bool PageAITransformResultProjection::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<AITransformResultProjectionDto>> refVal_setContent;
...
std::vector<std::shared_ptr<AITransformResultProjectionDto>>& PageAITransformResultProjection::getContent()
{
    return m_Content;
}

void PageAITransformResultProjection::setContent(const std::vector<std::shared_ptr<AITransformResultProjectionDto>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
...
std::vector<utility::string_t>& PageAITransformResultProjection::getColumns()
{
    return m_Columns;
}

void PageAITransformResultProjection::setColumns(const std::vector<utility::string_t>& value)
{
    m_Columns = value;
    m_ColumnsIsSet = true;
}

bool PageAITransformResultProjection::columnsIsSet() const
{
    return m_ColumnsIsSet;
}

void PageAITransformResultProjection::unsetColumns()
{
    m_ColumnsIsSet = false;
}
