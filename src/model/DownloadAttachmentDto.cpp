...
web::json::value DownloadAttachmentDto::toJson() const
{
    ...
    {
        val[utility::conversions::to_string_t(U("base64FileContents"))] = ModelBase::toJson(m_Base64FileContents);
    }
...
bool DownloadAttachmentDto::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("base64FileContents"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("base64FileContents")));
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_setBase64FileContents;
            ok &= ModelBase::fromJson(fieldValue, refVal_setBase64FileContents);
            setBase64FileContents(refVal_setBase64FileContents);
        }
    }
...
void DownloadAttachmentDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Base64FileContentsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("base64FileContents")), m_Base64FileContents));
    }
    if(m_ContentTypeIsSet)
    {
...
bool DownloadAttachmentDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(U("base64FileContents"))))
    {
        utility::string_t refVal_setBase64FileContents;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("base64FileContents"))), refVal_setBase64FileContents );
        setBase64FileContents(refVal_setBase64FileContents);
    }
