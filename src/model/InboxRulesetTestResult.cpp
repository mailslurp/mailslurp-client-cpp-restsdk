...
web::json::value InboxRulesetTestResult::toJson() const
{
    ...
    {
        val[utility::conversions::to_string_t(U("rulesetMatches"))] = ModelBase::toJson(m_RulesetMatches);
    }
    if(m_MatchesIsSet)
    {
...
bool InboxRulesetTestResult::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("rulesetMatches"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("rulesetMatches")));
        if(!fieldValue.is_null())
        {
            std::map<utility::string_t, bool> refVal_setRulesetMatches;
            ok &= ModelBase::fromJson(fieldValue, refVal_setRulesetMatches);
            setRulesetMatches(refVal_setRulesetMatches);
        }
    }
...
void InboxRulesetTestResult::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_RulesetMatchesIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("rulesetMatches")), m_RulesetMatches));
    }
    if(m_MatchesIsSet)
    {
...
bool InboxRulesetTestResult::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(U("rulesetMatches"))))
    {
        std::map<utility::string_t, bool> refVal_setRulesetMatches;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("rulesetMatches"))), refVal_setRulesetMatches );
        setRulesetMatches(refVal_setRulesetMatches);
    }
