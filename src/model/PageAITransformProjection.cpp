...
void PageAITransformProjection::validate()
{
    // TODO: implement validation
}

web::json::value PageAITransformProjection::toJson() const
{
...
bool PageAITransformProjection::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<AITransformProjection>> refVal_setContent;
...
void PageAITransformProjection::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageAITransformProjection::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<AITransformProjection>>& PageAITransformProjection::getContent()
{
    return m_Content;
}

void PageAITransformProjection::setContent(const std::vector<std::shared_ptr<AITransformProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageAITransformProjection::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageAITransformProjection::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageAITransformProjection::getPageable() const
{
    return m_Pageable;
}

void PageAITransformProjection::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageAITransformProjection::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageAITransformProjection::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PageAITransformProjection::getTotalElements() const
{
    return m_TotalElements;
}

void PageAITransformProjection::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageAITransformProjection::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageAITransformProjection::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PageAITransformProjection::getTotalPages() const
{
    return m_TotalPages;
}

void PageAITransformProjection::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageAITransformProjection::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageAITransformProjection::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PageAITransformProjection::isLast() const
{
    return m_Last;
}

void PageAITransformProjection::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageAITransformProjection::lastIsSet() const
{
    return m_LastIsSet;
}

void PageAITransformProjection::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageAITransformProjection::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageAITransformProjection::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageAITransformProjection::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageAITransformProjection::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
std::shared_ptr<SortObject> PageAITransformProjection::getSort() const
{
    return m_Sort;
}

void PageAITransformProjection::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageAITransformProjection::sortIsSet() const
{
    return m_SortIsSet;
}

void PageAITransformProjection::unsetSort()
{
    m_SortIsSet = false;
}
bool PageAITransformProjection::isFirst() const
{
    return m_First;
}

void PageAITransformProjection::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageAITransformProjection::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageAITransformProjection::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageAITransformProjection::getSize() const
{
    return m_Size;
}

void PageAITransformProjection::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageAITransformProjection::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageAITransformProjection::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageAITransformProjection::getNumber() const
{
    return m_number;
}

void PageAITransformProjection::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageAITransformProjection::numberIsSet() const
{
    return m_numberIsSet;
}

void PageAITransformProjection::unsetnumber()
{
    m_numberIsSet = false;
}
bool PageAITransformProjection::isEmpty() const
{
    return m_Empty;
}

void PageAITransformProjection::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageAITransformProjection::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageAITransformProjection::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
