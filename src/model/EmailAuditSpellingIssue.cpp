...
EmailAuditSpellingIssue::EmailAuditSpellingIssue()
{
...
void EmailAuditSpellingIssue::validate()
{
    // TODO: implement validation
}

web::json::value EmailAuditSpellingIssue::toJson() const
{
...
bool EmailAuditSpellingIssue::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void EmailAuditSpellingIssue::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EmailAuditSpellingIssue::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t EmailAuditSpellingIssue::getGroup() const
{
    return m_Group;
}

void EmailAuditSpellingIssue::setGroup(const utility::string_t& value)
{
    m_Group = value;
    m_GroupIsSet = true;
}

bool EmailAuditSpellingIssue::groupIsSet() const
{
    return m_GroupIsSet;
}

void EmailAuditSpellingIssue::unsetGroup()
{
    m_GroupIsSet = false;
}
utility::string_t EmailAuditSpellingIssue::getSuggestion() const
{
    return m_Suggestion;
}

void EmailAuditSpellingIssue::setSuggestion(const utility::string_t& value)
{
    m_Suggestion = value;
    m_SuggestionIsSet = true;
}

bool EmailAuditSpellingIssue::suggestionIsSet() const
{
    return m_SuggestionIsSet;
}

void EmailAuditSpellingIssue::unsetSuggestion()
{
    m_SuggestionIsSet = false;
}
utility::string_t EmailAuditSpellingIssue::getSeverity() const
{
    return m_Severity;
}

void EmailAuditSpellingIssue::setSeverity(const utility::string_t& value)
{
    m_Severity = value;
    m_SeverityIsSet = true;
}

bool EmailAuditSpellingIssue::severityIsSet() const
{
    return m_SeverityIsSet;
}

void EmailAuditSpellingIssue::unsetSeverity()
{
    m_SeverityIsSet = false;
}
utility::string_t EmailAuditSpellingIssue::getMessage() const
{
    return m_Message;
}

void EmailAuditSpellingIssue::setMessage(const utility::string_t& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}

bool EmailAuditSpellingIssue::messageIsSet() const
{
    return m_MessageIsSet;
}

void EmailAuditSpellingIssue::unsetMessage()
{
    m_MessageIsSet = false;
}
}
