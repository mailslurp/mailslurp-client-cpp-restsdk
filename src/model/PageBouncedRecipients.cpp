...
void PageBouncedRecipients::validate()
{
    // TODO: implement validation
}

web::json::value PageBouncedRecipients::toJson() const
{
...
bool PageBouncedRecipients::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<BounceRecipientProjection>> refVal_setContent;
...
void PageBouncedRecipients::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageBouncedRecipients::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<BounceRecipientProjection>>& PageBouncedRecipients::getContent()
{
    return m_Content;
}

void PageBouncedRecipients::setContent(const std::vector<std::shared_ptr<BounceRecipientProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageBouncedRecipients::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageBouncedRecipients::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageBouncedRecipients::getPageable() const
{
    return m_Pageable;
}

void PageBouncedRecipients::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageBouncedRecipients::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageBouncedRecipients::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PageBouncedRecipients::getTotal() const
{
    return m_Total;
}

void PageBouncedRecipients::setTotal(int64_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool PageBouncedRecipients::totalIsSet() const
{
    return m_TotalIsSet;
}

void PageBouncedRecipients::unsetTotal()
{
    m_TotalIsSet = false;
}
int64_t PageBouncedRecipients::getTotalElements() const
{
    return m_TotalElements;
}

void PageBouncedRecipients::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageBouncedRecipients::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageBouncedRecipients::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PageBouncedRecipients::getTotalPages() const
{
    return m_TotalPages;
}

void PageBouncedRecipients::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageBouncedRecipients::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageBouncedRecipients::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PageBouncedRecipients::isLast() const
{
    return m_Last;
}

void PageBouncedRecipients::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageBouncedRecipients::lastIsSet() const
{
    return m_LastIsSet;
}

void PageBouncedRecipients::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageBouncedRecipients::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageBouncedRecipients::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageBouncedRecipients::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageBouncedRecipients::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
bool PageBouncedRecipients::isFirst() const
{
    return m_First;
}

void PageBouncedRecipients::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageBouncedRecipients::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageBouncedRecipients::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageBouncedRecipients::getSize() const
{
    return m_Size;
}

void PageBouncedRecipients::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageBouncedRecipients::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageBouncedRecipients::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageBouncedRecipients::getNumber() const
{
    return m_number;
}

void PageBouncedRecipients::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageBouncedRecipients::numberIsSet() const
{
    return m_numberIsSet;
}

void PageBouncedRecipients::unsetnumber()
{
    m_numberIsSet = false;
}
std::shared_ptr<SortObject> PageBouncedRecipients::getSort() const
{
    return m_Sort;
}

void PageBouncedRecipients::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageBouncedRecipients::sortIsSet() const
{
    return m_SortIsSet;
}

void PageBouncedRecipients::unsetSort()
{
    m_SortIsSet = false;
}
bool PageBouncedRecipients::isEmpty() const
{
    return m_Empty;
}

void PageBouncedRecipients::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageBouncedRecipients::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageBouncedRecipients::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
