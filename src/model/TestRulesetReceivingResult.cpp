...
void TestRulesetReceivingResult::validate()
{
    // TODO: implement validation
}

web::json::value TestRulesetReceivingResult::toJson() const
{
...
bool TestRulesetReceivingResult::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void TestRulesetReceivingResult::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TestRulesetReceivingResult::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TestRulesetReceivingResult::isCanReceive() const
{
    return m_CanReceive;
}

void TestRulesetReceivingResult::setCanReceive(bool value)
{
    m_CanReceive = value;
    m_CanReceiveIsSet = true;
}

bool TestRulesetReceivingResult::canReceiveIsSet() const
{
    return m_CanReceiveIsSet;
}

void TestRulesetReceivingResult::unsetCanReceive()
{
    m_CanReceiveIsSet = false;
}
}
