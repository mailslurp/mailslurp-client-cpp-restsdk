...
utility::string_t InboxReplierDto::getShould() const
{
    return m_Should;
}

void InboxReplierDto::setShould(const utility::string_t& value)
{
    m_Should = value;
    m_ShouldIsSet = true;
}

bool InboxReplierDto::shouldIsSet() const
{
    return m_ShouldIsSet;
}

void InboxReplierDto::unsetShould()
{
    m_ShouldIsSet = false;
}
std::shared_ptr<InboxAutomationMatchOptions> InboxReplierDto::getMatchOptions() const
{
    return m_MatchOptions;
}

void InboxReplierDto::setMatchOptions(const std::shared_ptr<InboxAutomationMatchOptions>& value)
{
    m_MatchOptions = value;
    m_MatchOptionsIsSet = true;
}

bool InboxReplierDto::matchOptionsIsSet() const
{
    return m_MatchOptionsIsSet;
}

void InboxReplierDto::unsetMatchOptions()
{
    m_MatchOptionsIsSet = false;
}
}
