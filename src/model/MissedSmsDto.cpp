...
void MissedSmsDto::validate()
{
    // TODO: implement validation
}

web::json::value MissedSmsDto::toJson() const
{
...
bool MissedSmsDto::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void MissedSmsDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MissedSmsDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t MissedSmsDto::getId() const
{
    return m_Id;
}

void MissedSmsDto::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool MissedSmsDto::idIsSet() const
{
    return m_IdIsSet;
}

void MissedSmsDto::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t MissedSmsDto::getUserId() const
{
    return m_UserId;
}

void MissedSmsDto::setUserId(const utility::string_t& value)
{
    m_UserId = value;
    m_UserIdIsSet = true;
}

bool MissedSmsDto::userIdIsSet() const
{
    return m_UserIdIsSet;
}

void MissedSmsDto::unsetUserId()
{
    m_UserIdIsSet = false;
}
utility::string_t MissedSmsDto::getPhoneNumber() const
{
    return m_PhoneNumber;
}

void MissedSmsDto::setPhoneNumber(const utility::string_t& value)
{
    m_PhoneNumber = value;
    m_PhoneNumberIsSet = true;
}

bool MissedSmsDto::phoneNumberIsSet() const
{
    return m_PhoneNumberIsSet;
}

void MissedSmsDto::unsetPhoneNumber()
{
    m_PhoneNumberIsSet = false;
}
utility::string_t MissedSmsDto::getFromNumber() const
{
    return m_FromNumber;
}

void MissedSmsDto::setFromNumber(const utility::string_t& value)
{
    m_FromNumber = value;
    m_FromNumberIsSet = true;
}

bool MissedSmsDto::fromNumberIsSet() const
{
    return m_FromNumberIsSet;
}

void MissedSmsDto::unsetFromNumber()
{
    m_FromNumberIsSet = false;
}
utility::string_t MissedSmsDto::getToNumber() const
{
    return m_ToNumber;
}

void MissedSmsDto::setToNumber(const utility::string_t& value)
{
    m_ToNumber = value;
    m_ToNumberIsSet = true;
}

bool MissedSmsDto::toNumberIsSet() const
{
    return m_ToNumberIsSet;
}

void MissedSmsDto::unsetToNumber()
{
    m_ToNumberIsSet = false;
}
utility::string_t MissedSmsDto::getBody() const
{
    return m_Body;
}

void MissedSmsDto::setBody(const utility::string_t& value)
{
    m_Body = value;
    m_BodyIsSet = true;
}

bool MissedSmsDto::bodyIsSet() const
{
    return m_BodyIsSet;
}

void MissedSmsDto::unsetBody()
{
    m_BodyIsSet = false;
}
utility::string_t MissedSmsDto::getSid() const
{
    return m_Sid;
}

void MissedSmsDto::setSid(const utility::string_t& value)
{
    m_Sid = value;
    m_SidIsSet = true;
}

bool MissedSmsDto::sidIsSet() const
{
    return m_SidIsSet;
}

void MissedSmsDto::unsetSid()
{
    m_SidIsSet = false;
}
utility::datetime MissedSmsDto::getCreatedAt() const
{
    return m_CreatedAt;
}

void MissedSmsDto::setCreatedAt(const utility::datetime& value)
{
    m_CreatedAt = value;
    m_CreatedAtIsSet = true;
}

bool MissedSmsDto::createdAtIsSet() const
{
    return m_CreatedAtIsSet;
}

void MissedSmsDto::unsetCreatedAt()
{
    m_CreatedAtIsSet = false;
}
utility::datetime MissedSmsDto::getUpdatedAt() const
{
    return m_UpdatedAt;
}

void MissedSmsDto::setUpdatedAt(const utility::datetime& value)
{
    m_UpdatedAt = value;
    m_UpdatedAtIsSet = true;
}

bool MissedSmsDto::updatedAtIsSet() const
{
    return m_UpdatedAtIsSet;
}

void MissedSmsDto::unsetUpdatedAt()
{
    m_UpdatedAtIsSet = false;
}
}
