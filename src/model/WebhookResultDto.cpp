...
utility::string_t WebhookResultDto::getAiTransformerId() const
{
    return m_AiTransformerId;
}

void WebhookResultDto::setAiTransformerId(const utility::string_t& value)
{
    m_AiTransformerId = value;
    m_AiTransformerIdIsSet = true;
}

bool WebhookResultDto::aiTransformerIdIsSet() const
{
    return m_AiTransformerIdIsSet;
}

void WebhookResultDto::unsetAiTransformerId()
{
    m_AiTransformerIdIsSet = false;
}
}
