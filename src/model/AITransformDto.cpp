...
utility::datetime AITransformDto::getCreatedAt() const
{
    return m_CreatedAt;
}

void AITransformDto::setCreatedAt(const utility::datetime& value)
{
    m_CreatedAt = value;
    m_CreatedAtIsSet = true;
}

bool AITransformDto::createdAtIsSet() const
{
    return m_CreatedAtIsSet;
}

void AITransformDto::unsetCreatedAt()
{
    m_CreatedAtIsSet = false;
}
}
