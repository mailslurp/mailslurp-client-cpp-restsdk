...
#include "CppRestOpenAPIClient/model/AIMappingMatchOption.h"
...
AIMappingMatchOption::AIMappingMatchOption()
{
...
void AIMappingMatchOption::validate()
{
    // TODO: implement validation
}

web::json::value AIMappingMatchOption::toJson() const
{
...
bool AIMappingMatchOption::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AIMappingMatchOption::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AIMappingMatchOption::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t AIMappingMatchOption::getField() const
{
    return m_Field;
}

void AIMappingMatchOption::setField(const utility::string_t& value)
{
    m_Field = value;
    m_FieldIsSet = true;
}

bool AIMappingMatchOption::fieldIsSet() const
{
    return m_FieldIsSet;
}

void AIMappingMatchOption::unsetField()
{
    m_FieldIsSet = false;
}
utility::string_t AIMappingMatchOption::getShould() const
{
    return m_Should;
}

void AIMappingMatchOption::setShould(const utility::string_t& value)
{
    m_Should = value;
    m_ShouldIsSet = true;
}

bool AIMappingMatchOption::shouldIsSet() const
{
    return m_ShouldIsSet;
}

void AIMappingMatchOption::unsetShould()
{
    m_ShouldIsSet = false;
}
utility::string_t AIMappingMatchOption::getValue() const
{
    return m_Value;
}

void AIMappingMatchOption::setValue(const utility::string_t& value)
{
    m_Value = value;
    m_ValueIsSet = true;
}

bool AIMappingMatchOption::valueIsSet() const
{
    return m_ValueIsSet;
}

void AIMappingMatchOption::unsetValue()
{
    m_ValueIsSet = false;
}
}
