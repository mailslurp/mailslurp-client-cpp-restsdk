...
utility::string_t CreateInboxReplierOptions::getShould() const
{
    return m_Should;
}

void CreateInboxReplierOptions::setShould(const utility::string_t& value)
{
    m_Should = value;
    m_ShouldIsSet = true;
}

bool CreateInboxReplierOptions::shouldIsSet() const
{
    return m_ShouldIsSet;
}

void CreateInboxReplierOptions::unsetShould()
{
    m_ShouldIsSet = false;
}
std::shared_ptr<InboxAutomationMatchOptions> CreateInboxReplierOptions::getMatchOptions() const
{
    return m_MatchOptions;
}

void CreateInboxReplierOptions::setMatchOptions(const std::shared_ptr<InboxAutomationMatchOptions>& value)
{
    m_MatchOptions = value;
    m_MatchOptionsIsSet = true;
}

bool CreateInboxReplierOptions::matchOptionsIsSet() const
{
    return m_MatchOptionsIsSet;
}

void CreateInboxReplierOptions::unsetMatchOptions()
{
    m_MatchOptionsIsSet = false;
}
}
