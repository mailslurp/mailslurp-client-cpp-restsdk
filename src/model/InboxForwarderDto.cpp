...
utility::string_t InboxForwarderDto::getShould() const
{
    return m_Should;
}

void InboxForwarderDto::setShould(const utility::string_t& value)
{
    m_Should = value;
    m_ShouldIsSet = true;
}

bool InboxForwarderDto::shouldIsSet() const
{
    return m_ShouldIsSet;
}

void InboxForwarderDto::unsetShould()
{
    m_ShouldIsSet = false;
}
std::shared_ptr<InboxAutomationMatchOptions> InboxForwarderDto::getMatchOptions() const
{
    return m_MatchOptions;
}

void InboxForwarderDto::setMatchOptions(const std::shared_ptr<InboxAutomationMatchOptions>& value)
{
    m_MatchOptions = value;
    m_MatchOptionsIsSet = true;
}

bool InboxForwarderDto::matchOptionsIsSet() const
{
    return m_MatchOptionsIsSet;
}

void InboxForwarderDto::unsetMatchOptions()
{
    m_MatchOptionsIsSet = false;
}
utility::string_t InboxForwarderDto::getAttachmentTextExtractionMethod() const
{
    return m_AttachmentTextExtractionMethod;
}

void InboxForwarderDto::setAttachmentTextExtractionMethod(const utility::string_t& value)
{
    m_AttachmentTextExtractionMethod = value;
    m_AttachmentTextExtractionMethodIsSet = true;
}

bool InboxForwarderDto::attachmentTextExtractionMethodIsSet() const
{
    return m_AttachmentTextExtractionMethodIsSet;
}

void InboxForwarderDto::unsetAttachmentTextExtractionMethod()
{
    m_AttachmentTextExtractionMethodIsSet = false;
}
}
