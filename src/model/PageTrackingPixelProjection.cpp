...
void PageTrackingPixelProjection::validate()
{
    // TODO: implement validation
}

web::json::value PageTrackingPixelProjection::toJson() const
{
...
bool PageTrackingPixelProjection::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<TrackingPixelProjection>> refVal_setContent;
...
void PageTrackingPixelProjection::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageTrackingPixelProjection::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<TrackingPixelProjection>>& PageTrackingPixelProjection::getContent()
{
    return m_Content;
}

void PageTrackingPixelProjection::setContent(const std::vector<std::shared_ptr<TrackingPixelProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageTrackingPixelProjection::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageTrackingPixelProjection::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageTrackingPixelProjection::getPageable() const
{
    return m_Pageable;
}

void PageTrackingPixelProjection::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageTrackingPixelProjection::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageTrackingPixelProjection::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PageTrackingPixelProjection::getTotal() const
{
    return m_Total;
}

void PageTrackingPixelProjection::setTotal(int64_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool PageTrackingPixelProjection::totalIsSet() const
{
    return m_TotalIsSet;
}

void PageTrackingPixelProjection::unsetTotal()
{
    m_TotalIsSet = false;
}
int64_t PageTrackingPixelProjection::getTotalElements() const
{
    return m_TotalElements;
}

void PageTrackingPixelProjection::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageTrackingPixelProjection::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageTrackingPixelProjection::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PageTrackingPixelProjection::getTotalPages() const
{
    return m_TotalPages;
}

void PageTrackingPixelProjection::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageTrackingPixelProjection::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageTrackingPixelProjection::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PageTrackingPixelProjection::isLast() const
{
    return m_Last;
}

void PageTrackingPixelProjection::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageTrackingPixelProjection::lastIsSet() const
{
    return m_LastIsSet;
}

void PageTrackingPixelProjection::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageTrackingPixelProjection::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageTrackingPixelProjection::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageTrackingPixelProjection::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageTrackingPixelProjection::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
bool PageTrackingPixelProjection::isFirst() const
{
    return m_First;
}

void PageTrackingPixelProjection::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageTrackingPixelProjection::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageTrackingPixelProjection::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageTrackingPixelProjection::getSize() const
{
    return m_Size;
}

void PageTrackingPixelProjection::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageTrackingPixelProjection::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageTrackingPixelProjection::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageTrackingPixelProjection::getNumber() const
{
    return m_number;
}

void PageTrackingPixelProjection::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageTrackingPixelProjection::numberIsSet() const
{
    return m_numberIsSet;
}

void PageTrackingPixelProjection::unsetnumber()
{
    m_numberIsSet = false;
}
std::shared_ptr<SortObject> PageTrackingPixelProjection::getSort() const
{
    return m_Sort;
}

void PageTrackingPixelProjection::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageTrackingPixelProjection::sortIsSet() const
{
    return m_SortIsSet;
}

void PageTrackingPixelProjection::unsetSort()
{
    m_SortIsSet = false;
}
bool PageTrackingPixelProjection::isEmpty() const
{
    return m_Empty;
}

void PageTrackingPixelProjection::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageTrackingPixelProjection::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageTrackingPixelProjection::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
