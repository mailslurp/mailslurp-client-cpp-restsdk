...
int64_t EmailPreview::getSizeBytes() const
{
    return m_SizeBytes;
}

void EmailPreview::setSizeBytes(int64_t value)
{
    m_SizeBytes = value;
    m_SizeBytesIsSet = true;
}

bool EmailPreview::sizeBytesIsSet() const
{
    return m_SizeBytesIsSet;
}

void EmailPreview::unsetSizeBytes()
{
    m_SizeBytesIsSet = false;
}
}
