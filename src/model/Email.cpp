...
web::json::value Email::toJson() const
{
    ...
    if(m_XampHtmlIsSet)
    {
        val[utility::conversions::to_string_t(U("xampHtml"))] = ModelBase::toJson(m_XampHtml);
    }
...
bool Email::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("xampHtml"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("xampHtml")));
        if(!fieldValue.is_null())
        {
            bool refVal_setXampHtml;
            ok &= ModelBase::fromJson(fieldValue, refVal_setXampHtml);
            setXampHtml(refVal_setXampHtml);
        }
    }
    return ok;
}
...
void Email::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_XampHtmlIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("xampHtml")), m_XampHtml));
    }
}
...
bool Email::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(U("xampHtml"))))
    {
        bool refVal_setXampHtml;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("xampHtml"))), refVal_setXampHtml );
        setXampHtml(refVal_setXampHtml);
    }
    return ok;
}
...
utility::string_t Email::getTextExcerpt() const
{
    return m_TextExcerpt;
}

void Email::setTextExcerpt(const utility::string_t& value)
{
    m_TextExcerpt = value;
    m_TextExcerptIsSet = true;
}

bool Email::textExcerptIsSet() const
{
    return m_TextExcerptIsSet;
}

void Email::unsetTextExcerpt()
{
    m_TextExcerptIsSet = false;
}
...
bool Email::isIsXAmpHtml() const
{
    return m_IsXAmpHtml;
}

void Email::setIsXAmpHtml(bool value)
{
    m_IsXAmpHtml = value;
    m_IsXAmpHtmlIsSet = true;
}

bool Email::isXAmpHtmlIsSet() const
{
    return m_IsXAmpHtmlIsSet;
}

void Email::unsetIsXAmpHtml()
{
    m_IsXAmpHtmlIsSet = false;
}
std::vector<utility::string_t>& Email::getBodyPartContentTypes()
{
    return m_BodyPartContentTypes;
}

void Email::setBodyPartContentTypes(const std::vector<utility::string_t>& value)
{
    m_BodyPartContentTypes = value;
    m_BodyPartContentTypesIsSet = true;
}

bool Email::bodyPartContentTypesIsSet() const
{
    return m_BodyPartContentTypesIsSet;
}

void Email::unsetBodyPartContentTypes()
{
    m_BodyPartContentTypesIsSet = false;
}
utility::string_t Email::getExternalId() const
{
    return m_ExternalId;
}

void Email::setExternalId(const utility::string_t& value)
{
    m_ExternalId = value;
    m_ExternalIdIsSet = true;
}

bool Email::externalIdIsSet() const
{
    return m_ExternalIdIsSet;
}

void Email::unsetExternalId()
{
    m_ExternalIdIsSet = false;
}
utility::string_t Email::getMessageId() const
{
    return m_MessageId;
}

void Email::setMessageId(const utility::string_t& value)
{
    m_MessageId = value;
    m_MessageIdIsSet = true;
}

bool Email::messageIdIsSet() const
{
    return m_MessageIdIsSet;
}

void Email::unsetMessageId()
{
    m_MessageIdIsSet = false;
}
utility::string_t Email::getThreadId() const
{
    return m_ThreadId;
}

void Email::setThreadId(const utility::string_t& value)
{
    m_ThreadId = value;
    m_ThreadIdIsSet = true;
}

bool Email::threadIdIsSet() const
{
    return m_ThreadIdIsSet;
}

void Email::unsetThreadId()
{
    m_ThreadIdIsSet = false;
}
utility::string_t Email::getInReplyTo() const
{
    return m_InReplyTo;
}

void Email::setInReplyTo(const utility::string_t& value)
{
    m_InReplyTo = value;
    m_InReplyToIsSet = true;
}

bool Email::inReplyToIsSet() const
{
    return m_InReplyToIsSet;
}

void Email::unsetInReplyTo()
{
    m_InReplyToIsSet = false;
}
bool Email::isFavourite() const
{
    return m_Favourite;
}

void Email::setFavourite(bool value)
{
    m_Favourite = value;
    m_FavouriteIsSet = true;
}

bool Email::favouriteIsSet() const
{
    return m_FavouriteIsSet;
}

void Email::unsetFavourite()
{
    m_FavouriteIsSet = false;
}
int64_t Email::getSizeBytes() const
{
    return m_SizeBytes;
}

void Email::setSizeBytes(int64_t value)
{
    m_SizeBytes = value;
    m_SizeBytesIsSet = true;
}

bool Email::sizeBytesIsSet() const
{
    return m_SizeBytesIsSet;
}

void Email::unsetSizeBytes()
{
    m_SizeBytesIsSet = false;
}
...
bool Email::isXampHtml() const
{
    return m_XampHtml;
}

void Email::setXampHtml(bool value)
{
    m_XampHtml = value;
    m_XampHtmlIsSet = true;
}

bool Email::xampHtmlIsSet() const
{
    return m_XampHtmlIsSet;
}

void Email::unsetXampHtml()
{
    m_XampHtmlIsSet = false;
}
}
