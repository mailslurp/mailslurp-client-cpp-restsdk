...
void PagePhoneNumberReleaseProjection::validate()
{
    // TODO: implement validation
}

web::json::value PagePhoneNumberReleaseProjection::toJson() const
{
...
bool PagePhoneNumberReleaseProjection::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<PhoneNumberReleaseProjection>> refVal_setContent;
...
void PagePhoneNumberReleaseProjection::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PagePhoneNumberReleaseProjection::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<PhoneNumberReleaseProjection>>& PagePhoneNumberReleaseProjection::getContent()
{
    return m_Content;
}

void PagePhoneNumberReleaseProjection::setContent(const std::vector<std::shared_ptr<PhoneNumberReleaseProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PagePhoneNumberReleaseProjection::contentIsSet() const
{
    return m_ContentIsSet;
}

void PagePhoneNumberReleaseProjection::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PagePhoneNumberReleaseProjection::getPageable() const
{
    return m_Pageable;
}

void PagePhoneNumberReleaseProjection::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PagePhoneNumberReleaseProjection::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PagePhoneNumberReleaseProjection::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PagePhoneNumberReleaseProjection::getTotalElements() const
{
    return m_TotalElements;
}

void PagePhoneNumberReleaseProjection::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PagePhoneNumberReleaseProjection::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PagePhoneNumberReleaseProjection::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PagePhoneNumberReleaseProjection::getTotalPages() const
{
    return m_TotalPages;
}

void PagePhoneNumberReleaseProjection::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PagePhoneNumberReleaseProjection::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PagePhoneNumberReleaseProjection::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PagePhoneNumberReleaseProjection::isLast() const
{
    return m_Last;
}

void PagePhoneNumberReleaseProjection::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PagePhoneNumberReleaseProjection::lastIsSet() const
{
    return m_LastIsSet;
}

void PagePhoneNumberReleaseProjection::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PagePhoneNumberReleaseProjection::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PagePhoneNumberReleaseProjection::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PagePhoneNumberReleaseProjection::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PagePhoneNumberReleaseProjection::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
std::shared_ptr<SortObject> PagePhoneNumberReleaseProjection::getSort() const
{
    return m_Sort;
}

void PagePhoneNumberReleaseProjection::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PagePhoneNumberReleaseProjection::sortIsSet() const
{
    return m_SortIsSet;
}

void PagePhoneNumberReleaseProjection::unsetSort()
{
    m_SortIsSet = false;
}
bool PagePhoneNumberReleaseProjection::isFirst() const
{
    return m_First;
}

void PagePhoneNumberReleaseProjection::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PagePhoneNumberReleaseProjection::firstIsSet() const
{
    return m_FirstIsSet;
}

void PagePhoneNumberReleaseProjection::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PagePhoneNumberReleaseProjection::getSize() const
{
    return m_Size;
}

void PagePhoneNumberReleaseProjection::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PagePhoneNumberReleaseProjection::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PagePhoneNumberReleaseProjection::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PagePhoneNumberReleaseProjection::getNumber() const
{
    return m_number;
}

void PagePhoneNumberReleaseProjection::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PagePhoneNumberReleaseProjection::numberIsSet() const
{
    return m_numberIsSet;
}

void PagePhoneNumberReleaseProjection::unsetnumber()
{
    m_numberIsSet = false;
}
bool PagePhoneNumberReleaseProjection::isEmpty() const
{
    return m_Empty;
}

void PagePhoneNumberReleaseProjection::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PagePhoneNumberReleaseProjection::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PagePhoneNumberReleaseProjection::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
