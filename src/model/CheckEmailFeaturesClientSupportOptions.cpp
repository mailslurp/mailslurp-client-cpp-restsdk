...
void CheckEmailFeaturesClientSupportOptions::validate()
{
    // TODO: implement validation
}

web::json::value CheckEmailFeaturesClientSupportOptions::toJson() const
{
...
bool CheckEmailFeaturesClientSupportOptions::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CheckEmailFeaturesClientSupportOptions::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CheckEmailFeaturesClientSupportOptions::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t CheckEmailFeaturesClientSupportOptions::getEmailBody() const
{
    return m_EmailBody;
}

void CheckEmailFeaturesClientSupportOptions::setEmailBody(const utility::string_t& value)
{
    m_EmailBody = value;
    m_EmailBodyIsSet = true;
}

bool CheckEmailFeaturesClientSupportOptions::emailBodyIsSet() const
{
    return m_EmailBodyIsSet;
}

void CheckEmailFeaturesClientSupportOptions::unsetEmailBody()
{
    m_EmailBodyIsSet = false;
}
}
