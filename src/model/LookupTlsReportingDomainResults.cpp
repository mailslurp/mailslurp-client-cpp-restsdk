...
void LookupTlsReportingDomainResults::validate()
{
    // TODO: implement validation
}

web::json::value LookupTlsReportingDomainResults::toJson() const
{
...
bool LookupTlsReportingDomainResults::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void LookupTlsReportingDomainResults::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool LookupTlsReportingDomainResults::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool LookupTlsReportingDomainResults::isValid() const
{
    return m_Valid;
}

void LookupTlsReportingDomainResults::setValid(bool value)
{
    m_Valid = value;
    m_ValidIsSet = true;
}

bool LookupTlsReportingDomainResults::validIsSet() const
{
    return m_ValidIsSet;
}

void LookupTlsReportingDomainResults::unsetValid()
{
    m_ValidIsSet = false;
}
std::shared_ptr<DNSLookupOptions> LookupTlsReportingDomainResults::getQuery() const
{
    return m_Query;
}

void LookupTlsReportingDomainResults::setQuery(const std::shared_ptr<DNSLookupOptions>& value)
{
    m_Query = value;
    m_QueryIsSet = true;
}

bool LookupTlsReportingDomainResults::queryIsSet() const
{
    return m_QueryIsSet;
}

void LookupTlsReportingDomainResults::unsetQuery()
{
    m_QueryIsSet = false;
}
std::vector<std::shared_ptr<DNSLookupResult>>& LookupTlsReportingDomainResults::getRecords()
{
    return m_Records;
}

void LookupTlsReportingDomainResults::setRecords(const std::vector<std::shared_ptr<DNSLookupResult>>& value)
{
    m_Records = value;
    m_RecordsIsSet = true;
}

bool LookupTlsReportingDomainResults::recordsIsSet() const
{
    return m_RecordsIsSet;
}

void LookupTlsReportingDomainResults::unsetRecords()
{
    m_RecordsIsSet = false;
}
std::vector<utility::string_t>& LookupTlsReportingDomainResults::getErrors()
{
    return m_Errors;
}

void LookupTlsReportingDomainResults::setErrors(const std::vector<utility::string_t>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool LookupTlsReportingDomainResults::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void LookupTlsReportingDomainResults::unsetErrors()
{
    m_ErrorsIsSet = false;
}
std::vector<utility::string_t>& LookupTlsReportingDomainResults::getWarnings()
{
    return m_Warnings;
}

void LookupTlsReportingDomainResults::setWarnings(const std::vector<utility::string_t>& value)
{
    m_Warnings = value;
    m_WarningsIsSet = true;
}

bool LookupTlsReportingDomainResults::warningsIsSet() const
{
    return m_WarningsIsSet;
}

void LookupTlsReportingDomainResults::unsetWarnings()
{
    m_WarningsIsSet = false;
}
}
