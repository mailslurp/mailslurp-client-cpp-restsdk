...
void PageDevicePreviewRunProjection::validate()
{
    // TODO: implement validation
}

web::json::value PageDevicePreviewRunProjection::toJson() const
{
...
bool PageDevicePreviewRunProjection::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<DevicePreviewRunDto>> refVal_setContent;
...
void PageDevicePreviewRunProjection::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageDevicePreviewRunProjection::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<DevicePreviewRunDto>>& PageDevicePreviewRunProjection::getContent()
{
    return m_Content;
}

void PageDevicePreviewRunProjection::setContent(const std::vector<std::shared_ptr<DevicePreviewRunDto>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageDevicePreviewRunProjection::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageDevicePreviewRunProjection::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageDevicePreviewRunProjection::getPageable() const
{
    return m_Pageable;
}

void PageDevicePreviewRunProjection::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageDevicePreviewRunProjection::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageDevicePreviewRunProjection::unsetPageable()
{
    m_PageableIsSet = false;
}
int32_t PageDevicePreviewRunProjection::getTotalPages() const
{
    return m_TotalPages;
}

void PageDevicePreviewRunProjection::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageDevicePreviewRunProjection::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageDevicePreviewRunProjection::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
int64_t PageDevicePreviewRunProjection::getTotalElements() const
{
    return m_TotalElements;
}

void PageDevicePreviewRunProjection::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageDevicePreviewRunProjection::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageDevicePreviewRunProjection::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
bool PageDevicePreviewRunProjection::isLast() const
{
    return m_Last;
}

void PageDevicePreviewRunProjection::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageDevicePreviewRunProjection::lastIsSet() const
{
    return m_LastIsSet;
}

void PageDevicePreviewRunProjection::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageDevicePreviewRunProjection::getSize() const
{
    return m_Size;
}

void PageDevicePreviewRunProjection::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageDevicePreviewRunProjection::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageDevicePreviewRunProjection::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageDevicePreviewRunProjection::getNumber() const
{
    return m_number;
}

void PageDevicePreviewRunProjection::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageDevicePreviewRunProjection::numberIsSet() const
{
    return m_numberIsSet;
}

void PageDevicePreviewRunProjection::unsetnumber()
{
    m_numberIsSet = false;
}
int32_t PageDevicePreviewRunProjection::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageDevicePreviewRunProjection::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageDevicePreviewRunProjection::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageDevicePreviewRunProjection::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
std::shared_ptr<SortObject> PageDevicePreviewRunProjection::getSort() const
{
    return m_Sort;
}

void PageDevicePreviewRunProjection::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageDevicePreviewRunProjection::sortIsSet() const
{
    return m_SortIsSet;
}

void PageDevicePreviewRunProjection::unsetSort()
{
    m_SortIsSet = false;
}
bool PageDevicePreviewRunProjection::isFirst() const
{
    return m_First;
}

void PageDevicePreviewRunProjection::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageDevicePreviewRunProjection::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageDevicePreviewRunProjection::unsetFirst()
{
    m_FirstIsSet = false;
}
bool PageDevicePreviewRunProjection::isEmpty() const
{
    return m_Empty;
}

void PageDevicePreviewRunProjection::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageDevicePreviewRunProjection::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageDevicePreviewRunProjection::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
