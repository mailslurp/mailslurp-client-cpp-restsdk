...
std::shared_ptr<Sender> SentEmailDto::getSender() const
{
    return m_Sender;
}

void SentEmailDto::setSender(const std::shared_ptr<Sender>& value)
{
    m_Sender = value;
    m_SenderIsSet = true;
}

bool SentEmailDto::senderIsSet() const
{
    return m_SenderIsSet;
}

void SentEmailDto::unsetSender()
{
    m_SenderIsSet = false;
}
std::shared_ptr<EmailRecipients> SentEmailDto::getRecipients() const
{
    return m_Recipients;
}

void SentEmailDto::setRecipients(const std::shared_ptr<EmailRecipients>& value)
{
    m_Recipients = value;
    m_RecipientsIsSet = true;
}

bool SentEmailDto::recipientsIsSet() const
{
    return m_RecipientsIsSet;
}

void SentEmailDto::unsetRecipients()
{
    m_RecipientsIsSet = false;
}
...
utility::datetime SentEmailDto::getCreatedAt() const
{
    return m_CreatedAt;
}

void SentEmailDto::setCreatedAt(const utility::datetime& value)
{
    m_CreatedAt = value;
    m_CreatedAtIsSet = true;
}

bool SentEmailDto::createdAtIsSet() const
{
    return m_CreatedAtIsSet;
}

void SentEmailDto::unsetCreatedAt()
{
    m_CreatedAtIsSet = false;
}
...
std::map<utility::string_t, utility::string_t>& SentEmailDto::getHeaders()
{
    return m_Headers;
}

void SentEmailDto::setHeaders(const std::map<utility::string_t, utility::string_t>& value)
{
    m_Headers = value;
    m_HeadersIsSet = true;
}

bool SentEmailDto::headersIsSet() const
{
    return m_HeadersIsSet;
}

void SentEmailDto::unsetHeaders()
{
    m_HeadersIsSet = false;
}
utility::string_t SentEmailDto::getThreadId() const
{
    return m_ThreadId;
}

void SentEmailDto::setThreadId(const utility::string_t& value)
{
    m_ThreadId = value;
    m_ThreadIdIsSet = true;
}

bool SentEmailDto::threadIdIsSet() const
{
    return m_ThreadIdIsSet;
}

void SentEmailDto::unsetThreadId()
{
    m_ThreadIdIsSet = false;
}
utility::string_t SentEmailDto::getBodyExcerpt() const
{
    return m_BodyExcerpt;
}

void SentEmailDto::setBodyExcerpt(const utility::string_t& value)
{
    m_BodyExcerpt = value;
    m_BodyExcerptIsSet = true;
}

bool SentEmailDto::bodyExcerptIsSet() const
{
    return m_BodyExcerptIsSet;
}

void SentEmailDto::unsetBodyExcerpt()
{
    m_BodyExcerptIsSet = false;
}
utility::string_t SentEmailDto::getTextExcerpt() const
{
    return m_TextExcerpt;
}

void SentEmailDto::setTextExcerpt(const utility::string_t& value)
{
    m_TextExcerpt = value;
    m_TextExcerptIsSet = true;
}

bool SentEmailDto::textExcerptIsSet() const
{
    return m_TextExcerptIsSet;
}

void SentEmailDto::unsetTextExcerpt()
{
    m_TextExcerptIsSet = false;
}
utility::string_t SentEmailDto::getInReplyTo() const
{
    return m_InReplyTo;
}

void SentEmailDto::setInReplyTo(const utility::string_t& value)
{
    m_InReplyTo = value;
    m_InReplyToIsSet = true;
}

bool SentEmailDto::inReplyToIsSet() const
{
    return m_InReplyToIsSet;
}

void SentEmailDto::unsetInReplyTo()
{
    m_InReplyToIsSet = false;
}
bool SentEmailDto::isFavourite() const
{
    return m_Favourite;
}

void SentEmailDto::setFavourite(bool value)
{
    m_Favourite = value;
    m_FavouriteIsSet = true;
}

bool SentEmailDto::favouriteIsSet() const
{
    return m_FavouriteIsSet;
}

void SentEmailDto::unsetFavourite()
{
    m_FavouriteIsSet = false;
}
int64_t SentEmailDto::getSizeBytes() const
{
    return m_SizeBytes;
}

void SentEmailDto::setSizeBytes(int64_t value)
{
    m_SizeBytes = value;
    m_SizeBytesIsSet = true;
}

bool SentEmailDto::sizeBytesIsSet() const
{
    return m_SizeBytesIsSet;
}

void SentEmailDto::unsetSizeBytes()
{
    m_SizeBytesIsSet = false;
}
