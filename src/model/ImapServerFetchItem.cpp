...
int64_t ImapServerFetchItem::getUid() const
{
    return m_Uid;
}

void ImapServerFetchItem::setUid(int64_t value)
{
    m_Uid = value;
    m_UidIsSet = true;
}
...
int64_t ImapServerFetchItem::getSeqNum() const
{
    return m_SeqNum;
}

void ImapServerFetchItem::setSeqNum(int64_t value)
{
    m_SeqNum = value;
    m_SeqNumIsSet = true;
}
