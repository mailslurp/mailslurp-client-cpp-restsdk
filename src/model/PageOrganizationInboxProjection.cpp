...
void PageOrganizationInboxProjection::validate()
{
    // TODO: implement validation
}

web::json::value PageOrganizationInboxProjection::toJson() const
{
...
bool PageOrganizationInboxProjection::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<OrganizationInboxProjection>> refVal_setContent;
...
void PageOrganizationInboxProjection::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageOrganizationInboxProjection::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<OrganizationInboxProjection>>& PageOrganizationInboxProjection::getContent()
{
    return m_Content;
}

void PageOrganizationInboxProjection::setContent(const std::vector<std::shared_ptr<OrganizationInboxProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageOrganizationInboxProjection::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageOrganizationInboxProjection::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageOrganizationInboxProjection::getPageable() const
{
    return m_Pageable;
}

void PageOrganizationInboxProjection::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageOrganizationInboxProjection::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageOrganizationInboxProjection::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PageOrganizationInboxProjection::getTotal() const
{
    return m_Total;
}

void PageOrganizationInboxProjection::setTotal(int64_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool PageOrganizationInboxProjection::totalIsSet() const
{
    return m_TotalIsSet;
}

void PageOrganizationInboxProjection::unsetTotal()
{
    m_TotalIsSet = false;
}
int64_t PageOrganizationInboxProjection::getTotalElements() const
{
    return m_TotalElements;
}

void PageOrganizationInboxProjection::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageOrganizationInboxProjection::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageOrganizationInboxProjection::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PageOrganizationInboxProjection::getTotalPages() const
{
    return m_TotalPages;
}

void PageOrganizationInboxProjection::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageOrganizationInboxProjection::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageOrganizationInboxProjection::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PageOrganizationInboxProjection::isLast() const
{
    return m_Last;
}

void PageOrganizationInboxProjection::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageOrganizationInboxProjection::lastIsSet() const
{
    return m_LastIsSet;
}

void PageOrganizationInboxProjection::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageOrganizationInboxProjection::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageOrganizationInboxProjection::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageOrganizationInboxProjection::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageOrganizationInboxProjection::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
bool PageOrganizationInboxProjection::isFirst() const
{
    return m_First;
}

void PageOrganizationInboxProjection::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageOrganizationInboxProjection::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageOrganizationInboxProjection::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageOrganizationInboxProjection::getSize() const
{
    return m_Size;
}

void PageOrganizationInboxProjection::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageOrganizationInboxProjection::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageOrganizationInboxProjection::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageOrganizationInboxProjection::getNumber() const
{
    return m_number;
}

void PageOrganizationInboxProjection::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageOrganizationInboxProjection::numberIsSet() const
{
    return m_numberIsSet;
}

void PageOrganizationInboxProjection::unsetnumber()
{
    m_numberIsSet = false;
}
std::shared_ptr<SortObject> PageOrganizationInboxProjection::getSort() const
{
    return m_Sort;
}

void PageOrganizationInboxProjection::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageOrganizationInboxProjection::sortIsSet() const
{
    return m_SortIsSet;
}

void PageOrganizationInboxProjection::unsetSort()
{
    m_SortIsSet = false;
}
bool PageOrganizationInboxProjection::isEmpty() const
{
    return m_Empty;
}

void PageOrganizationInboxProjection::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageOrganizationInboxProjection::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageOrganizationInboxProjection::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
