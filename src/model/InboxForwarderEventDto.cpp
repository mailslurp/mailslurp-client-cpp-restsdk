...
void InboxForwarderEventDto::validate()
{
    // TODO: implement validation
}

web::json::value InboxForwarderEventDto::toJson() const
{
...
bool InboxForwarderEventDto::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void InboxForwarderEventDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool InboxForwarderEventDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t InboxForwarderEventDto::getId() const
{
    return m_Id;
}

void InboxForwarderEventDto::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool InboxForwarderEventDto::idIsSet() const
{
    return m_IdIsSet;
}

void InboxForwarderEventDto::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t InboxForwarderEventDto::getInboxId() const
{
    return m_InboxId;
}

void InboxForwarderEventDto::setInboxId(const utility::string_t& value)
{
    m_InboxId = value;
    m_InboxIdIsSet = true;
}

bool InboxForwarderEventDto::inboxIdIsSet() const
{
    return m_InboxIdIsSet;
}

void InboxForwarderEventDto::unsetInboxId()
{
    m_InboxIdIsSet = false;
}
utility::string_t InboxForwarderEventDto::getEmailId() const
{
    return m_EmailId;
}

void InboxForwarderEventDto::setEmailId(const utility::string_t& value)
{
    m_EmailId = value;
    m_EmailIdIsSet = true;
}

bool InboxForwarderEventDto::emailIdIsSet() const
{
    return m_EmailIdIsSet;
}

void InboxForwarderEventDto::unsetEmailId()
{
    m_EmailIdIsSet = false;
}
utility::string_t InboxForwarderEventDto::getSentId() const
{
    return m_SentId;
}

void InboxForwarderEventDto::setSentId(const utility::string_t& value)
{
    m_SentId = value;
    m_SentIdIsSet = true;
}

bool InboxForwarderEventDto::sentIdIsSet() const
{
    return m_SentIdIsSet;
}

void InboxForwarderEventDto::unsetSentId()
{
    m_SentIdIsSet = false;
}
utility::string_t InboxForwarderEventDto::getUserId() const
{
    return m_UserId;
}

void InboxForwarderEventDto::setUserId(const utility::string_t& value)
{
    m_UserId = value;
    m_UserIdIsSet = true;
}

bool InboxForwarderEventDto::userIdIsSet() const
{
    return m_UserIdIsSet;
}

void InboxForwarderEventDto::unsetUserId()
{
    m_UserIdIsSet = false;
}
utility::string_t InboxForwarderEventDto::getForwarderId() const
{
    return m_ForwarderId;
}

void InboxForwarderEventDto::setForwarderId(const utility::string_t& value)
{
    m_ForwarderId = value;
    m_ForwarderIdIsSet = true;
}

bool InboxForwarderEventDto::forwarderIdIsSet() const
{
    return m_ForwarderIdIsSet;
}

void InboxForwarderEventDto::unsetForwarderId()
{
    m_ForwarderIdIsSet = false;
}
utility::string_t InboxForwarderEventDto::getMessage() const
{
    return m_Message;
}

void InboxForwarderEventDto::setMessage(const utility::string_t& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}

bool InboxForwarderEventDto::messageIsSet() const
{
    return m_MessageIsSet;
}

void InboxForwarderEventDto::unsetMessage()
{
    m_MessageIsSet = false;
}
utility::string_t InboxForwarderEventDto::getStatus() const
{
    return m_Status;
}

void InboxForwarderEventDto::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool InboxForwarderEventDto::statusIsSet() const
{
    return m_StatusIsSet;
}

void InboxForwarderEventDto::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::datetime InboxForwarderEventDto::getCreatedAt() const
{
    return m_CreatedAt;
}

void InboxForwarderEventDto::setCreatedAt(const utility::datetime& value)
{
    m_CreatedAt = value;
    m_CreatedAtIsSet = true;
}

bool InboxForwarderEventDto::createdAtIsSet() const
{
    return m_CreatedAtIsSet;
}

void InboxForwarderEventDto::unsetCreatedAt()
{
    m_CreatedAtIsSet = false;
}
}
