...
void StructuredContentResultDto::validate()
{
    // TODO: implement validation
}

web::json::value StructuredContentResultDto::toJson() const
{
...
bool StructuredContentResultDto::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void StructuredContentResultDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool StructuredContentResultDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Object> StructuredContentResultDto::getResult() const
{
    return m_Result;
}

void StructuredContentResultDto::setResult(const std::shared_ptr<Object>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool StructuredContentResultDto::resultIsSet() const
{
    return m_ResultIsSet;
}

void StructuredContentResultDto::unsetResult()
{
    m_ResultIsSet = false;
}
}
