...
void PageEntityFavouriteItems::validate()
{
    // TODO: implement validation
}

web::json::value PageEntityFavouriteItems::toJson() const
{
...
bool PageEntityFavouriteItems::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<EntityFavouriteItemProjection>> refVal_setContent;
...
void PageEntityFavouriteItems::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageEntityFavouriteItems::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<EntityFavouriteItemProjection>>& PageEntityFavouriteItems::getContent()
{
    return m_Content;
}

void PageEntityFavouriteItems::setContent(const std::vector<std::shared_ptr<EntityFavouriteItemProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageEntityFavouriteItems::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageEntityFavouriteItems::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageEntityFavouriteItems::getPageable() const
{
    return m_Pageable;
}

void PageEntityFavouriteItems::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageEntityFavouriteItems::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageEntityFavouriteItems::unsetPageable()
{
    m_PageableIsSet = false;
}
int32_t PageEntityFavouriteItems::getTotalPages() const
{
    return m_TotalPages;
}

void PageEntityFavouriteItems::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageEntityFavouriteItems::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageEntityFavouriteItems::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
int64_t PageEntityFavouriteItems::getTotalElements() const
{
    return m_TotalElements;
}

void PageEntityFavouriteItems::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageEntityFavouriteItems::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageEntityFavouriteItems::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
bool PageEntityFavouriteItems::isLast() const
{
    return m_Last;
}

void PageEntityFavouriteItems::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageEntityFavouriteItems::lastIsSet() const
{
    return m_LastIsSet;
}

void PageEntityFavouriteItems::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageEntityFavouriteItems::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageEntityFavouriteItems::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageEntityFavouriteItems::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageEntityFavouriteItems::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
bool PageEntityFavouriteItems::isFirst() const
{
    return m_First;
}

void PageEntityFavouriteItems::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageEntityFavouriteItems::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageEntityFavouriteItems::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageEntityFavouriteItems::getSize() const
{
    return m_Size;
}

void PageEntityFavouriteItems::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageEntityFavouriteItems::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageEntityFavouriteItems::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageEntityFavouriteItems::getNumber() const
{
    return m_number;
}

void PageEntityFavouriteItems::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageEntityFavouriteItems::numberIsSet() const
{
    return m_numberIsSet;
}

void PageEntityFavouriteItems::unsetnumber()
{
    m_numberIsSet = false;
}
std::shared_ptr<SortObject> PageEntityFavouriteItems::getSort() const
{
    return m_Sort;
}

void PageEntityFavouriteItems::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageEntityFavouriteItems::sortIsSet() const
{
    return m_SortIsSet;
}

void PageEntityFavouriteItems::unsetSort()
{
    m_SortIsSet = false;
}
bool PageEntityFavouriteItems::isEmpty() const
{
    return m_Empty;
}

void PageEntityFavouriteItems::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageEntityFavouriteItems::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageEntityFavouriteItems::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
