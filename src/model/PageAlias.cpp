...
bool PageAlias::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<AliasProjection>> refVal_setContent;
...
std::shared_ptr<SortObject> PageAlias::getSort() const
{
    return m_Sort;
}

void PageAlias::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
