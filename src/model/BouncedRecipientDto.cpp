...
utility::string_t BouncedRecipientDto::getBounceType() const
{
    return m_BounceType;
}

void BouncedRecipientDto::setBounceType(const utility::string_t& value)
{
    m_BounceType = value;
    m_BounceTypeIsSet = true;
}

bool BouncedRecipientDto::bounceTypeIsSet() const
{
    return m_BounceTypeIsSet;
}

void BouncedRecipientDto::unsetBounceType()
{
    m_BounceTypeIsSet = false;
}
