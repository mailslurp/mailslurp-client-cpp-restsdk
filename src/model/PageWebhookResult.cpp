...
void PageWebhookResult::validate()
{
    // TODO: implement validation
}

web::json::value PageWebhookResult::toJson() const
{
...
bool PageWebhookResult::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<WebhookResultDto>> refVal_setContent;
...
void PageWebhookResult::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageWebhookResult::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<WebhookResultDto>>& PageWebhookResult::getContent()
{
    return m_Content;
}

void PageWebhookResult::setContent(const std::vector<std::shared_ptr<WebhookResultDto>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageWebhookResult::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageWebhookResult::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageWebhookResult::getPageable() const
{
    return m_Pageable;
}

void PageWebhookResult::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageWebhookResult::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageWebhookResult::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PageWebhookResult::getTotal() const
{
    return m_Total;
}

void PageWebhookResult::setTotal(int64_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool PageWebhookResult::totalIsSet() const
{
    return m_TotalIsSet;
}

void PageWebhookResult::unsetTotal()
{
    m_TotalIsSet = false;
}
int64_t PageWebhookResult::getTotalElements() const
{
    return m_TotalElements;
}

void PageWebhookResult::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageWebhookResult::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageWebhookResult::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PageWebhookResult::getTotalPages() const
{
    return m_TotalPages;
}

void PageWebhookResult::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageWebhookResult::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageWebhookResult::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PageWebhookResult::isLast() const
{
    return m_Last;
}

void PageWebhookResult::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageWebhookResult::lastIsSet() const
{
    return m_LastIsSet;
}

void PageWebhookResult::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageWebhookResult::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageWebhookResult::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageWebhookResult::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageWebhookResult::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
bool PageWebhookResult::isFirst() const
{
    return m_First;
}

void PageWebhookResult::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageWebhookResult::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageWebhookResult::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageWebhookResult::getSize() const
{
    return m_Size;
}

void PageWebhookResult::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageWebhookResult::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageWebhookResult::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageWebhookResult::getNumber() const
{
    return m_number;
}

void PageWebhookResult::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageWebhookResult::numberIsSet() const
{
    return m_numberIsSet;
}

void PageWebhookResult::unsetnumber()
{
    m_numberIsSet = false;
}
std::shared_ptr<SortObject> PageWebhookResult::getSort() const
{
    return m_Sort;
}

void PageWebhookResult::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageWebhookResult::sortIsSet() const
{
    return m_SortIsSet;
}

void PageWebhookResult::unsetSort()
{
    m_SortIsSet = false;
}
bool PageWebhookResult::isEmpty() const
{
    return m_Empty;
}

void PageWebhookResult::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageWebhookResult::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageWebhookResult::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
