...
web::json::value UploadMultipartForm_request::toJson() const
{
    ...
    {
        val[utility::conversions::to_string_t(U("contentTypeHeader"))] = ModelBase::toJson(m_ContentTypeHeader);
    }
    if(m_fileIsSet)
    {
...
bool UploadMultipartForm_request::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("contentTypeHeader"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("contentTypeHeader")));
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_setContentTypeHeader;
            ok &= ModelBase::fromJson(fieldValue, refVal_setContentTypeHeader);
            setContentTypeHeader(refVal_setContentTypeHeader);
        }
    }
...
void UploadMultipartForm_request::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_ContentTypeHeaderIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("contentTypeHeader")), m_ContentTypeHeader));
    }
    if(m_fileIsSet)
    {
...
bool UploadMultipartForm_request::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(U("contentTypeHeader"))))
    {
        utility::string_t refVal_setContentTypeHeader;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("contentTypeHeader"))), refVal_setContentTypeHeader );
        setContentTypeHeader(refVal_setContentTypeHeader);
    }
...
utility::string_t UploadMultipartForm_request::getContentTypeHeader() const
{
    return m_ContentTypeHeader;
}

void UploadMultipartForm_request::setContentTypeHeader(const utility::string_t& value)
{
    m_ContentTypeHeader = value;
    m_ContentTypeHeaderIsSet = true;
}

bool UploadMultipartForm_request::contentTypeHeaderIsSet() const
{
    return m_ContentTypeHeaderIsSet;
}

void UploadMultipartForm_request::unsetContentTypeHeader()
{
    m_ContentTypeHeaderIsSet = false;
}
