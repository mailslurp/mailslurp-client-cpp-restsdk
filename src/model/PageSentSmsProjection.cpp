...
void PageSentSmsProjection::validate()
{
    // TODO: implement validation
}

web::json::value PageSentSmsProjection::toJson() const
{
...
bool PageSentSmsProjection::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<SentSmsProjection>> refVal_setContent;
...
void PageSentSmsProjection::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageSentSmsProjection::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<SentSmsProjection>>& PageSentSmsProjection::getContent()
{
    return m_Content;
}

void PageSentSmsProjection::setContent(const std::vector<std::shared_ptr<SentSmsProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageSentSmsProjection::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageSentSmsProjection::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageSentSmsProjection::getPageable() const
{
    return m_Pageable;
}

void PageSentSmsProjection::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageSentSmsProjection::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageSentSmsProjection::unsetPageable()
{
    m_PageableIsSet = false;
}
int32_t PageSentSmsProjection::getTotalPages() const
{
    return m_TotalPages;
}

void PageSentSmsProjection::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageSentSmsProjection::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageSentSmsProjection::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
int64_t PageSentSmsProjection::getTotalElements() const
{
    return m_TotalElements;
}

void PageSentSmsProjection::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageSentSmsProjection::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageSentSmsProjection::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
bool PageSentSmsProjection::isLast() const
{
    return m_Last;
}

void PageSentSmsProjection::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageSentSmsProjection::lastIsSet() const
{
    return m_LastIsSet;
}

void PageSentSmsProjection::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageSentSmsProjection::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageSentSmsProjection::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageSentSmsProjection::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageSentSmsProjection::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
bool PageSentSmsProjection::isFirst() const
{
    return m_First;
}

void PageSentSmsProjection::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageSentSmsProjection::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageSentSmsProjection::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageSentSmsProjection::getSize() const
{
    return m_Size;
}

void PageSentSmsProjection::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageSentSmsProjection::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageSentSmsProjection::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageSentSmsProjection::getNumber() const
{
    return m_number;
}

void PageSentSmsProjection::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageSentSmsProjection::numberIsSet() const
{
    return m_numberIsSet;
}

void PageSentSmsProjection::unsetnumber()
{
    m_numberIsSet = false;
}
std::shared_ptr<SortObject> PageSentSmsProjection::getSort() const
{
    return m_Sort;
}

void PageSentSmsProjection::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageSentSmsProjection::sortIsSet() const
{
    return m_SortIsSet;
}

void PageSentSmsProjection::unsetSort()
{
    m_SortIsSet = false;
}
bool PageSentSmsProjection::isEmpty() const
{
    return m_Empty;
}

void PageSentSmsProjection::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageSentSmsProjection::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageSentSmsProjection::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
