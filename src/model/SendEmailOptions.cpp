...
SendEmailOptions::SendEmailOptions()
{
    ...
    m_IgnoreEmptyRecipients = false;
    m_IgnoreEmptyRecipientsIsSet = false;
    m_IsXAmpHtml = false;
    m_IsXAmpHtmlIsSet = false;
...
web::json::value SendEmailOptions::toJson() const
{
    ...
    if(m_IgnoreEmptyRecipientsIsSet)
    {
        val[utility::conversions::to_string_t(U("ignoreEmptyRecipients"))] = ModelBase::toJson(m_IgnoreEmptyRecipients);
    }
    if(m_IsXAmpHtmlIsSet)
    {
        val[utility::conversions::to_string_t(U("isXAmpHtml"))] = ModelBase::toJson(m_IsXAmpHtml);
    }
    if(m_BodyPartsIsSet)
    {
        val[utility::conversions::to_string_t(U("bodyParts"))] = ModelBase::toJson(m_BodyParts);
    }
...
bool SendEmailOptions::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("ignoreEmptyRecipients"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("ignoreEmptyRecipients")));
        if(!fieldValue.is_null())
        {
            bool refVal_setIgnoreEmptyRecipients;
            ok &= ModelBase::fromJson(fieldValue, refVal_setIgnoreEmptyRecipients);
            setIgnoreEmptyRecipients(refVal_setIgnoreEmptyRecipients);
        }
    }
    if(val.has_field(utility::conversions::to_string_t(U("isXAmpHtml"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("isXAmpHtml")));
        if(!fieldValue.is_null())
        {
            bool refVal_setIsXAmpHtml;
            ok &= ModelBase::fromJson(fieldValue, refVal_setIsXAmpHtml);
            setIsXAmpHtml(refVal_setIsXAmpHtml);
        }
    }
    if(val.has_field(utility::conversions::to_string_t(U("bodyParts"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("bodyParts")));
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<SendEmailBodyPart>> refVal_setBodyParts;
            ok &= ModelBase::fromJson(fieldValue, refVal_setBodyParts);
            setBodyParts(refVal_setBodyParts);
        }
    }
    return ok;
}
...
void SendEmailOptions::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_IgnoreEmptyRecipientsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("ignoreEmptyRecipients")), m_IgnoreEmptyRecipients));
    }
    if(m_IsXAmpHtmlIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("isXAmpHtml")), m_IsXAmpHtml));
    }
    if(m_BodyPartsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("bodyParts")), m_BodyParts));
    }
}
...
bool SendEmailOptions::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(U("ignoreEmptyRecipients"))))
    {
        bool refVal_setIgnoreEmptyRecipients;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("ignoreEmptyRecipients"))), refVal_setIgnoreEmptyRecipients );
        setIgnoreEmptyRecipients(refVal_setIgnoreEmptyRecipients);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("isXAmpHtml"))))
    {
        bool refVal_setIsXAmpHtml;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("isXAmpHtml"))), refVal_setIsXAmpHtml );
        setIsXAmpHtml(refVal_setIsXAmpHtml);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("bodyParts"))))
    {
        std::vector<std::shared_ptr<SendEmailBodyPart>> refVal_setBodyParts;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("bodyParts"))), refVal_setBodyParts );
        setBodyParts(refVal_setBodyParts);
    }
    return ok;
}
...
utility::string_t SendEmailOptions::getFromName() const
{
    return m_FromName;
}

void SendEmailOptions::setFromName(const utility::string_t& value)
{
    m_FromName = value;
    m_FromNameIsSet = true;
}

bool SendEmailOptions::fromNameIsSet() const
{
    return m_FromNameIsSet;
}

void SendEmailOptions::unsetFromName()
{
    m_FromNameIsSet = false;
}
...
std::map<utility::string_t, utility::string_t>& SendEmailOptions::getCustomHeaders()
{
    return m_CustomHeaders;
}

void SendEmailOptions::setCustomHeaders(const std::map<utility::string_t, utility::string_t>& value)
{
    m_CustomHeaders = value;
    m_CustomHeadersIsSet = true;
}

bool SendEmailOptions::customHeadersIsSet() const
{
    return m_CustomHeadersIsSet;
}

void SendEmailOptions::unsetCustomHeaders()
{
    m_CustomHeadersIsSet = false;
}
...
bool SendEmailOptions::isIgnoreEmptyRecipients() const
{
    return m_IgnoreEmptyRecipients;
}

void SendEmailOptions::setIgnoreEmptyRecipients(bool value)
{
    m_IgnoreEmptyRecipients = value;
    m_IgnoreEmptyRecipientsIsSet = true;
}

bool SendEmailOptions::ignoreEmptyRecipientsIsSet() const
{
    return m_IgnoreEmptyRecipientsIsSet;
}

void SendEmailOptions::unsetIgnoreEmptyRecipients()
{
    m_IgnoreEmptyRecipientsIsSet = false;
}
bool SendEmailOptions::isIsXAmpHtml() const
{
    return m_IsXAmpHtml;
}

void SendEmailOptions::setIsXAmpHtml(bool value)
{
    m_IsXAmpHtml = value;
    m_IsXAmpHtmlIsSet = true;
}

bool SendEmailOptions::isXAmpHtmlIsSet() const
{
    return m_IsXAmpHtmlIsSet;
}

void SendEmailOptions::unsetIsXAmpHtml()
{
    m_IsXAmpHtmlIsSet = false;
}
std::vector<std::shared_ptr<SendEmailBodyPart>>& SendEmailOptions::getBodyParts()
{
    return m_BodyParts;
}

void SendEmailOptions::setBodyParts(const std::vector<std::shared_ptr<SendEmailBodyPart>>& value)
{
    m_BodyParts = value;
    m_BodyPartsIsSet = true;
}

bool SendEmailOptions::bodyPartsIsSet() const
{
    return m_BodyPartsIsSet;
}

void SendEmailOptions::unsetBodyParts()
{
    m_BodyPartsIsSet = false;
}
}
