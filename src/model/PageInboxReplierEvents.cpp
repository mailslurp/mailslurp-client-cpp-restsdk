...
void PageInboxReplierEvents::validate()
{
    // TODO: implement validation
}

web::json::value PageInboxReplierEvents::toJson() const
{
...
bool PageInboxReplierEvents::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<InboxReplierEventProjection>> refVal_setContent;
...
void PageInboxReplierEvents::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageInboxReplierEvents::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<InboxReplierEventProjection>>& PageInboxReplierEvents::getContent()
{
    return m_Content;
}

void PageInboxReplierEvents::setContent(const std::vector<std::shared_ptr<InboxReplierEventProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageInboxReplierEvents::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageInboxReplierEvents::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageInboxReplierEvents::getPageable() const
{
    return m_Pageable;
}

void PageInboxReplierEvents::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageInboxReplierEvents::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageInboxReplierEvents::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PageInboxReplierEvents::getTotal() const
{
    return m_Total;
}

void PageInboxReplierEvents::setTotal(int64_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool PageInboxReplierEvents::totalIsSet() const
{
    return m_TotalIsSet;
}

void PageInboxReplierEvents::unsetTotal()
{
    m_TotalIsSet = false;
}
int64_t PageInboxReplierEvents::getTotalElements() const
{
    return m_TotalElements;
}

void PageInboxReplierEvents::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageInboxReplierEvents::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageInboxReplierEvents::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PageInboxReplierEvents::getTotalPages() const
{
    return m_TotalPages;
}

void PageInboxReplierEvents::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageInboxReplierEvents::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageInboxReplierEvents::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PageInboxReplierEvents::isLast() const
{
    return m_Last;
}

void PageInboxReplierEvents::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageInboxReplierEvents::lastIsSet() const
{
    return m_LastIsSet;
}

void PageInboxReplierEvents::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageInboxReplierEvents::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageInboxReplierEvents::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageInboxReplierEvents::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageInboxReplierEvents::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
bool PageInboxReplierEvents::isFirst() const
{
    return m_First;
}

void PageInboxReplierEvents::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageInboxReplierEvents::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageInboxReplierEvents::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageInboxReplierEvents::getSize() const
{
    return m_Size;
}

void PageInboxReplierEvents::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageInboxReplierEvents::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageInboxReplierEvents::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageInboxReplierEvents::getNumber() const
{
    return m_number;
}

void PageInboxReplierEvents::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageInboxReplierEvents::numberIsSet() const
{
    return m_numberIsSet;
}

void PageInboxReplierEvents::unsetnumber()
{
    m_numberIsSet = false;
}
std::shared_ptr<SortObject> PageInboxReplierEvents::getSort() const
{
    return m_Sort;
}

void PageInboxReplierEvents::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageInboxReplierEvents::sortIsSet() const
{
    return m_SortIsSet;
}

void PageInboxReplierEvents::unsetSort()
{
    m_SortIsSet = false;
}
bool PageInboxReplierEvents::isEmpty() const
{
    return m_Empty;
}

void PageInboxReplierEvents::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageInboxReplierEvents::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageInboxReplierEvents::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
