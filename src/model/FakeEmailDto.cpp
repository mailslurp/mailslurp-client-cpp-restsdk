...
FakeEmailDto::FakeEmailDto()
{
    ...
    m_BodyUrl = utility::conversions::to_string_t("");
    m_BodyUrlIsSet = false;
}
...
web::json::value FakeEmailDto::toJson() const
{
    ...
    if(m_AttachmentNamesIsSet)
    {
        val[utility::conversions::to_string_t(U("attachmentNames"))] = ModelBase::toJson(m_AttachmentNames);
    }
    if(m_SubjectIsSet)
    {
    ...
    if(m_BodyUrlIsSet)
    {
        val[utility::conversions::to_string_t(U("bodyUrl"))] = ModelBase::toJson(m_BodyUrl);
    }
...
bool FakeEmailDto::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("attachmentNames"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("attachmentNames")));
        if(!fieldValue.is_null())
        {
            std::vector<utility::string_t> refVal_setAttachmentNames;
            ok &= ModelBase::fromJson(fieldValue, refVal_setAttachmentNames);
            setAttachmentNames(refVal_setAttachmentNames);
        }
    }
    ...
    if(val.has_field(utility::conversions::to_string_t(U("bodyUrl"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("bodyUrl")));
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_setBodyUrl;
            ok &= ModelBase::fromJson(fieldValue, refVal_setBodyUrl);
            setBodyUrl(refVal_setBodyUrl);
        }
    }
    return ok;
}
...
void FakeEmailDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_AttachmentNamesIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("attachmentNames")), m_AttachmentNames));
    }
    if(m_SubjectIsSet)
    {
    ...
    if(m_BodyUrlIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("bodyUrl")), m_BodyUrl));
    }
}
...
bool FakeEmailDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(U("attachmentNames"))))
    {
        std::vector<utility::string_t> refVal_setAttachmentNames;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("attachmentNames"))), refVal_setAttachmentNames );
        setAttachmentNames(refVal_setAttachmentNames);
    }
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(U("bodyUrl"))))
    {
        utility::string_t refVal_setBodyUrl;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("bodyUrl"))), refVal_setBodyUrl );
        setBodyUrl(refVal_setBodyUrl);
    }
    return ok;
}
...
std::vector<utility::string_t>& FakeEmailDto::getAttachmentNames()
{
    return m_AttachmentNames;
}

void FakeEmailDto::setAttachmentNames(const std::vector<utility::string_t>& value)
{
    m_AttachmentNames = value;
    m_AttachmentNamesIsSet = true;
}

bool FakeEmailDto::attachmentNamesIsSet() const
{
    return m_AttachmentNamesIsSet;
}

void FakeEmailDto::unsetAttachmentNames()
{
    m_AttachmentNamesIsSet = false;
}
...
utility::string_t FakeEmailDto::getContentType() const
{
    return m_ContentType;
}

void FakeEmailDto::setContentType(const utility::string_t& value)
{
    m_ContentType = value;
    m_ContentTypeIsSet = true;
}

bool FakeEmailDto::contentTypeIsSet() const
{
    return m_ContentTypeIsSet;
}

void FakeEmailDto::unsetContentType()
{
    m_ContentTypeIsSet = false;
}
utility::string_t FakeEmailDto::getBodyUrl() const
{
    return m_BodyUrl;
}

void FakeEmailDto::setBodyUrl(const utility::string_t& value)
{
    m_BodyUrl = value;
    m_BodyUrlIsSet = true;
}

bool FakeEmailDto::bodyUrlIsSet() const
{
    return m_BodyUrlIsSet;
}

void FakeEmailDto::unsetBodyUrl()
{
    m_BodyUrlIsSet = false;
}
}
