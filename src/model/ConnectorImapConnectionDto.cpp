...
bool ConnectorImapConnectionDto::isStartTls() const
{
    return m_StartTls;
}

void ConnectorImapConnectionDto::setStartTls(bool value)
{
    m_StartTls = value;
    m_StartTlsIsSet = true;
}

bool ConnectorImapConnectionDto::startTlsIsSet() const
{
    return m_StartTlsIsSet;
}

void ConnectorImapConnectionDto::unsetStartTls()
{
    m_StartTlsIsSet = false;
}
utility::string_t ConnectorImapConnectionDto::getProxyHost() const
{
    return m_ProxyHost;
}

void ConnectorImapConnectionDto::setProxyHost(const utility::string_t& value)
{
    m_ProxyHost = value;
    m_ProxyHostIsSet = true;
}

bool ConnectorImapConnectionDto::proxyHostIsSet() const
{
    return m_ProxyHostIsSet;
}

void ConnectorImapConnectionDto::unsetProxyHost()
{
    m_ProxyHostIsSet = false;
}
int32_t ConnectorImapConnectionDto::getProxyPort() const
{
    return m_ProxyPort;
}

void ConnectorImapConnectionDto::setProxyPort(int32_t value)
{
    m_ProxyPort = value;
    m_ProxyPortIsSet = true;
}

bool ConnectorImapConnectionDto::proxyPortIsSet() const
{
    return m_ProxyPortIsSet;
}

void ConnectorImapConnectionDto::unsetProxyPort()
{
    m_ProxyPortIsSet = false;
}
bool ConnectorImapConnectionDto::isProxyEnabled() const
{
    return m_ProxyEnabled;
}

void ConnectorImapConnectionDto::setProxyEnabled(bool value)
{
    m_ProxyEnabled = value;
    m_ProxyEnabledIsSet = true;
}

bool ConnectorImapConnectionDto::proxyEnabledIsSet() const
{
    return m_ProxyEnabledIsSet;
}

void ConnectorImapConnectionDto::unsetProxyEnabled()
{
    m_ProxyEnabledIsSet = false;
}
utility::string_t ConnectorImapConnectionDto::getLocalHostName() const
{
    return m_LocalHostName;
}

void ConnectorImapConnectionDto::setLocalHostName(const utility::string_t& value)
{
    m_LocalHostName = value;
    m_LocalHostNameIsSet = true;
}

bool ConnectorImapConnectionDto::localHostNameIsSet() const
{
    return m_LocalHostNameIsSet;
}

void ConnectorImapConnectionDto::unsetLocalHostName()
{
    m_LocalHostNameIsSet = false;
}
std::vector<utility::string_t>& ConnectorImapConnectionDto::getMechanisms()
{
    return m_Mechanisms;
}

void ConnectorImapConnectionDto::setMechanisms(const std::vector<utility::string_t>& value)
{
    m_Mechanisms = value;
    m_MechanismsIsSet = true;
}

bool ConnectorImapConnectionDto::mechanismsIsSet() const
{
    return m_MechanismsIsSet;
}

void ConnectorImapConnectionDto::unsetMechanisms()
{
    m_MechanismsIsSet = false;
}
std::vector<utility::string_t>& ConnectorImapConnectionDto::getSslProtocols()
{
    return m_SslProtocols;
}

void ConnectorImapConnectionDto::setSslProtocols(const std::vector<utility::string_t>& value)
{
    m_SslProtocols = value;
    m_SslProtocolsIsSet = true;
}

bool ConnectorImapConnectionDto::sslProtocolsIsSet() const
{
    return m_SslProtocolsIsSet;
}

void ConnectorImapConnectionDto::unsetSslProtocols()
{
    m_SslProtocolsIsSet = false;
}
utility::string_t ConnectorImapConnectionDto::getSslTrust() const
{
    return m_SslTrust;
}

void ConnectorImapConnectionDto::setSslTrust(const utility::string_t& value)
{
    m_SslTrust = value;
    m_SslTrustIsSet = true;
}

bool ConnectorImapConnectionDto::sslTrustIsSet() const
{
    return m_SslTrustIsSet;
}

void ConnectorImapConnectionDto::unsetSslTrust()
{
    m_SslTrustIsSet = false;
}
