...
utility::string_t InboxForwarderEventProjection::getSentId() const
{
    return m_SentId;
}

void InboxForwarderEventProjection::setSentId(const utility::string_t& value)
{
    m_SentId = value;
    m_SentIdIsSet = true;
}

bool InboxForwarderEventProjection::sentIdIsSet() const
{
    return m_SentIdIsSet;
}

void InboxForwarderEventProjection::unsetSentId()
{
    m_SentIdIsSet = false;
}
