...
void PageEmailThreadProjection::validate()
{
    // TODO: implement validation
}

web::json::value PageEmailThreadProjection::toJson() const
{
...
bool PageEmailThreadProjection::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<EmailThreadProjection>> refVal_setContent;
...
void PageEmailThreadProjection::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageEmailThreadProjection::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<EmailThreadProjection>>& PageEmailThreadProjection::getContent()
{
    return m_Content;
}

void PageEmailThreadProjection::setContent(const std::vector<std::shared_ptr<EmailThreadProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageEmailThreadProjection::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageEmailThreadProjection::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageEmailThreadProjection::getPageable() const
{
    return m_Pageable;
}

void PageEmailThreadProjection::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageEmailThreadProjection::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageEmailThreadProjection::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PageEmailThreadProjection::getTotalElements() const
{
    return m_TotalElements;
}

void PageEmailThreadProjection::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageEmailThreadProjection::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageEmailThreadProjection::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PageEmailThreadProjection::getTotalPages() const
{
    return m_TotalPages;
}

void PageEmailThreadProjection::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageEmailThreadProjection::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageEmailThreadProjection::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PageEmailThreadProjection::isLast() const
{
    return m_Last;
}

void PageEmailThreadProjection::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageEmailThreadProjection::lastIsSet() const
{
    return m_LastIsSet;
}

void PageEmailThreadProjection::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageEmailThreadProjection::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageEmailThreadProjection::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageEmailThreadProjection::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageEmailThreadProjection::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
std::shared_ptr<SortObject> PageEmailThreadProjection::getSort() const
{
    return m_Sort;
}

void PageEmailThreadProjection::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageEmailThreadProjection::sortIsSet() const
{
    return m_SortIsSet;
}

void PageEmailThreadProjection::unsetSort()
{
    m_SortIsSet = false;
}
bool PageEmailThreadProjection::isFirst() const
{
    return m_First;
}

void PageEmailThreadProjection::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageEmailThreadProjection::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageEmailThreadProjection::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageEmailThreadProjection::getSize() const
{
    return m_Size;
}

void PageEmailThreadProjection::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageEmailThreadProjection::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageEmailThreadProjection::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageEmailThreadProjection::getNumber() const
{
    return m_number;
}

void PageEmailThreadProjection::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageEmailThreadProjection::numberIsSet() const
{
    return m_numberIsSet;
}

void PageEmailThreadProjection::unsetnumber()
{
    m_numberIsSet = false;
}
bool PageEmailThreadProjection::isEmpty() const
{
    return m_Empty;
}

void PageEmailThreadProjection::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageEmailThreadProjection::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageEmailThreadProjection::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
