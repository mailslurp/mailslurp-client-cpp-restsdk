...
utility::string_t AttachmentProjection::getInboxId() const
{
    return m_InboxId;
}

void AttachmentProjection::setInboxId(const utility::string_t& value)
{
    m_InboxId = value;
    m_InboxIdIsSet = true;
}

bool AttachmentProjection::inboxIdIsSet() const
{
    return m_InboxIdIsSet;
}

void AttachmentProjection::unsetInboxId()
{
    m_InboxIdIsSet = false;
}
...
utility::string_t AttachmentProjection::getId() const
{
    return m_Id;
}

void AttachmentProjection::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool AttachmentProjection::idIsSet() const
{
    return m_IdIsSet;
}

void AttachmentProjection::unsetId()
{
    m_IdIsSet = false;
}
