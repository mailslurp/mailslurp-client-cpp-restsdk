...
void ConnectorSmtpConnectionTestResult::validate()
{
    // TODO: implement validation
}

web::json::value ConnectorSmtpConnectionTestResult::toJson() const
{
...
bool ConnectorSmtpConnectionTestResult::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ConnectorSmtpConnectionTestResult::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ConnectorSmtpConnectionTestResult::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t ConnectorSmtpConnectionTestResult::getError() const
{
    return m_Error;
}

void ConnectorSmtpConnectionTestResult::setError(const utility::string_t& value)
{
    m_Error = value;
    m_ErrorIsSet = true;
}

bool ConnectorSmtpConnectionTestResult::errorIsSet() const
{
    return m_ErrorIsSet;
}

void ConnectorSmtpConnectionTestResult::unsetError()
{
    m_ErrorIsSet = false;
}
bool ConnectorSmtpConnectionTestResult::isSuccess() const
{
    return m_Success;
}

void ConnectorSmtpConnectionTestResult::setSuccess(bool value)
{
    m_Success = value;
    m_SuccessIsSet = true;
}

bool ConnectorSmtpConnectionTestResult::successIsSet() const
{
    return m_SuccessIsSet;
}

void ConnectorSmtpConnectionTestResult::unsetSuccess()
{
    m_SuccessIsSet = false;
}
utility::string_t ConnectorSmtpConnectionTestResult::getMessage() const
{
    return m_Message;
}

void ConnectorSmtpConnectionTestResult::setMessage(const utility::string_t& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}

bool ConnectorSmtpConnectionTestResult::messageIsSet() const
{
    return m_MessageIsSet;
}

void ConnectorSmtpConnectionTestResult::unsetMessage()
{
    m_MessageIsSet = false;
}
std::vector<utility::string_t>& ConnectorSmtpConnectionTestResult::getLogs()
{
    return m_Logs;
}

void ConnectorSmtpConnectionTestResult::setLogs(const std::vector<utility::string_t>& value)
{
    m_Logs = value;
    m_LogsIsSet = true;
}

bool ConnectorSmtpConnectionTestResult::logsIsSet() const
{
    return m_LogsIsSet;
}

void ConnectorSmtpConnectionTestResult::unsetLogs()
{
    m_LogsIsSet = false;
}
}
