...
WebhookProjection::WebhookProjection()
{
    ...
    m_AiTransformerId = utility::conversions::to_string_t("");
    m_AiTransformerIdIsSet = false;
...
web::json::value WebhookProjection::toJson() const
{
    ...
    if(m_AiTransformerIdIsSet)
    {
        val[utility::conversions::to_string_t(U("aiTransformerId"))] = ModelBase::toJson(m_AiTransformerId);
    }
...
bool WebhookProjection::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("aiTransformerId"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("aiTransformerId")));
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_setAiTransformerId;
            ok &= ModelBase::fromJson(fieldValue, refVal_setAiTransformerId);
            setAiTransformerId(refVal_setAiTransformerId);
        }
    }
...
void WebhookProjection::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_AiTransformerIdIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("aiTransformerId")), m_AiTransformerId));
    }
    if(m_AiTransformIdIsSet)
    {
...
bool WebhookProjection::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(U("aiTransformerId"))))
    {
        utility::string_t refVal_setAiTransformerId;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("aiTransformerId"))), refVal_setAiTransformerId );
        setAiTransformerId(refVal_setAiTransformerId);
    }
...
utility::string_t WebhookProjection::getAiTransformerId() const
{
    return m_AiTransformerId;
}

void WebhookProjection::setAiTransformerId(const utility::string_t& value)
{
    m_AiTransformerId = value;
    m_AiTransformerIdIsSet = true;
}

bool WebhookProjection::aiTransformerIdIsSet() const
{
    return m_AiTransformerIdIsSet;
}

void WebhookProjection::unsetAiTransformerId()
{
    m_AiTransformerIdIsSet = false;
}
