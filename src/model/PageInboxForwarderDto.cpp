...
bool PageInboxForwarderDto::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<InboxForwarderDto>> refVal_setContent;
...
std::shared_ptr<SortObject> PageInboxForwarderDto::getSort() const
{
    return m_Sort;
}

void PageInboxForwarderDto::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
