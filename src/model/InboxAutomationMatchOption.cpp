...
InboxAutomationMatchOption::InboxAutomationMatchOption()
{
...
void InboxAutomationMatchOption::validate()
{
    // TODO: implement validation
}

web::json::value InboxAutomationMatchOption::toJson() const
{
...
bool InboxAutomationMatchOption::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void InboxAutomationMatchOption::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool InboxAutomationMatchOption::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t InboxAutomationMatchOption::getField() const
{
    return m_Field;
}

void InboxAutomationMatchOption::setField(const utility::string_t& value)
{
    m_Field = value;
    m_FieldIsSet = true;
}

bool InboxAutomationMatchOption::fieldIsSet() const
{
    return m_FieldIsSet;
}

void InboxAutomationMatchOption::unsetField()
{
    m_FieldIsSet = false;
}
utility::string_t InboxAutomationMatchOption::getShould() const
{
    return m_Should;
}

void InboxAutomationMatchOption::setShould(const utility::string_t& value)
{
    m_Should = value;
    m_ShouldIsSet = true;
}

bool InboxAutomationMatchOption::shouldIsSet() const
{
    return m_ShouldIsSet;
}

void InboxAutomationMatchOption::unsetShould()
{
    m_ShouldIsSet = false;
}
utility::string_t InboxAutomationMatchOption::getValue() const
{
    return m_Value;
}

void InboxAutomationMatchOption::setValue(const utility::string_t& value)
{
    m_Value = value;
    m_ValueIsSet = true;
}

bool InboxAutomationMatchOption::valueIsSet() const
{
    return m_ValueIsSet;
}

void InboxAutomationMatchOption::unsetValue()
{
    m_ValueIsSet = false;
}
}
