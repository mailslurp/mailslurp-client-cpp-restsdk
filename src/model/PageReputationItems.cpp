...
void PageReputationItems::validate()
{
    // TODO: implement validation
}

web::json::value PageReputationItems::toJson() const
{
...
bool PageReputationItems::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<ReputationItemProjection>> refVal_setContent;
...
void PageReputationItems::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageReputationItems::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<ReputationItemProjection>>& PageReputationItems::getContent()
{
    return m_Content;
}

void PageReputationItems::setContent(const std::vector<std::shared_ptr<ReputationItemProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageReputationItems::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageReputationItems::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageReputationItems::getPageable() const
{
    return m_Pageable;
}

void PageReputationItems::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageReputationItems::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageReputationItems::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PageReputationItems::getTotalElements() const
{
    return m_TotalElements;
}

void PageReputationItems::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageReputationItems::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageReputationItems::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PageReputationItems::getTotalPages() const
{
    return m_TotalPages;
}

void PageReputationItems::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageReputationItems::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageReputationItems::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PageReputationItems::isLast() const
{
    return m_Last;
}

void PageReputationItems::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageReputationItems::lastIsSet() const
{
    return m_LastIsSet;
}

void PageReputationItems::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageReputationItems::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageReputationItems::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageReputationItems::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageReputationItems::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
bool PageReputationItems::isFirst() const
{
    return m_First;
}

void PageReputationItems::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageReputationItems::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageReputationItems::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageReputationItems::getSize() const
{
    return m_Size;
}

void PageReputationItems::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageReputationItems::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageReputationItems::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageReputationItems::getNumber() const
{
    return m_number;
}

void PageReputationItems::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageReputationItems::numberIsSet() const
{
    return m_numberIsSet;
}

void PageReputationItems::unsetnumber()
{
    m_numberIsSet = false;
}
std::shared_ptr<SortObject> PageReputationItems::getSort() const
{
    return m_Sort;
}

void PageReputationItems::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageReputationItems::sortIsSet() const
{
    return m_SortIsSet;
}

void PageReputationItems::unsetSort()
{
    m_SortIsSet = false;
}
bool PageReputationItems::isEmpty() const
{
    return m_Empty;
}

void PageReputationItems::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageReputationItems::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageReputationItems::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
