...
void PageAITransformMappingProjection::validate()
{
    // TODO: implement validation
}

web::json::value PageAITransformMappingProjection::toJson() const
{
...
bool PageAITransformMappingProjection::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<AITransformMappingProjection>> refVal_setContent;
...
void PageAITransformMappingProjection::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageAITransformMappingProjection::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<AITransformMappingProjection>>& PageAITransformMappingProjection::getContent()
{
    return m_Content;
}

void PageAITransformMappingProjection::setContent(const std::vector<std::shared_ptr<AITransformMappingProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageAITransformMappingProjection::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageAITransformMappingProjection::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageAITransformMappingProjection::getPageable() const
{
    return m_Pageable;
}

void PageAITransformMappingProjection::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageAITransformMappingProjection::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageAITransformMappingProjection::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PageAITransformMappingProjection::getTotalElements() const
{
    return m_TotalElements;
}

void PageAITransformMappingProjection::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageAITransformMappingProjection::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageAITransformMappingProjection::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PageAITransformMappingProjection::getTotalPages() const
{
    return m_TotalPages;
}

void PageAITransformMappingProjection::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageAITransformMappingProjection::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageAITransformMappingProjection::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PageAITransformMappingProjection::isLast() const
{
    return m_Last;
}

void PageAITransformMappingProjection::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageAITransformMappingProjection::lastIsSet() const
{
    return m_LastIsSet;
}

void PageAITransformMappingProjection::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageAITransformMappingProjection::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageAITransformMappingProjection::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageAITransformMappingProjection::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageAITransformMappingProjection::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
bool PageAITransformMappingProjection::isFirst() const
{
    return m_First;
}

void PageAITransformMappingProjection::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageAITransformMappingProjection::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageAITransformMappingProjection::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageAITransformMappingProjection::getSize() const
{
    return m_Size;
}

void PageAITransformMappingProjection::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageAITransformMappingProjection::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageAITransformMappingProjection::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageAITransformMappingProjection::getNumber() const
{
    return m_number;
}

void PageAITransformMappingProjection::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageAITransformMappingProjection::numberIsSet() const
{
    return m_numberIsSet;
}

void PageAITransformMappingProjection::unsetnumber()
{
    m_numberIsSet = false;
}
std::shared_ptr<SortObject> PageAITransformMappingProjection::getSort() const
{
    return m_Sort;
}

void PageAITransformMappingProjection::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageAITransformMappingProjection::sortIsSet() const
{
    return m_SortIsSet;
}

void PageAITransformMappingProjection::unsetSort()
{
    m_SortIsSet = false;
}
bool PageAITransformMappingProjection::isEmpty() const
{
    return m_Empty;
}

void PageAITransformMappingProjection::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageAITransformMappingProjection::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageAITransformMappingProjection::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
