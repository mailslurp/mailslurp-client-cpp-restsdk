...
DomainNameRecord::DomainNameRecord()
{
    ...
    m_Ttl = 0L;
    m_TtlIsSet = false;
    m_AlternativeRecordEntriesIsSet = false;
}
...
web::json::value DomainNameRecord::toJson() const
{
    ...
    if(m_AlternativeRecordEntriesIsSet)
    {
        val[utility::conversions::to_string_t(U("alternativeRecordEntries"))] = ModelBase::toJson(m_AlternativeRecordEntries);
    }
...
bool DomainNameRecord::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("alternativeRecordEntries"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("alternativeRecordEntries")));
        if(!fieldValue.is_null())
        {
            std::vector<utility::string_t> refVal_setAlternativeRecordEntries;
            ok &= ModelBase::fromJson(fieldValue, refVal_setAlternativeRecordEntries);
            setAlternativeRecordEntries(refVal_setAlternativeRecordEntries);
        }
    }
    return ok;
}
...
void DomainNameRecord::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_AlternativeRecordEntriesIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("alternativeRecordEntries")), m_AlternativeRecordEntries));
    }
}
...
bool DomainNameRecord::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(U("alternativeRecordEntries"))))
    {
        std::vector<utility::string_t> refVal_setAlternativeRecordEntries;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("alternativeRecordEntries"))), refVal_setAlternativeRecordEntries );
        setAlternativeRecordEntries(refVal_setAlternativeRecordEntries);
    }
    return ok;
}
...
std::vector<utility::string_t>& DomainNameRecord::getAlternativeRecordEntries()
{
    return m_AlternativeRecordEntries;
}

void DomainNameRecord::setAlternativeRecordEntries(const std::vector<utility::string_t>& value)
{
    m_AlternativeRecordEntries = value;
    m_AlternativeRecordEntriesIsSet = true;
}

bool DomainNameRecord::alternativeRecordEntriesIsSet() const
{
    return m_AlternativeRecordEntriesIsSet;
}

void DomainNameRecord::unsetAlternativeRecordEntries()
{
    m_AlternativeRecordEntriesIsSet = false;
}
}
