...
bool CreateConnectorImapConnectionOptions::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("mechanisms"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<utility::string_t> refVal_setMechanisms;
...
bool CreateConnectorImapConnectionOptions::isStartTls() const
{
    return m_StartTls;
}

void CreateConnectorImapConnectionOptions::setStartTls(bool value)
{
    m_StartTls = value;
    m_StartTlsIsSet = true;
}

bool CreateConnectorImapConnectionOptions::startTlsIsSet() const
{
    return m_StartTlsIsSet;
}

void CreateConnectorImapConnectionOptions::unsetStartTls()
{
    m_StartTlsIsSet = false;
}
bool CreateConnectorImapConnectionOptions::isProxyEnabled() const
{
    return m_ProxyEnabled;
}

void CreateConnectorImapConnectionOptions::setProxyEnabled(bool value)
{
    m_ProxyEnabled = value;
    m_ProxyEnabledIsSet = true;
}

bool CreateConnectorImapConnectionOptions::proxyEnabledIsSet() const
{
    return m_ProxyEnabledIsSet;
}

void CreateConnectorImapConnectionOptions::unsetProxyEnabled()
{
    m_ProxyEnabledIsSet = false;
}
int32_t CreateConnectorImapConnectionOptions::getProxyPort() const
{
    return m_ProxyPort;
}

void CreateConnectorImapConnectionOptions::setProxyPort(int32_t value)
{
    m_ProxyPort = value;
    m_ProxyPortIsSet = true;
}

bool CreateConnectorImapConnectionOptions::proxyPortIsSet() const
{
    return m_ProxyPortIsSet;
}

void CreateConnectorImapConnectionOptions::unsetProxyPort()
{
    m_ProxyPortIsSet = false;
}
utility::string_t CreateConnectorImapConnectionOptions::getProxyHost() const
{
    return m_ProxyHost;
}

void CreateConnectorImapConnectionOptions::setProxyHost(const utility::string_t& value)
{
    m_ProxyHost = value;
    m_ProxyHostIsSet = true;
}

bool CreateConnectorImapConnectionOptions::proxyHostIsSet() const
{
    return m_ProxyHostIsSet;
}

void CreateConnectorImapConnectionOptions::unsetProxyHost()
{
    m_ProxyHostIsSet = false;
}
utility::string_t CreateConnectorImapConnectionOptions::getLocalHostName() const
{
    return m_LocalHostName;
}

void CreateConnectorImapConnectionOptions::setLocalHostName(const utility::string_t& value)
{
    m_LocalHostName = value;
    m_LocalHostNameIsSet = true;
}

bool CreateConnectorImapConnectionOptions::localHostNameIsSet() const
{
    return m_LocalHostNameIsSet;
}

void CreateConnectorImapConnectionOptions::unsetLocalHostName()
{
    m_LocalHostNameIsSet = false;
}
std::vector<utility::string_t>& CreateConnectorImapConnectionOptions::getMechanisms()
{
    return m_Mechanisms;
}

void CreateConnectorImapConnectionOptions::setMechanisms(const std::vector<utility::string_t>& value)
{
    m_Mechanisms = value;
    m_MechanismsIsSet = true;
}

bool CreateConnectorImapConnectionOptions::mechanismsIsSet() const
{
    return m_MechanismsIsSet;
}

void CreateConnectorImapConnectionOptions::unsetMechanisms()
{
    m_MechanismsIsSet = false;
}
utility::string_t CreateConnectorImapConnectionOptions::getSslTrust() const
{
    return m_SslTrust;
}

void CreateConnectorImapConnectionOptions::setSslTrust(const utility::string_t& value)
{
    m_SslTrust = value;
    m_SslTrustIsSet = true;
}

bool CreateConnectorImapConnectionOptions::sslTrustIsSet() const
{
    return m_SslTrustIsSet;
}

void CreateConnectorImapConnectionOptions::unsetSslTrust()
{
    m_SslTrustIsSet = false;
}
std::vector<utility::string_t>& CreateConnectorImapConnectionOptions::getSslProtocols()
{
    return m_SslProtocols;
}

void CreateConnectorImapConnectionOptions::setSslProtocols(const std::vector<utility::string_t>& value)
{
    m_SslProtocols = value;
    m_SslProtocolsIsSet = true;
}

bool CreateConnectorImapConnectionOptions::sslProtocolsIsSet() const
{
    return m_SslProtocolsIsSet;
}

void CreateConnectorImapConnectionOptions::unsetSslProtocols()
{
    m_SslProtocolsIsSet = false;
}
}
