...
void PagePlusAddressProjection::validate()
{
    // TODO: implement validation
}

web::json::value PagePlusAddressProjection::toJson() const
{
...
bool PagePlusAddressProjection::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<PlusAddressProjection>> refVal_setContent;
...
void PagePlusAddressProjection::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PagePlusAddressProjection::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<PlusAddressProjection>>& PagePlusAddressProjection::getContent()
{
    return m_Content;
}

void PagePlusAddressProjection::setContent(const std::vector<std::shared_ptr<PlusAddressProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PagePlusAddressProjection::contentIsSet() const
{
    return m_ContentIsSet;
}

void PagePlusAddressProjection::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PagePlusAddressProjection::getPageable() const
{
    return m_Pageable;
}

void PagePlusAddressProjection::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PagePlusAddressProjection::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PagePlusAddressProjection::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PagePlusAddressProjection::getTotalElements() const
{
    return m_TotalElements;
}

void PagePlusAddressProjection::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PagePlusAddressProjection::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PagePlusAddressProjection::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PagePlusAddressProjection::getTotalPages() const
{
    return m_TotalPages;
}

void PagePlusAddressProjection::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PagePlusAddressProjection::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PagePlusAddressProjection::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PagePlusAddressProjection::isLast() const
{
    return m_Last;
}

void PagePlusAddressProjection::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PagePlusAddressProjection::lastIsSet() const
{
    return m_LastIsSet;
}

void PagePlusAddressProjection::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PagePlusAddressProjection::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PagePlusAddressProjection::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PagePlusAddressProjection::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PagePlusAddressProjection::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
std::shared_ptr<SortObject> PagePlusAddressProjection::getSort() const
{
    return m_Sort;
}

void PagePlusAddressProjection::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PagePlusAddressProjection::sortIsSet() const
{
    return m_SortIsSet;
}

void PagePlusAddressProjection::unsetSort()
{
    m_SortIsSet = false;
}
bool PagePlusAddressProjection::isFirst() const
{
    return m_First;
}

void PagePlusAddressProjection::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PagePlusAddressProjection::firstIsSet() const
{
    return m_FirstIsSet;
}

void PagePlusAddressProjection::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PagePlusAddressProjection::getSize() const
{
    return m_Size;
}

void PagePlusAddressProjection::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PagePlusAddressProjection::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PagePlusAddressProjection::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PagePlusAddressProjection::getNumber() const
{
    return m_number;
}

void PagePlusAddressProjection::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PagePlusAddressProjection::numberIsSet() const
{
    return m_numberIsSet;
}

void PagePlusAddressProjection::unsetnumber()
{
    m_numberIsSet = false;
}
bool PagePlusAddressProjection::isEmpty() const
{
    return m_Empty;
}

void PagePlusAddressProjection::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PagePlusAddressProjection::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PagePlusAddressProjection::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
