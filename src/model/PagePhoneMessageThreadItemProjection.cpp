...
void PagePhoneMessageThreadItemProjection::validate()
{
    // TODO: implement validation
}

web::json::value PagePhoneMessageThreadItemProjection::toJson() const
{
...
bool PagePhoneMessageThreadItemProjection::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<PhoneMessageThreadItemProjection>> refVal_setContent;
...
void PagePhoneMessageThreadItemProjection::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PagePhoneMessageThreadItemProjection::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<PhoneMessageThreadItemProjection>>& PagePhoneMessageThreadItemProjection::getContent()
{
    return m_Content;
}

void PagePhoneMessageThreadItemProjection::setContent(const std::vector<std::shared_ptr<PhoneMessageThreadItemProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PagePhoneMessageThreadItemProjection::contentIsSet() const
{
    return m_ContentIsSet;
}

void PagePhoneMessageThreadItemProjection::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PagePhoneMessageThreadItemProjection::getPageable() const
{
    return m_Pageable;
}

void PagePhoneMessageThreadItemProjection::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PagePhoneMessageThreadItemProjection::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PagePhoneMessageThreadItemProjection::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PagePhoneMessageThreadItemProjection::getTotalElements() const
{
    return m_TotalElements;
}

void PagePhoneMessageThreadItemProjection::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PagePhoneMessageThreadItemProjection::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PagePhoneMessageThreadItemProjection::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PagePhoneMessageThreadItemProjection::getTotalPages() const
{
    return m_TotalPages;
}

void PagePhoneMessageThreadItemProjection::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PagePhoneMessageThreadItemProjection::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PagePhoneMessageThreadItemProjection::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PagePhoneMessageThreadItemProjection::isLast() const
{
    return m_Last;
}

void PagePhoneMessageThreadItemProjection::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PagePhoneMessageThreadItemProjection::lastIsSet() const
{
    return m_LastIsSet;
}

void PagePhoneMessageThreadItemProjection::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PagePhoneMessageThreadItemProjection::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PagePhoneMessageThreadItemProjection::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PagePhoneMessageThreadItemProjection::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PagePhoneMessageThreadItemProjection::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
std::shared_ptr<SortObject> PagePhoneMessageThreadItemProjection::getSort() const
{
    return m_Sort;
}

void PagePhoneMessageThreadItemProjection::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PagePhoneMessageThreadItemProjection::sortIsSet() const
{
    return m_SortIsSet;
}

void PagePhoneMessageThreadItemProjection::unsetSort()
{
    m_SortIsSet = false;
}
bool PagePhoneMessageThreadItemProjection::isFirst() const
{
    return m_First;
}

void PagePhoneMessageThreadItemProjection::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PagePhoneMessageThreadItemProjection::firstIsSet() const
{
    return m_FirstIsSet;
}

void PagePhoneMessageThreadItemProjection::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PagePhoneMessageThreadItemProjection::getSize() const
{
    return m_Size;
}

void PagePhoneMessageThreadItemProjection::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PagePhoneMessageThreadItemProjection::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PagePhoneMessageThreadItemProjection::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PagePhoneMessageThreadItemProjection::getNumber() const
{
    return m_number;
}

void PagePhoneMessageThreadItemProjection::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PagePhoneMessageThreadItemProjection::numberIsSet() const
{
    return m_numberIsSet;
}

void PagePhoneMessageThreadItemProjection::unsetnumber()
{
    m_numberIsSet = false;
}
bool PagePhoneMessageThreadItemProjection::isEmpty() const
{
    return m_Empty;
}

void PagePhoneMessageThreadItemProjection::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PagePhoneMessageThreadItemProjection::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PagePhoneMessageThreadItemProjection::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
