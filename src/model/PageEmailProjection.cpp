...
void PageEmailProjection::validate()
{
    // TODO: implement validation
}

web::json::value PageEmailProjection::toJson() const
{
...
bool PageEmailProjection::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<EmailProjection>> refVal_setContent;
...
void PageEmailProjection::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageEmailProjection::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<EmailProjection>>& PageEmailProjection::getContent()
{
    return m_Content;
}

void PageEmailProjection::setContent(const std::vector<std::shared_ptr<EmailProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageEmailProjection::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageEmailProjection::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageEmailProjection::getPageable() const
{
    return m_Pageable;
}

void PageEmailProjection::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageEmailProjection::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageEmailProjection::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PageEmailProjection::getTotal() const
{
    return m_Total;
}

void PageEmailProjection::setTotal(int64_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool PageEmailProjection::totalIsSet() const
{
    return m_TotalIsSet;
}

void PageEmailProjection::unsetTotal()
{
    m_TotalIsSet = false;
}
int64_t PageEmailProjection::getTotalElements() const
{
    return m_TotalElements;
}

void PageEmailProjection::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageEmailProjection::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageEmailProjection::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PageEmailProjection::getTotalPages() const
{
    return m_TotalPages;
}

void PageEmailProjection::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageEmailProjection::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageEmailProjection::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PageEmailProjection::isLast() const
{
    return m_Last;
}

void PageEmailProjection::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageEmailProjection::lastIsSet() const
{
    return m_LastIsSet;
}

void PageEmailProjection::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageEmailProjection::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageEmailProjection::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageEmailProjection::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageEmailProjection::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
bool PageEmailProjection::isFirst() const
{
    return m_First;
}

void PageEmailProjection::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageEmailProjection::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageEmailProjection::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageEmailProjection::getSize() const
{
    return m_Size;
}

void PageEmailProjection::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageEmailProjection::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageEmailProjection::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageEmailProjection::getNumber() const
{
    return m_number;
}

void PageEmailProjection::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageEmailProjection::numberIsSet() const
{
    return m_numberIsSet;
}

void PageEmailProjection::unsetnumber()
{
    m_numberIsSet = false;
}
std::shared_ptr<SortObject> PageEmailProjection::getSort() const
{
    return m_Sort;
}

void PageEmailProjection::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageEmailProjection::sortIsSet() const
{
    return m_SortIsSet;
}

void PageEmailProjection::unsetSort()
{
    m_SortIsSet = false;
}
bool PageEmailProjection::isEmpty() const
{
    return m_Empty;
}

void PageEmailProjection::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageEmailProjection::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageEmailProjection::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
