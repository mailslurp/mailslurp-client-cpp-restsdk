...
void SenderProjection::validate()
{
    // TODO: implement validation
}

web::json::value SenderProjection::toJson() const
{
...
bool SenderProjection::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SenderProjection::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SenderProjection::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t SenderProjection::getEmailAddress() const
{
    return m_EmailAddress;
}

void SenderProjection::setEmailAddress(const utility::string_t& value)
{
    m_EmailAddress = value;
    m_EmailAddressIsSet = true;
}

bool SenderProjection::emailAddressIsSet() const
{
    return m_EmailAddressIsSet;
}

void SenderProjection::unsetEmailAddress()
{
    m_EmailAddressIsSet = false;
}
utility::string_t SenderProjection::getRawValue() const
{
    return m_RawValue;
}

void SenderProjection::setRawValue(const utility::string_t& value)
{
    m_RawValue = value;
    m_RawValueIsSet = true;
}

bool SenderProjection::rawValueIsSet() const
{
    return m_RawValueIsSet;
}

void SenderProjection::unsetRawValue()
{
    m_RawValueIsSet = false;
}
utility::string_t SenderProjection::getName() const
{
    return m_Name;
}

void SenderProjection::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool SenderProjection::nameIsSet() const
{
    return m_NameIsSet;
}

void SenderProjection::unsetName()
{
    m_NameIsSet = false;
}
}
