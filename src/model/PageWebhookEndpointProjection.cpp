...
void PageWebhookEndpointProjection::validate()
{
    // TODO: implement validation
}

web::json::value PageWebhookEndpointProjection::toJson() const
{
...
bool PageWebhookEndpointProjection::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<WebhookEndpointProjection>> refVal_setContent;
...
void PageWebhookEndpointProjection::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageWebhookEndpointProjection::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<WebhookEndpointProjection>>& PageWebhookEndpointProjection::getContent()
{
    return m_Content;
}

void PageWebhookEndpointProjection::setContent(const std::vector<std::shared_ptr<WebhookEndpointProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageWebhookEndpointProjection::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageWebhookEndpointProjection::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageWebhookEndpointProjection::getPageable() const
{
    return m_Pageable;
}

void PageWebhookEndpointProjection::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageWebhookEndpointProjection::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageWebhookEndpointProjection::unsetPageable()
{
    m_PageableIsSet = false;
}
int32_t PageWebhookEndpointProjection::getTotalPages() const
{
    return m_TotalPages;
}

void PageWebhookEndpointProjection::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageWebhookEndpointProjection::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageWebhookEndpointProjection::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
int64_t PageWebhookEndpointProjection::getTotalElements() const
{
    return m_TotalElements;
}

void PageWebhookEndpointProjection::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageWebhookEndpointProjection::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageWebhookEndpointProjection::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
bool PageWebhookEndpointProjection::isLast() const
{
    return m_Last;
}

void PageWebhookEndpointProjection::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageWebhookEndpointProjection::lastIsSet() const
{
    return m_LastIsSet;
}

void PageWebhookEndpointProjection::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageWebhookEndpointProjection::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageWebhookEndpointProjection::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageWebhookEndpointProjection::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageWebhookEndpointProjection::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
bool PageWebhookEndpointProjection::isFirst() const
{
    return m_First;
}

void PageWebhookEndpointProjection::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageWebhookEndpointProjection::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageWebhookEndpointProjection::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageWebhookEndpointProjection::getSize() const
{
    return m_Size;
}

void PageWebhookEndpointProjection::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageWebhookEndpointProjection::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageWebhookEndpointProjection::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageWebhookEndpointProjection::getNumber() const
{
    return m_number;
}

void PageWebhookEndpointProjection::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageWebhookEndpointProjection::numberIsSet() const
{
    return m_numberIsSet;
}

void PageWebhookEndpointProjection::unsetnumber()
{
    m_numberIsSet = false;
}
std::shared_ptr<SortObject> PageWebhookEndpointProjection::getSort() const
{
    return m_Sort;
}

void PageWebhookEndpointProjection::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageWebhookEndpointProjection::sortIsSet() const
{
    return m_SortIsSet;
}

void PageWebhookEndpointProjection::unsetSort()
{
    m_SortIsSet = false;
}
bool PageWebhookEndpointProjection::isEmpty() const
{
    return m_Empty;
}

void PageWebhookEndpointProjection::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageWebhookEndpointProjection::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageWebhookEndpointProjection::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
