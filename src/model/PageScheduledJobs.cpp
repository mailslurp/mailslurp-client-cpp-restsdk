...
void PageScheduledJobs::validate()
{
    // TODO: implement validation
}

web::json::value PageScheduledJobs::toJson() const
{
...
bool PageScheduledJobs::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<ScheduledJob>> refVal_setContent;
...
void PageScheduledJobs::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageScheduledJobs::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<ScheduledJob>>& PageScheduledJobs::getContent()
{
    return m_Content;
}

void PageScheduledJobs::setContent(const std::vector<std::shared_ptr<ScheduledJob>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageScheduledJobs::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageScheduledJobs::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageScheduledJobs::getPageable() const
{
    return m_Pageable;
}

void PageScheduledJobs::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageScheduledJobs::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageScheduledJobs::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PageScheduledJobs::getTotal() const
{
    return m_Total;
}

void PageScheduledJobs::setTotal(int64_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool PageScheduledJobs::totalIsSet() const
{
    return m_TotalIsSet;
}

void PageScheduledJobs::unsetTotal()
{
    m_TotalIsSet = false;
}
int64_t PageScheduledJobs::getTotalElements() const
{
    return m_TotalElements;
}

void PageScheduledJobs::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageScheduledJobs::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageScheduledJobs::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PageScheduledJobs::getTotalPages() const
{
    return m_TotalPages;
}

void PageScheduledJobs::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageScheduledJobs::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageScheduledJobs::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PageScheduledJobs::isLast() const
{
    return m_Last;
}

void PageScheduledJobs::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageScheduledJobs::lastIsSet() const
{
    return m_LastIsSet;
}

void PageScheduledJobs::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageScheduledJobs::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageScheduledJobs::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageScheduledJobs::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageScheduledJobs::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
bool PageScheduledJobs::isFirst() const
{
    return m_First;
}

void PageScheduledJobs::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageScheduledJobs::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageScheduledJobs::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageScheduledJobs::getSize() const
{
    return m_Size;
}

void PageScheduledJobs::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageScheduledJobs::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageScheduledJobs::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageScheduledJobs::getNumber() const
{
    return m_number;
}

void PageScheduledJobs::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageScheduledJobs::numberIsSet() const
{
    return m_numberIsSet;
}

void PageScheduledJobs::unsetnumber()
{
    m_numberIsSet = false;
}
std::shared_ptr<SortObject> PageScheduledJobs::getSort() const
{
    return m_Sort;
}

void PageScheduledJobs::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageScheduledJobs::sortIsSet() const
{
    return m_SortIsSet;
}

void PageScheduledJobs::unsetSort()
{
    m_SortIsSet = false;
}
bool PageScheduledJobs::isEmpty() const
{
    return m_Empty;
}

void PageScheduledJobs::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageScheduledJobs::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageScheduledJobs::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
