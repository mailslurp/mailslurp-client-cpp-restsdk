...
utility::string_t UpdateInboxReplierOptions::getShould() const
{
    return m_Should;
}

void UpdateInboxReplierOptions::setShould(const utility::string_t& value)
{
    m_Should = value;
    m_ShouldIsSet = true;
}

bool UpdateInboxReplierOptions::shouldIsSet() const
{
    return m_ShouldIsSet;
}

void UpdateInboxReplierOptions::unsetShould()
{
    m_ShouldIsSet = false;
}
std::shared_ptr<InboxAutomationMatchOptions> UpdateInboxReplierOptions::getMatchOptions() const
{
    return m_MatchOptions;
}

void UpdateInboxReplierOptions::setMatchOptions(const std::shared_ptr<InboxAutomationMatchOptions>& value)
{
    m_MatchOptions = value;
    m_MatchOptionsIsSet = true;
}

bool UpdateInboxReplierOptions::matchOptionsIsSet() const
{
    return m_MatchOptionsIsSet;
}

void UpdateInboxReplierOptions::unsetMatchOptions()
{
    m_MatchOptionsIsSet = false;
}
}
