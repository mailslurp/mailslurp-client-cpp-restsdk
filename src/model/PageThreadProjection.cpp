...
#include "CppRestOpenAPIClient/model/PageThreadProjection.h"
...
void PageThreadProjection::validate()
{
    // TODO: implement validation
}

web::json::value PageThreadProjection::toJson() const
{
...
bool PageThreadProjection::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("content"))))
    {
        ...
        {
            std::vector<std::shared_ptr<ThreadProjection>> refVal_setContent;
...
void PageThreadProjection::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PageThreadProjection::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<ThreadProjection>>& PageThreadProjection::getContent()
{
    return m_Content;
}

void PageThreadProjection::setContent(const std::vector<std::shared_ptr<ThreadProjection>>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool PageThreadProjection::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageThreadProjection::unsetContent()
{
    m_ContentIsSet = false;
}
std::shared_ptr<PageableObject> PageThreadProjection::getPageable() const
{
    return m_Pageable;
}

void PageThreadProjection::setPageable(const std::shared_ptr<PageableObject>& value)
{
    m_Pageable = value;
    m_PageableIsSet = true;
}

bool PageThreadProjection::pageableIsSet() const
{
    return m_PageableIsSet;
}

void PageThreadProjection::unsetPageable()
{
    m_PageableIsSet = false;
}
int64_t PageThreadProjection::getTotal() const
{
    return m_Total;
}

void PageThreadProjection::setTotal(int64_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool PageThreadProjection::totalIsSet() const
{
    return m_TotalIsSet;
}

void PageThreadProjection::unsetTotal()
{
    m_TotalIsSet = false;
}
int64_t PageThreadProjection::getTotalElements() const
{
    return m_TotalElements;
}

void PageThreadProjection::setTotalElements(int64_t value)
{
    m_TotalElements = value;
    m_TotalElementsIsSet = true;
}

bool PageThreadProjection::totalElementsIsSet() const
{
    return m_TotalElementsIsSet;
}

void PageThreadProjection::unsetTotalElements()
{
    m_TotalElementsIsSet = false;
}
int32_t PageThreadProjection::getTotalPages() const
{
    return m_TotalPages;
}

void PageThreadProjection::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool PageThreadProjection::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void PageThreadProjection::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
bool PageThreadProjection::isLast() const
{
    return m_Last;
}

void PageThreadProjection::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}

bool PageThreadProjection::lastIsSet() const
{
    return m_LastIsSet;
}

void PageThreadProjection::unsetLast()
{
    m_LastIsSet = false;
}
int32_t PageThreadProjection::getNumberOfElements() const
{
    return m_NumberOfElements;
}

void PageThreadProjection::setNumberOfElements(int32_t value)
{
    m_NumberOfElements = value;
    m_NumberOfElementsIsSet = true;
}

bool PageThreadProjection::numberOfElementsIsSet() const
{
    return m_NumberOfElementsIsSet;
}

void PageThreadProjection::unsetNumberOfElements()
{
    m_NumberOfElementsIsSet = false;
}
bool PageThreadProjection::isFirst() const
{
    return m_First;
}

void PageThreadProjection::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}

bool PageThreadProjection::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageThreadProjection::unsetFirst()
{
    m_FirstIsSet = false;
}
int32_t PageThreadProjection::getSize() const
{
    return m_Size;
}

void PageThreadProjection::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool PageThreadProjection::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageThreadProjection::unsetSize()
{
    m_SizeIsSet = false;
}
int32_t PageThreadProjection::getNumber() const
{
    return m_number;
}

void PageThreadProjection::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool PageThreadProjection::numberIsSet() const
{
    return m_numberIsSet;
}

void PageThreadProjection::unsetnumber()
{
    m_numberIsSet = false;
}
std::shared_ptr<SortObject> PageThreadProjection::getSort() const
{
    return m_Sort;
}

void PageThreadProjection::setSort(const std::shared_ptr<SortObject>& value)
{
    m_Sort = value;
    m_SortIsSet = true;
}

bool PageThreadProjection::sortIsSet() const
{
    return m_SortIsSet;
}

void PageThreadProjection::unsetSort()
{
    m_SortIsSet = false;
}
bool PageThreadProjection::isEmpty() const
{
    return m_Empty;
}

void PageThreadProjection::setEmpty(bool value)
{
    m_Empty = value;
    m_EmptyIsSet = true;
}

bool PageThreadProjection::emptyIsSet() const
{
    return m_EmptyIsSet;
}

void PageThreadProjection::unsetEmpty()
{
    m_EmptyIsSet = false;
}
}
